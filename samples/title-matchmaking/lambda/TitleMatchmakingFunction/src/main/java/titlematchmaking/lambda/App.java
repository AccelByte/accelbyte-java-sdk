...
public class App implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
                ...
                try {
                        ...
                        final DefaultHttpRetryPolicy retryPolicy = new DefaultHttpRetryPolicy() {
                                ...
                                public boolean doRetry(
                                                int attempt, Operation operation, HttpResponse response,
                                                Exception exception) {
                        ...
                        final ModelsGameSessionSetting gameSessionSetting = ModelsGameSessionSetting.builder()
                        ...
                        final ModelsCreateSessionRequest createSessionBody = ModelsCreateSessionRequest.builder()
                                        .namespace(namespace)
                                        .sessionType("p2p")
                                        .gameVersion("1.0.0")
                                        .username(username)
                        ...
                        return response.withStatusCode(200)
                                        .withBody(getSuccessJson("ok - player 2"));
                } catch (Exception e) {
                        e.printStackTrace();
                        return response.withStatusCode(503)
                                        .withBody(getErrorJson(50300,
        ...
        private String getErrorJson(int code, String message) {
                return String.format("{\"code\":\"%d\",\"message\":\"%s\"}", code,
                                message);
        }
}
