...
public class PublicSubmitUserAccountDeletionRequest implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(PublicSubmitUserAccountDeletionRequest.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.gdpr.operations.data_deletion.PublicSubmitUserAccountDeletionRequest
          operation =
