...
@Command(name = "adminCreateModAction", mixinStandardHelpOptions = true)
public class AdminCreateModAction implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminCreateModAction.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminCreateModAction()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.reporting.operations
              .admin_extension_categories_and_auto_moderation_actions.AdminCreateModAction
          operation =
              net.accelbyte.sdk.api.reporting.operations
                  .admin_extension_categories_and_auto_moderation_actions.AdminCreateModAction
                  .builder()
                  .body(new ObjectMapper().readValue(body, RestapiActionApiRequest.class))
                  .build();
