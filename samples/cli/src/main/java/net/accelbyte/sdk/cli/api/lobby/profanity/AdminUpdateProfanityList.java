...
public class AdminUpdateProfanityList implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.lobby.operations.profanity.AdminUpdateProfanityList operation =
