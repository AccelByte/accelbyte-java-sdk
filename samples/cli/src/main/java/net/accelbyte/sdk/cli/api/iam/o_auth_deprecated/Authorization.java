...
public class Authorization implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.Authorization operation =
          net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.Authorization.builder()
