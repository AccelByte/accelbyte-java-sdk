...
public class AdminPutPlayerPublicRecordConcurrentHandlerV1 implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(AdminPutPlayerPublicRecordConcurrentHandlerV1.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new AdminPutPlayerPublicRecordConcurrentHandlerV1()).execute(args);
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.admin_concurrent_record
          ...
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.admin_concurrent_record
                  .AdminPutPlayerPublicRecordConcurrentHandlerV1.builder()
                  .key(key)
                  .namespace(namespace)
                  .userId(userId)
                  .body(
