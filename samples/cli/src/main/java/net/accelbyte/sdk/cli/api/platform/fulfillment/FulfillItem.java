...
@Command(name = "fulfillItem", mixinStandardHelpOptions = true)
public class FulfillItem implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(FulfillItem.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new FulfillItem()).execute(args);
