...
public class QueryMatchLengthDurationpAvg implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryMatchLengthDurationpAvg
          operation =
              net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryMatchLengthDurationpAvg
                  .builder()
                  .namespace(namespace)
                  .matchPool(matchPool)
                  .endDate(endDate)
