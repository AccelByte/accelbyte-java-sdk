...
@Command(name = "addFriendsWithoutConfirmation", mixinStandardHelpOptions = true)
public class AddFriendsWithoutConfirmation implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AddFriendsWithoutConfirmation.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AddFriendsWithoutConfirmation()).execute(args);
