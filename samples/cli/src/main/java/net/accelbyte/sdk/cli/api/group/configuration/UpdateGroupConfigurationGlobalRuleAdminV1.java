...
public class UpdateGroupConfigurationGlobalRuleAdminV1 implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(UpdateGroupConfigurationGlobalRuleAdminV1.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.group.operations.configuration.UpdateGroupConfigurationGlobalRuleAdminV1
          operation =
              net.accelbyte.sdk.api.group.operations.configuration
                  .UpdateGroupConfigurationGlobalRuleAdminV1.builder()
