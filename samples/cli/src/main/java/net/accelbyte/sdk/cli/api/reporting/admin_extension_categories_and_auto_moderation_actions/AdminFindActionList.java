...
@Command(name = "adminFindActionList", mixinStandardHelpOptions = true)
public class AdminFindActionList implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminFindActionList.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminFindActionList()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.reporting.operations
              .admin_extension_categories_and_auto_moderation_actions.AdminFindActionList
          operation =
