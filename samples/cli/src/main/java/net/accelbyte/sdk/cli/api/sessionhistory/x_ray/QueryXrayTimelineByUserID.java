...
public class QueryXrayTimelineByUserID implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryXrayTimelineByUserID operation =
                    net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryXrayTimelineByUserID.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .limit(limit)
                            .offset(offset)
            ...
            final ApimodelsXRayTicketQueryResponse response =
                    wrapper.queryXrayTimelineByUserID(operation);
