...
@Command(name = "getCurrentCycleLeaderboardRankingAdminV3", mixinStandardHelpOptions = true)
public class GetCurrentCycleLeaderboardRankingAdminV3 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(GetCurrentCycleLeaderboardRankingAdminV3.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GetCurrentCycleLeaderboardRankingAdminV3()).execute(args);
      ...
      final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
          ...
          operation =
              net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
                  .GetCurrentCycleLeaderboardRankingAdminV3.builder()
                  .cycleId(cycleId)
