...
public class AdminCancelUserAccountDeletionRequest implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(AdminCancelUserAccountDeletionRequest.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.gdpr.operations.data_deletion.AdminCancelUserAccountDeletionRequest
          operation =
              net.accelbyte.sdk.api.gdpr.operations.data_deletion
                  .AdminCancelUserAccountDeletionRequest.builder()
                  .namespace(namespace)
                  .userId(userId)
                  .build();
