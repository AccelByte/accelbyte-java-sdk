...
@Command(name = "getDefaultProvider", mixinStandardHelpOptions = true)
public class GetDefaultProvider implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(GetDefaultProvider.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GetDefaultProvider()).execute(args);
