...
public class ListAllTerminatedServers implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.dslogmanager.operations.all_terminated_servers.ListAllTerminatedServers
          operation =
              net.accelbyte.sdk.api.dslogmanager.operations.all_terminated_servers
                  ...
                  .userId(userId)
                  .build();
      ModelsListTerminatedServersResponse response = wrapper.listAllTerminatedServers(operation);
