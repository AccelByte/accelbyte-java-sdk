...
@Command(name = "retrieveSinglePolicy1", mixinStandardHelpOptions = true)
public class RetrieveSinglePolicy1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(RetrieveSinglePolicy1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new RetrieveSinglePolicy1()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace
                  .RetrieveSinglePolicy1.builder()
                  .basePolicyId(basePolicyId)
                  .namespace(namespace)
                  .build();
      final RetrieveBasePolicyResponse response = wrapper.retrieveSinglePolicy1(operation);
