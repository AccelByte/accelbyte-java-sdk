...
public class RevokeAUser implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.RevokeAUser operation =
          net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.RevokeAUser.builder()
