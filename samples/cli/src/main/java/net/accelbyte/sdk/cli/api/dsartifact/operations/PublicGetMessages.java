...
package net.accelbyte.sdk.cli.api.dsartifact.operations;

import com.fasterxml.jackson.databind.ObjectMapper;
import java.util.*;
import java.util.concurrent.Callable;
import net.accelbyte.sdk.api.dsartifact.models.*;
import net.accelbyte.sdk.api.dsartifact.wrappers.Operations;
...
public class PublicGetMessages implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.dsartifact.operations.operations.PublicGetMessages operation =
          net.accelbyte.sdk.api.dsartifact.operations.operations.PublicGetMessages.builder()
              .build();
