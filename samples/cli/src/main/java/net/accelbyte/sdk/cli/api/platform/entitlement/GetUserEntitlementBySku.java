...
public class GetUserEntitlementBySku implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.entitlement.GetUserEntitlementBySku operation =
          net.accelbyte.sdk.api.platform.operations.entitlement.GetUserEntitlementBySku.builder()
              .namespace(namespace)
              .userId(userId)
              ...
              .sku(sku)
              .build();
      EntitlementInfo response = wrapper.getUserEntitlementBySku(operation);
