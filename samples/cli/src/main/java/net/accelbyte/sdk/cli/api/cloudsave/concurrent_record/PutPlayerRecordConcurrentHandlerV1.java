...
@Command(name = "putPlayerRecordConcurrentHandlerV1", mixinStandardHelpOptions = true)
public class PutPlayerRecordConcurrentHandlerV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PutPlayerRecordConcurrentHandlerV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PutPlayerRecordConcurrentHandlerV1()).execute(args);
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.concurrent_record
          ...
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.concurrent_record
                  .PutPlayerRecordConcurrentHandlerV1.builder()
                  .key(key)
                  .namespace(namespace)
                  .userId(userId)
