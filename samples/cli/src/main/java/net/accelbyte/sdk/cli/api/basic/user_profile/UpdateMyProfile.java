...
public class UpdateMyProfile implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.basic.operations.user_profile.UpdateMyProfile operation =
            ...
            UserProfilePrivateInfo response =
                    wrapper.updateMyProfile(operation);
