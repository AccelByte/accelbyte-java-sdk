...
public class ExistsAnyUserActiveEntitlementByItemIds implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(ExistsAnyUserActiveEntitlementByItemIds.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.entitlement.ExistsAnyUserActiveEntitlementByItemIds
          operation =
              net.accelbyte.sdk.api.platform.operations.entitlement
                  ...
                  .itemIds(itemIds)
                  .build();
      Ownership response = wrapper.existsAnyUserActiveEntitlementByItemIds(operation);
