...
@Command(name = "reportFailedUpload", mixinStandardHelpOptions = true)
public class ReportFailedUpload implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(ReportFailedUpload.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new ReportFailedUpload()).execute(args);
      ...
      final net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue
          ...
          operation =
              net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue
                  .ReportFailedUpload.builder()
                  .nodeIP(nodeIP)
                  .podName(podName)
                  .build();
      wrapper.reportFailedUpload(operation);
