...
public class RetrieveAllThirdPartyLoginPlatformCredentialV3 implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(RetrieveAllThirdPartyLoginPlatformCredentialV3.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new RetrieveAllThirdPartyLoginPlatformCredentialV3()).execute(args);
