...
public class UpdateCountryGroup implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(UpdateCountryGroup.class);

  @Option(
      names = {"--countryGroupCode"},
      description = "countryGroupCode")
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.basic.operations.misc.UpdateCountryGroup operation =
          net.accelbyte.sdk.api.basic.operations.misc.UpdateCountryGroup.builder()
              ...
              .build();
      CountryGroupObject response = wrapper.updateCountryGroup(operation);
