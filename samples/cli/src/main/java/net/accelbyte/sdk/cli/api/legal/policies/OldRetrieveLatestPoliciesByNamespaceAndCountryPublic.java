...
@Command(
    name = "oldRetrieveLatestPoliciesByNamespaceAndCountryPublic",
    mixinStandardHelpOptions = true)
public class OldRetrieveLatestPoliciesByNamespaceAndCountryPublic implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(OldRetrieveLatestPoliciesByNamespaceAndCountryPublic.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new OldRetrieveLatestPoliciesByNamespaceAndCountryPublic()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.legal.operations.policies
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.policies
                  .OldRetrieveLatestPoliciesByNamespaceAndCountryPublic.builder()
      ...
      final List<RetrievePolicyPublicResponse> response =
          wrapper.oldRetrieveLatestPoliciesByNamespaceAndCountryPublic(operation);
