...
public class AdminQueryTicketDetail implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.sessionhistory.operations.game_session_detail.AdminQueryTicketDetail operation =
                    net.accelbyte.sdk.api.sessionhistory.operations.game_session_detail.AdminQueryTicketDetail.builder()
                            .namespace(namespace)
                            .endDate(endDate)
                            .gameMode(gameMode)
                            .limit(limit)
                            ...
                            .userIDs(userIDs)
                            .build();
            final ApimodelsTicketDetailQueryResponse response =
                    wrapper.adminQueryTicketDetail(operation);
