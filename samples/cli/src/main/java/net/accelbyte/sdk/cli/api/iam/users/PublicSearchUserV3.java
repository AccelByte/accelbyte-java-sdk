...
public class PublicSearchUserV3 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users.PublicSearchUserV3 operation =
          net.accelbyte.sdk.api.iam.operations.users.PublicSearchUserV3.builder()
              ...
              .query(query)
              .build();
      ModelPublicUserInformationResponseV3 response = wrapper.publicSearchUserV3(operation);
