...
@Command(name = "adminGetInventoryItem", mixinStandardHelpOptions = true)
public class AdminGetInventoryItem implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminGetInventoryItem.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminGetInventoryItem()).execute(args);
