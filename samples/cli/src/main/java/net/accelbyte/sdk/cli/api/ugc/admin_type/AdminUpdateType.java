...
public class AdminUpdateType implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.ugc.operations.admin_type.AdminUpdateType operation =
            ...
            ModelsCreateTypeResponse response =
                    wrapper.adminUpdateType(operation);
