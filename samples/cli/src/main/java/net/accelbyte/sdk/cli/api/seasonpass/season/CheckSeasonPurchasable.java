...
public class CheckSeasonPurchasable implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.seasonpass.operations.season.CheckSeasonPurchasable operation =
                    net.accelbyte.sdk.api.seasonpass.operations.season.CheckSeasonPurchasable.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .body(new ObjectMapper().readValue(body, UserPurchasable.class)) 
                            .build();
