...
@Command(name = "publicListGlobalAchievements", mixinStandardHelpOptions = true)
public class PublicListGlobalAchievements implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PublicListGlobalAchievements.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicListGlobalAchievements()).execute(args);
