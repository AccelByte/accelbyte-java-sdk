...
public class GetEventByUserIDAndEventIDHandler implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.eventlog.operations.event.GetEventByUserIDAndEventIDHandler operation =
          net.accelbyte.sdk.api.eventlog.operations.event.GetEventByUserIDAndEventIDHandler
              ...
              .startDate(startDate)
              .build();
      ModelsEventResponse response = wrapper.getEventByUserIDAndEventIDHandler(operation);
