...
public class BulkResetUserStatItem2 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.social.operations.user_statistic.BulkResetUserStatItem2
          operation =
              net.accelbyte.sdk.api.social.operations.user_statistic.BulkResetUserStatItem2
                  .builder()
                  .namespace(namespace)
                  .body(
                      new ObjectMapper()
                  ...
                  .build();
      final List<BulkStatItemOperationResult> response = wrapper.bulkResetUserStatItem2(operation);
