...
@Command(name = "queryUserIAPConsumeHistory", mixinStandardHelpOptions = true)
public class QueryUserIAPConsumeHistory implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(QueryUserIAPConsumeHistory.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new QueryUserIAPConsumeHistory()).execute(args);
