...
@Command(name = "createStore", mixinStandardHelpOptions = true)
public class CreateStore implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(CreateStore.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new CreateStore()).execute(args);
