...
public class PartialUpdateThirdPartyLoginPlatformDomainV3 implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(PartialUpdateThirdPartyLoginPlatformDomainV3.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new PartialUpdateThirdPartyLoginPlatformDomainV3()).execute(args);
