...
@Command(name = "getItem", mixinStandardHelpOptions = true)
public class GetItem implements Callable<Integer> {

    private static final Logger log = LogManager.getLogger(GetItem.class);
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new GetItem()).execute(args);
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.platform.operations.item.GetItem operation =
