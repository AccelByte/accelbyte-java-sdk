...
public class UpdateUserStatItemValue1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.social.operations.user_statistic.UpdateUserStatItemValue1 operation =
          net.accelbyte.sdk.api.social.operations.user_statistic.UpdateUserStatItemValue1.builder()
              .namespace(namespace)
              .statCode(statCode)
              .userId(userId)
              ...
              .build();
      StatItemIncResult response = wrapper.updateUserStatItemValue1(operation);
