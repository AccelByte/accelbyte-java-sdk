...
public class SearchSessionsV2 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.matchmaking.operations.matchmaking.SearchSessionsV2 operation =
          net.accelbyte.sdk.api.matchmaking.operations.matchmaking.SearchSessionsV2.builder()
              ...
              .offset(offset)
              .build();
      ServiceGetSessionHistorySearchResponseV2 response = wrapper.searchSessionsV2(operation);
