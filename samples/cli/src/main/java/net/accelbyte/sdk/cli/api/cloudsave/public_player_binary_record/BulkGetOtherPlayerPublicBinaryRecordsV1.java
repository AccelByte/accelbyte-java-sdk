...
@Command(name = "bulkGetOtherPlayerPublicBinaryRecordsV1", mixinStandardHelpOptions = true)
public class BulkGetOtherPlayerPublicBinaryRecordsV1 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(BulkGetOtherPlayerPublicBinaryRecordsV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new BulkGetOtherPlayerPublicBinaryRecordsV1()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record
          ...
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record
                  .BulkGetOtherPlayerPublicBinaryRecordsV1.builder()
                  .namespace(namespace)
                  .userId(userId)
      ...
      final ModelsBulkGetPlayerBinaryRecordResponse response =
          wrapper.bulkGetOtherPlayerPublicBinaryRecordsV1(operation);
