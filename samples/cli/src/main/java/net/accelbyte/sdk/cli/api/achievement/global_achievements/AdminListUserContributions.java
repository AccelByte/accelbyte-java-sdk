...
@Command(name = "adminListUserContributions", mixinStandardHelpOptions = true)
public class AdminListUserContributions implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminListUserContributions.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminListUserContributions()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.achievement.operations.global_achievements
          ...
          operation =
              net.accelbyte.sdk.api.achievement.operations.global_achievements
                  .AdminListUserContributions.builder()
                  .namespace(namespace)
                  .userId(userId)
      ...
      final ModelsPaginatedUserContributionResponse response =
          wrapper.adminListUserContributions(operation);
