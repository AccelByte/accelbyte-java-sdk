...
public class DeleteGroupConfigurationGlobalRuleAdminV1 implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(DeleteGroupConfigurationGlobalRuleAdminV1.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.group.operations.configuration.DeleteGroupConfigurationGlobalRuleAdminV1
          operation =
              net.accelbyte.sdk.api.group.operations.configuration
                  .DeleteGroupConfigurationGlobalRuleAdminV1.builder()
