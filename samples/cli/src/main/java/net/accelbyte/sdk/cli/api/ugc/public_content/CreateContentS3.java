...
@Command(name = "createContentS3", mixinStandardHelpOptions = true)
public class CreateContentS3 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(CreateContentS3.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new CreateContentS3()).execute(args);
