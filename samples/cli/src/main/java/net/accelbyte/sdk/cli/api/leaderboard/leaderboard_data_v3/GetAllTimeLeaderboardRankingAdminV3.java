...
@Command(name = "getAllTimeLeaderboardRankingAdminV3", mixinStandardHelpOptions = true)
public class GetAllTimeLeaderboardRankingAdminV3 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(GetAllTimeLeaderboardRankingAdminV3.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GetAllTimeLeaderboardRankingAdminV3()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
          ...
          operation =
              net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
                  .GetAllTimeLeaderboardRankingAdminV3.builder()
      ...
      final ModelsGetLeaderboardRankingResp response =
          wrapper.getAllTimeLeaderboardRankingAdminV3(operation);
