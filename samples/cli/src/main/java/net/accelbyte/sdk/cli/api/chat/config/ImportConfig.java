...
public class ImportConfig implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.chat.operations.config.ImportConfig operation =
                    net.accelbyte.sdk.api.chat.operations.config.ImportConfig.builder()
                            .namespace(namespace)
                            .file(file != null ? file : null)
                            .build();
            final ModelsImportConfigResponse response =
                    wrapper.importConfig(operation);
