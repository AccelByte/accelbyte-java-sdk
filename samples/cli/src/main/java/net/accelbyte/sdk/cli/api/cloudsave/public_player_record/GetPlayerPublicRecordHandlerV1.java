...
public class GetPlayerPublicRecordHandlerV1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.cloudsave.operations.public_player_record.GetPlayerPublicRecordHandlerV1
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_player_record
                  .GetPlayerPublicRecordHandlerV1.builder()
                  .key(key)
                  .namespace(namespace)
                  .userId(userId)
                  .build();
      ModelsPlayerRecordResponse response = wrapper.getPlayerPublicRecordHandlerV1(operation);
