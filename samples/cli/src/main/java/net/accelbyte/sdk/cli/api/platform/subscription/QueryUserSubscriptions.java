...
public class QueryUserSubscriptions implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.subscription.QueryUserSubscriptions operation =
          net.accelbyte.sdk.api.platform.operations.subscription.QueryUserSubscriptions.builder()
              .namespace(namespace)
              .userId(userId)
              ...
              .build();
      SubscriptionPagingSlicedResult response = wrapper.queryUserSubscriptions(operation);
