...
@Command(name = "getListGroupByIDsV2", mixinStandardHelpOptions = true)
public class GetListGroupByIDsV2 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(GetListGroupByIDsV2.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GetListGroupByIDsV2()).execute(args);
