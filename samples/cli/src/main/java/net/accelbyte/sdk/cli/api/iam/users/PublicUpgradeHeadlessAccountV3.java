...
public class PublicUpgradeHeadlessAccountV3 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users.PublicUpgradeHeadlessAccountV3 operation =
          net.accelbyte.sdk.api.iam.operations.users.PublicUpgradeHeadlessAccountV3.builder()
              ...
              .build();
      final ModelUserResponseV3 response = wrapper.publicUpgradeHeadlessAccountV3(operation);
