...
@Command(name = "deleteUser", mixinStandardHelpOptions = true)
public class DeleteUser implements Callable<Integer> {
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteUser()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users.DeleteUser operation =
