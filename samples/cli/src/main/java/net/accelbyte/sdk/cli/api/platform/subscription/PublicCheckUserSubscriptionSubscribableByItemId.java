...
public class PublicCheckUserSubscriptionSubscribableByItemId implements Callable<Integer> {
    ...
    private static final Logger log = LogManager.getLogger(PublicCheckUserSubscriptionSubscribableByItemId.class);
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new PublicCheckUserSubscriptionSubscribableByItemId()).execute(args);
