...
public class PublicUpdateInsertPartySessionStorageReserved implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(PublicUpdateInsertPartySessionStorageReserved.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new PublicUpdateInsertPartySessionStorageReserved()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.session.operations.session_storage
          ...
          operation =
              net.accelbyte.sdk.api.session.operations.session_storage
                  .PublicUpdateInsertPartySessionStorageReserved.builder()
                  .namespace(namespace)
                  .partyId(partyId)
                  .userId(userId)
      ...
      final Map<String, ?> response =
          wrapper.publicUpdateInsertPartySessionStorageReserved(operation);
