...
@Command(name = "fleetClaimByKeys", mixinStandardHelpOptions = true)
public class FleetClaimByKeys implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(FleetClaimByKeys.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new FleetClaimByKeys()).execute(args);
