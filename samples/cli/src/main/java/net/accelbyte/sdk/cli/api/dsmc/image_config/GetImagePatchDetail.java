...
public class GetImagePatchDetail implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.dsmc.operations.image_config.GetImagePatchDetail operation =
          net.accelbyte.sdk.api.dsmc.operations.image_config.GetImagePatchDetail.builder()
              .namespace(namespace)
              .version(version)
              .versionPatch(versionPatch)
              .build();
      final ModelsGetImagePatchDetailResponse response = wrapper.getImagePatchDetail(operation);
