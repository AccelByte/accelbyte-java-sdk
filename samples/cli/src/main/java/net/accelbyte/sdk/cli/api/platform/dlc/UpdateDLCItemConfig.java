...
public class UpdateDLCItemConfig implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.platform.operations.dlc.UpdateDLCItemConfig operation =
          net.accelbyte.sdk.api.platform.operations.dlc.UpdateDLCItemConfig.builder()
              ...
              .build();
      final DLCItemConfigInfo response = wrapper.updateDLCItemConfig(operation);
