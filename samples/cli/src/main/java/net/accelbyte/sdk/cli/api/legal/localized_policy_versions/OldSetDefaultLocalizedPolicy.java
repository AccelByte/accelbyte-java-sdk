...
@Command(name = "oldSetDefaultLocalizedPolicy", mixinStandardHelpOptions = true)
public class OldSetDefaultLocalizedPolicy implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(OldSetDefaultLocalizedPolicy.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new OldSetDefaultLocalizedPolicy()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions
                  .OldSetDefaultLocalizedPolicy.builder()
                  .localizedPolicyVersionId(localizedPolicyVersionId)
                  .build();
      wrapper.oldSetDefaultLocalizedPolicy(operation);
