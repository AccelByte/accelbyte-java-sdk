...
@Command(name = "createCategory", mixinStandardHelpOptions = true)
public class CreateCategory implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(CreateCategory.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new CreateCategory()).execute(args);
