...
public class GetMemberRolesListPublicV1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.group.operations.group_roles.GetMemberRolesListPublicV1 operation =
          net.accelbyte.sdk.api.group.operations.group_roles.GetMemberRolesListPublicV1.builder()
              .namespace(namespace)
              .limit(limit)
              .offset(offset)
              .build();
      ModelsGetMemberRolesListResponseV1 response = wrapper.getMemberRolesListPublicV1(operation);
