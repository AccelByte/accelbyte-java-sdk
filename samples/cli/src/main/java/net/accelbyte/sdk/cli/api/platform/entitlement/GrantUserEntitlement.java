...
@Command(name = "grantUserEntitlement", mixinStandardHelpOptions = true)
public class GrantUserEntitlement implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(GrantUserEntitlement.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GrantUserEntitlement()).execute(args);
