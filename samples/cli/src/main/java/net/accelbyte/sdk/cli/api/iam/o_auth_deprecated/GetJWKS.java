...
public class GetJWKS implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.GetJWKS operation =
          net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.GetJWKS.builder().build();
