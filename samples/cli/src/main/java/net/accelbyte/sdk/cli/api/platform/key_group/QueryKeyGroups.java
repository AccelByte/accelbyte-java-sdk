...
public class QueryKeyGroups implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.platform.operations.key_group.QueryKeyGroups operation =
            ...
            KeyGroupPagingSlicedResult response =
                    wrapper.queryKeyGroups(operation);
