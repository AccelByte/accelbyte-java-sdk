...
@Command(name = "getAllTimeLeaderboardRankingPublicV3", mixinStandardHelpOptions = true)
public class GetAllTimeLeaderboardRankingPublicV3 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(GetAllTimeLeaderboardRankingPublicV3.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GetAllTimeLeaderboardRankingPublicV3()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
          ...
          operation =
              net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
                  .GetAllTimeLeaderboardRankingPublicV3.builder()
      ...
      final ModelsGetLeaderboardRankingResp response =
          wrapper.getAllTimeLeaderboardRankingPublicV3(operation);
