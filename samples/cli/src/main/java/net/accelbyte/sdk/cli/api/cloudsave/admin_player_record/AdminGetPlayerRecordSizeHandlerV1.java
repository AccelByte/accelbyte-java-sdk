...
@Command(name = "adminGetPlayerRecordSizeHandlerV1", mixinStandardHelpOptions = true)
public class AdminGetPlayerRecordSizeHandlerV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminGetPlayerRecordSizeHandlerV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminGetPlayerRecordSizeHandlerV1()).execute(args);
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.admin_player_record
          ...
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.admin_player_record
                  .AdminGetPlayerRecordSizeHandlerV1.builder()
                  .key(key)
                  .namespace(namespace)
                  .userId(userId)
                  .build();
