...
public class PostPlayerRecordHandlerV1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.cloudsave.operations.public_player_record.PostPlayerRecordHandlerV1
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_player_record
                  ...
                  .build();
      ModelsPlayerRecordResponse response = wrapper.postPlayerRecordHandlerV1(operation);
