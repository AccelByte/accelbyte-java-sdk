...
public class SingleAdminGetContent implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.ugc.operations.admin_content.SingleAdminGetContent operation =
          net.accelbyte.sdk.api.ugc.operations.admin_content.SingleAdminGetContent.builder()
              .namespace(namespace)
              .limit(limit)
              .offset(offset)
              .build();
      ModelsPaginatedContentDownloadResponse response = wrapper.singleAdminGetContent(operation);
