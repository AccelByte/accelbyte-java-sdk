...
@Command(name = "retrieveLocalizedPolicyVersions1", mixinStandardHelpOptions = true)
public class RetrieveLocalizedPolicyVersions1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(RetrieveLocalizedPolicyVersions1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new RetrieveLocalizedPolicyVersions1()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
                  .RetrieveLocalizedPolicyVersions1.builder()
                  .namespace(namespace)
                  .policyVersionId(policyVersionId)
                  .build();
      final List<RetrieveLocalizedPolicyVersionResponse> response =
          wrapper.retrieveLocalizedPolicyVersions1(operation);
