...
public class ExportChannels implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.matchmaking.operations.matchmaking.ExportChannels operation =
          net.accelbyte.sdk.api.matchmaking.operations.matchmaking.ExportChannels.builder()
              .namespace(namespace)
              .build();
      List<ModelsChannelV1> response = wrapper.exportChannels(operation);
