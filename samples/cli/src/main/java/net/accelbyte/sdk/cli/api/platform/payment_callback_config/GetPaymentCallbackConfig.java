...
public class GetPaymentCallbackConfig implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.payment_callback_config.GetPaymentCallbackConfig
          operation =
              net.accelbyte.sdk.api.platform.operations.payment_callback_config
                  .GetPaymentCallbackConfig.builder()
                  .namespace(namespace)
                  .build();
      PaymentCallbackConfigInfo response = wrapper.getPaymentCallbackConfig(operation);
