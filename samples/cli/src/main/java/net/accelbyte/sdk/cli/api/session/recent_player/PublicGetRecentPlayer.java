...
@Command(name = "publicGetRecentPlayer", mixinStandardHelpOptions = true)
public class PublicGetRecentPlayer implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PublicGetRecentPlayer.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicGetRecentPlayer()).execute(args);
