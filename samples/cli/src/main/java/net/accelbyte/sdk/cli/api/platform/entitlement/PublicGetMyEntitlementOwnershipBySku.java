...
public class PublicGetMyEntitlementOwnershipBySku implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(PublicGetMyEntitlementOwnershipBySku.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.entitlement.PublicGetMyEntitlementOwnershipBySku
          operation =
              net.accelbyte.sdk.api.platform.operations.entitlement
                  .PublicGetMyEntitlementOwnershipBySku.builder()
                  .namespace(namespace)
                  .entitlementClazz(entitlementClazz)
                  .sku(sku)
                  .build();
      TimedOwnership response = wrapper.publicGetMyEntitlementOwnershipBySku(operation);
