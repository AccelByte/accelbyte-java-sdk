...
@Command(
    name = "publicUpgradeHeadlessAccountWithVerificationCodeV4",
    mixinStandardHelpOptions = true)
public class PublicUpgradeHeadlessAccountWithVerificationCodeV4 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(PublicUpgradeHeadlessAccountWithVerificationCodeV4.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new PublicUpgradeHeadlessAccountWithVerificationCodeV4()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users_v4
          ...
          operation =
              net.accelbyte.sdk.api.iam.operations.users_v4
                  .PublicUpgradeHeadlessAccountWithVerificationCodeV4.builder()
                  .namespace(namespace)
                  .body(
                      new ObjectMapper()
                          .readValue(
