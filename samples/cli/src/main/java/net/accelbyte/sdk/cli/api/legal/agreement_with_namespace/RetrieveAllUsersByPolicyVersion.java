...
@Command(name = "retrieveAllUsersByPolicyVersion", mixinStandardHelpOptions = true)
public class RetrieveAllUsersByPolicyVersion implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(RetrieveAllUsersByPolicyVersion.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new RetrieveAllUsersByPolicyVersion()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.agreement_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.agreement_with_namespace
                  .RetrieveAllUsersByPolicyVersion.builder()
                  .namespace(namespace)
