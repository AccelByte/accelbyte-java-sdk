...
public class AdminVerifyUserWithoutVerificationCodeV3 implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(AdminVerifyUserWithoutVerificationCodeV3.class);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users.AdminVerifyUserWithoutVerificationCodeV3
          operation =
              net.accelbyte.sdk.api.iam.operations.users.AdminVerifyUserWithoutVerificationCodeV3
                  .builder()
                  .namespace(namespace)
                  .userId(userId)
                  .build();
