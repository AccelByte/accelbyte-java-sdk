...
@Command(name = "publicCreateProfile", mixinStandardHelpOptions = true)
public class PublicCreateProfile implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PublicCreateProfile.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicCreateProfile()).execute(args);
