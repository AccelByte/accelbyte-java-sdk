...
@Command(name = "requestPresignedURL1", mixinStandardHelpOptions = true)
public class RequestPresignedURL1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(RequestPresignedURL1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new RequestPresignedURL1()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final UploadLocalizedPolicyVersionAttachmentResponse response =
          wrapper.requestPresignedURL1(operation);
