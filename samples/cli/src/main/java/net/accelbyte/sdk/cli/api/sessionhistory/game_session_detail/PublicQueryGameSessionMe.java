...
@Command(name = "publicQueryGameSessionMe", mixinStandardHelpOptions = true)
public class PublicQueryGameSessionMe implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PublicQueryGameSessionMe.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicQueryGameSessionMe()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.sessionhistory.operations.game_session_detail
          ...
          operation =
              net.accelbyte.sdk.api.sessionhistory.operations.game_session_detail
                  .PublicQueryGameSessionMe.builder()
                  .namespace(namespace)
                  .limit(limit)
                  .offset(offset)
                  .order(order)
      ...
      final ApimodelsGameSessionDetailQueryResponse response =
          wrapper.publicQueryGameSessionMe(operation);
