...
@Command(name = "deleteLeaderboardConfigurationAdminV3", mixinStandardHelpOptions = true)
public class DeleteLeaderboardConfigurationAdminV3 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(DeleteLeaderboardConfigurationAdminV3.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteLeaderboardConfigurationAdminV3()).execute(args);
      ...
      final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3
          ...
          operation =
              net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3
                  .DeleteLeaderboardConfigurationAdminV3.builder()
