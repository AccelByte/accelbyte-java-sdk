...
@Command(name = "createRuleSet", mixinStandardHelpOptions = true)
public class CreateRuleSet implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(CreateRuleSet.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new CreateRuleSet()).execute(args);
