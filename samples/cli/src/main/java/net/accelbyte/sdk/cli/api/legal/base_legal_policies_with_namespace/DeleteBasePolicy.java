...
@Command(name = "deleteBasePolicy", mixinStandardHelpOptions = true)
public class DeleteBasePolicy implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DeleteBasePolicy.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteBasePolicy()).execute(args);
