...
public class AddRolePermission implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.iam.operations.roles_deprecated.AddRolePermission operation =
          net.accelbyte.sdk.api.iam.operations.roles_deprecated.AddRolePermission.builder()
              .action(action)
              .resource(resource)
              .roleId(roleId)
