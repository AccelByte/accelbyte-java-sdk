...
public class GetRegisteredEventsHandler implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.eventlog.operations.event_registry.GetRegisteredEventsHandler
          operation =
              net.accelbyte.sdk.api.eventlog.operations.event_registry.GetRegisteredEventsHandler
                  .builder()
                  .build();
      final ModelsEventRegistry response = wrapper.getRegisteredEventsHandler(operation);
