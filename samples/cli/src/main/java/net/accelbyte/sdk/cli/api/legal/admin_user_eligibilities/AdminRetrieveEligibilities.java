...
public class AdminRetrieveEligibilities implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.legal.operations.admin_user_eligibilities.AdminRetrieveEligibilities
          operation =
              net.accelbyte.sdk.api.legal.operations.admin_user_eligibilities
                  .AdminRetrieveEligibilities.builder()
                  .namespace(namespace)
                  .userId(userId)
