...
@Command(name = "deleteServicePluginConfig", mixinStandardHelpOptions = true)
public class DeleteServicePluginConfig implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DeleteServicePluginConfig.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteServicePluginConfig()).execute(args);
      ...
      final net.accelbyte.sdk.api.platform.operations.service_plugin_config
          ...
          operation =
              net.accelbyte.sdk.api.platform.operations.service_plugin_config
                  .DeleteServicePluginConfig.builder()
                  .namespace(namespace)
                  .build();
