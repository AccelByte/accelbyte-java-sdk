...
public class RetrieveSingleLocalizedPolicyVersion2 implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(RetrieveSingleLocalizedPolicyVersion2.class);
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions
                  .RetrieveSingleLocalizedPolicyVersion2.builder()
                  .localizedPolicyVersionId(localizedPolicyVersionId)
                  .build();
      final RetrieveLocalizedPolicyVersionPublicResponse response =
          wrapper.retrieveSingleLocalizedPolicyVersion2(operation);
