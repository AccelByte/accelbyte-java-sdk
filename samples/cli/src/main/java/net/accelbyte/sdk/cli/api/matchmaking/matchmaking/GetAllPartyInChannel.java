...
public class GetAllPartyInChannel implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetAllPartyInChannel operation =
          net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetAllPartyInChannel.builder()
              .channelName(channelName)
              .namespace(namespace)
              .build();
      List<ModelsMatchingParty> response = wrapper.getAllPartyInChannel(operation);
