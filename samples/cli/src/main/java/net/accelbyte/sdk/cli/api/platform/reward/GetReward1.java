...
public class GetReward1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.platform.operations.reward.GetReward1 operation =
          net.accelbyte.sdk.api.platform.operations.reward.GetReward1.builder()
              .namespace(namespace)
              .rewardId(rewardId)
              .build();
      RewardInfo response = wrapper.getReward1(operation);
