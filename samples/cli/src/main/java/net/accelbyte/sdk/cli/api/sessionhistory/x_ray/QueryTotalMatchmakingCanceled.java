...
public class QueryTotalMatchmakingCanceled implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryTotalMatchmakingCanceled operation =
                    net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryTotalMatchmakingCanceled.builder()
                            .namespace(namespace)
                            .matchPool(matchPool)
                            .endDate(endDate)
                            .startDate(startDate)
