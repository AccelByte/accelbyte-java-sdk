...
@Command(name = "publicRetrieveSingleLocalizedPolicyVersion", mixinStandardHelpOptions = true)
public class PublicRetrieveSingleLocalizedPolicyVersion implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(PublicRetrieveSingleLocalizedPolicyVersion.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicRetrieveSingleLocalizedPolicyVersion()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
                  .PublicRetrieveSingleLocalizedPolicyVersion.builder()
                  .localizedPolicyVersionId(localizedPolicyVersionId)
                  .namespace(namespace)
                  .build();
      final RetrieveLocalizedPolicyVersionPublicResponse response =
          wrapper.publicRetrieveSingleLocalizedPolicyVersion(operation);
