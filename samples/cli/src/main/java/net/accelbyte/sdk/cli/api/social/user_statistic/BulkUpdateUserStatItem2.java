...
public class BulkUpdateUserStatItem2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.social.operations.user_statistic.BulkUpdateUserStatItem2 operation =
                    net.accelbyte.sdk.api.social.operations.user_statistic.BulkUpdateUserStatItem2.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .additionalKey(additionalKey)
                            .body(new ObjectMapper().readValue(body, new TypeReference<List<BulkStatItemUpdate>>() {}))
                            .build();
            List<BulkStatItemOperationResult> response =
                    wrapper.bulkUpdateUserStatItem2(operation);
