...
@Command(name = "banUsers", mixinStandardHelpOptions = true)
public class BanUsers implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(BanUsers.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new BanUsers()).execute(args);
