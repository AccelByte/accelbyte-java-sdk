...
@Command(name = "deleteIAPItemConfig", mixinStandardHelpOptions = true)
public class DeleteIAPItemConfig implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DeleteIAPItemConfig.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteIAPItemConfig()).execute(args);
