...
@Command(name = "listExtOrderNoByExtTxId", mixinStandardHelpOptions = true)
public class ListExtOrderNoByExtTxId implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(ListExtOrderNoByExtTxId.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new ListExtOrderNoByExtTxId()).execute(args);
