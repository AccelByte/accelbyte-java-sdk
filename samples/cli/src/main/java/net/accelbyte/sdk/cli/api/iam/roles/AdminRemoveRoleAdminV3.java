...
public class AdminRemoveRoleAdminV3 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.roles.AdminRemoveRoleAdminV3 operation =
          net.accelbyte.sdk.api.iam.operations.roles.AdminRemoveRoleAdminV3.builder()
              .roleId(roleId)
              .build();
