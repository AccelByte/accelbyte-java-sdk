...
public class PublicGetCategory implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.platform.operations.category.PublicGetCategory operation =
            ...
            CategoryInfo response =
                    wrapper.publicGetCategory(operation);
