...
@Command(name = "deleteGameBinaryRecordV1", mixinStandardHelpOptions = true)
public class DeleteGameBinaryRecordV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DeleteGameBinaryRecordV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteGameBinaryRecordV1()).execute(args);
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record
          ...
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record
                  .DeleteGameBinaryRecordV1.builder()
                  .key(key)
                  .namespace(namespace)
                  .build();
      wrapper.deleteGameBinaryRecordV1(operation);
