...
public class PublicGetUserEntitlementOwnershipBySku implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(PublicGetUserEntitlementOwnershipBySku.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.entitlement.PublicGetUserEntitlementOwnershipBySku
          operation =
              net.accelbyte.sdk.api.platform.operations.entitlement
                  .PublicGetUserEntitlementOwnershipBySku.builder()
                  .namespace(namespace)
                  .userId(userId)
                  .entitlementClazz(entitlementClazz)
                  .sku(sku)
                  .build();
      TimedOwnership response = wrapper.publicGetUserEntitlementOwnershipBySku(operation);
