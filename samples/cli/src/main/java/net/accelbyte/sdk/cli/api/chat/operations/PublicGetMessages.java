...
package net.accelbyte.sdk.cli.api.chat.operations;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import net.accelbyte.sdk.api.chat.models.*;
import net.accelbyte.sdk.api.chat.wrappers.Operations;
...
public class PublicGetMessages implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.chat.operations.operations.PublicGetMessages operation =
                    net.accelbyte.sdk.api.chat.operations.operations.PublicGetMessages.builder()
                            .build();
            final List<LogAppMessageDeclaration> response =
