...
@Command(name = "publicGetPastUserProgression", mixinStandardHelpOptions = true)
public class PublicGetPastUserProgression implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PublicGetPastUserProgression.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicGetPastUserProgression()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.challenge.operations.challenge_progression
              .PublicGetPastUserProgression
          operation =
              net.accelbyte.sdk.api.challenge.operations.challenge_progression
                  .PublicGetPastUserProgression.builder()
