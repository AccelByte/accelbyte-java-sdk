...
@Command(name = "deleteUserRankingByLeaderboardCodeAdminV3", mixinStandardHelpOptions = true)
public class DeleteUserRankingByLeaderboardCodeAdminV3 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(DeleteUserRankingByLeaderboardCodeAdminV3.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteUserRankingByLeaderboardCodeAdminV3()).execute(args);
      ...
      final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
          ...
          operation =
              net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
                  .DeleteUserRankingByLeaderboardCodeAdminV3.builder()
