...
public class GetUserEntitlementOwnershipByItemId implements Runnable {
    ...
    public void run() {
        try {
            ...
            .getUserEntitlementOwnershipByItemId(
                new net.accelbyte.sdk.api.platform.operations.entitlement.GetUserEntitlementOwnershipByItemId(
                    namespace,
                    userId,
                    entitlementClazz,
                    itemId
