...
public class GetUserEntitlementOwnershipByItemId implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.entitlement.GetUserEntitlementOwnershipByItemId
          operation =
              net.accelbyte.sdk.api.platform.operations.entitlement
                  ...
                  .itemId(itemId)
                  .build();
      TimedOwnership response = wrapper.getUserEntitlementOwnershipByItemId(operation);
