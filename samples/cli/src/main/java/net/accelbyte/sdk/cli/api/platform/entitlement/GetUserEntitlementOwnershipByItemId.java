...
public class GetUserEntitlementOwnershipByItemId implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.platform.operations.entitlement.GetUserEntitlementOwnershipByItemId operation =
                    net.accelbyte.sdk.api.platform.operations.entitlement.GetUserEntitlementOwnershipByItemId.builder()
                            .namespace(namespace)
                            .userId(userId)
            ...
            TimedOwnership response =
                    wrapper.getUserEntitlementOwnershipByItemId(operation);
