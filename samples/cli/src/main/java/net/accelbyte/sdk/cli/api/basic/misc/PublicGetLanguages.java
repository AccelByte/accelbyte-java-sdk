...
@Command(name = "publicGetLanguages", mixinStandardHelpOptions = true)
public class PublicGetLanguages implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PublicGetLanguages.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicGetLanguages()).execute(args);
