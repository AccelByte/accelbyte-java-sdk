...
@Command(name = "adminDeleteSession", mixinStandardHelpOptions = true)
public class AdminDeleteSession implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminDeleteSession.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminDeleteSession()).execute(args);
