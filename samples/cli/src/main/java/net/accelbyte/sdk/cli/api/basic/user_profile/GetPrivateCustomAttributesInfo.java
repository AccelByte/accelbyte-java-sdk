...
public class GetPrivateCustomAttributesInfo implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.basic.operations.user_profile.GetPrivateCustomAttributesInfo operation =
          net.accelbyte.sdk.api.basic.operations.user_profile.GetPrivateCustomAttributesInfo
              .builder()
              .namespace(namespace)
              .userId(userId)
              .build();
      Map<String, ?> response = wrapper.getPrivateCustomAttributesInfo(operation);
