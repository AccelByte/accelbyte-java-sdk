...
public class BulkUpdateUserStatItem implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.social.operations.user_statistic.BulkUpdateUserStatItem operation =
                    net.accelbyte.sdk.api.social.operations.user_statistic.BulkUpdateUserStatItem.builder()
                            .namespace(namespace)
                            .userId(userId)
            ...
            List<BulkStatItemOperationResult> response =
                    wrapper.bulkUpdateUserStatItem(operation);
