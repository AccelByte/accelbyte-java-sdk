...
@Command(name = "bulkGetUserSeasonProgression", mixinStandardHelpOptions = true)
public class BulkGetUserSeasonProgression implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(BulkGetUserSeasonProgression.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new BulkGetUserSeasonProgression()).execute(args);
