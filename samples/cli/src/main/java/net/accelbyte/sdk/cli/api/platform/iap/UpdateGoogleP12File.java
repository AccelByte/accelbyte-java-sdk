...
@Command(name = "updateGoogleP12File", mixinStandardHelpOptions = true)
public class UpdateGoogleP12File implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(UpdateGoogleP12File.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new UpdateGoogleP12File()).execute(args);
