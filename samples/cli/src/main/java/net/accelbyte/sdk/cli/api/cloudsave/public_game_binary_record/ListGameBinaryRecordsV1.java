...
@Command(name = "listGameBinaryRecordsV1", mixinStandardHelpOptions = true)
public class ListGameBinaryRecordsV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(ListGameBinaryRecordsV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new ListGameBinaryRecordsV1()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record
          ...
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record
                  .ListGameBinaryRecordsV1.builder()
                  .namespace(namespace)
                  .limit(limit)
                  .offset(offset)
                  .query(query)
      ...
      final ModelsListGameBinaryRecordsResponse response =
          wrapper.listGameBinaryRecordsV1(operation);
