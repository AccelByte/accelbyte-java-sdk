...
public class GetSingleTemplateLocalizationV1Admin implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(GetSingleTemplateLocalizationV1Admin.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.lobby.operations.notification.GetSingleTemplateLocalizationV1Admin
          operation =
              net.accelbyte.sdk.api.lobby.operations.notification
                  .GetSingleTemplateLocalizationV1Admin.builder()
                  .namespace(namespace)
