...
@Command(name = "oldCreateLocalizedPolicyVersion", mixinStandardHelpOptions = true)
public class OldCreateLocalizedPolicyVersion implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(OldCreateLocalizedPolicyVersion.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new OldCreateLocalizedPolicyVersion()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions
                  .OldCreateLocalizedPolicyVersion.builder()
      ...
      final CreateLocalizedPolicyVersionResponse response =
          wrapper.oldCreateLocalizedPolicyVersion(operation);
