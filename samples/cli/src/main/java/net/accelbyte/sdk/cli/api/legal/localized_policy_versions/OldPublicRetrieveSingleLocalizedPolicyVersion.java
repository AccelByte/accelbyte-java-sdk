...
@Command(name = "oldPublicRetrieveSingleLocalizedPolicyVersion", mixinStandardHelpOptions = true)
public class OldPublicRetrieveSingleLocalizedPolicyVersion implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(OldPublicRetrieveSingleLocalizedPolicyVersion.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new OldPublicRetrieveSingleLocalizedPolicyVersion()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions
                  .OldPublicRetrieveSingleLocalizedPolicyVersion.builder()
                  .localizedPolicyVersionId(localizedPolicyVersionId)
                  .build();
      final RetrieveLocalizedPolicyVersionPublicResponse response =
          wrapper.oldPublicRetrieveSingleLocalizedPolicyVersion(operation);
