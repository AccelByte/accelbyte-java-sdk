...
public class AdminUpdateTag implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.ugc.operations.admin_tag.AdminUpdateTag operation =
            ...
            ModelsCreateTagResponse response =
                    wrapper.adminUpdateTag(operation);
