...
public class GetPublicFollowers implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.ugc.operations.public_follow.GetPublicFollowers operation =
          net.accelbyte.sdk.api.ugc.operations.public_follow.GetPublicFollowers.builder()
              ...
              .offset(offset)
              .build();
      ModelsPaginatedCreatorOverviewResponse response = wrapper.getPublicFollowers(operation);
