...
public class PublicUpdateUserEmailAddressV4 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users_v4.PublicUpdateUserEmailAddressV4 operation =
