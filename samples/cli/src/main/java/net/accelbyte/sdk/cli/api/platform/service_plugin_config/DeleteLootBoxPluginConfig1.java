...
@Command(name = "deleteLootBoxPluginConfig1", mixinStandardHelpOptions = true)
public class DeleteLootBoxPluginConfig1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DeleteLootBoxPluginConfig1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteLootBoxPluginConfig1()).execute(args);
      ...
      final net.accelbyte.sdk.api.platform.operations.service_plugin_config
          ...
          operation =
              net.accelbyte.sdk.api.platform.operations.service_plugin_config
                  .DeleteLootBoxPluginConfig1.builder()
                  .namespace(namespace)
                  .build();
