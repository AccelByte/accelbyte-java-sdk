...
@Command(name = "acquireUserTicket", mixinStandardHelpOptions = true)
public class AcquireUserTicket implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AcquireUserTicket.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AcquireUserTicket()).execute(args);
