...
public class CreateCurrency implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.platform.operations.currency.CreateCurrency operation =
            ...
            CurrencyInfo response =
                    wrapper.createCurrency(operation);
