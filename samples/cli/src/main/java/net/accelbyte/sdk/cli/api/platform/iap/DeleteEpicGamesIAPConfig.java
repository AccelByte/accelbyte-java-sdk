...
@Command(name = "deleteEpicGamesIAPConfig", mixinStandardHelpOptions = true)
public class DeleteEpicGamesIAPConfig implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DeleteEpicGamesIAPConfig.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteEpicGamesIAPConfig()).execute(args);
