...
@Command(
    name = "retrieveAllActiveThirdPartyLoginPlatformCredentialV3",
    mixinStandardHelpOptions = true)
public class RetrieveAllActiveThirdPartyLoginPlatformCredentialV3 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(RetrieveAllActiveThirdPartyLoginPlatformCredentialV3.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new RetrieveAllActiveThirdPartyLoginPlatformCredentialV3()).execute(args);
      ...
      final net.accelbyte.sdk.api.iam.operations.third_party_credential
          ...
          operation =
              net.accelbyte.sdk.api.iam.operations.third_party_credential
                  .RetrieveAllActiveThirdPartyLoginPlatformCredentialV3.builder()
                  .namespace(namespace)
                  .build();
