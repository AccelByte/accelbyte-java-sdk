...
@Command(name = "adminUpdateIntegrationConfiguration", mixinStandardHelpOptions = true)
public class AdminUpdateIntegrationConfiguration implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminUpdateIntegrationConfiguration.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminUpdateIntegrationConfiguration()).execute(args);
      ...
      final net.accelbyte.sdk.api.inventory.operations.admin_integration_configurations
          ...
          operation =
              net.accelbyte.sdk.api.inventory.operations.admin_integration_configurations
                  .AdminUpdateIntegrationConfiguration.builder()
                  .integrationConfigurationId(integrationConfigurationId)
                  .namespace(namespace)
                  .body(
                      new ObjectMapper()
                          .readValue(body, ApimodelsUpdateIntegrationConfigurationReq.class))
                  .build();
      final ApimodelsIntegrationConfigurationResp response =
          wrapper.adminUpdateIntegrationConfiguration(operation);
