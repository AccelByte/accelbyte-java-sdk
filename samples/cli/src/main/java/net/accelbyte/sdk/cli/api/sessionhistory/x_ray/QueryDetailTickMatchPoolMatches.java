...
public class QueryDetailTickMatchPoolMatches implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryDetailTickMatchPoolMatches operation =
                    net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryDetailTickMatchPoolMatches.builder()
                            .namespace(namespace)
                            .podName(podName)
                            .poolName(poolName)
                            .tickId(tickId)
            ...
            final ApimodelsXRayMatchPoolPodTickMatchResponse response =
                    wrapper.queryDetailTickMatchPoolMatches(operation);
