...
@Command(name = "adminGenerateBackupCodesV4", mixinStandardHelpOptions = true)
public class AdminGenerateBackupCodesV4 implements Callable<Integer> {
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminGenerateBackupCodesV4()).execute(args);
