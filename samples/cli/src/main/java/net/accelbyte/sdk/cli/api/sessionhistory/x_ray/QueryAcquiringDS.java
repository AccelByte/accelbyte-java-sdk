...
@Command(name = "queryAcquiringDS", mixinStandardHelpOptions = true)
public class QueryAcquiringDS implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(QueryAcquiringDS.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new QueryAcquiringDS()).execute(args);
    ...
    try {
      ...
      final net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryAcquiringDS operation =
          net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryAcquiringDS.builder()
              ...
              .startDate(startDate)
              .build();
      final ApimodelsXRayAcquiringDsQueryResponse response = wrapper.queryAcquiringDS(operation);
