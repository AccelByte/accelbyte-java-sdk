...
public class AdminGetLogConfig implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.chat.operations.config.AdminGetLogConfig operation =
          net.accelbyte.sdk.api.chat.operations.config.AdminGetLogConfig.builder().build();
