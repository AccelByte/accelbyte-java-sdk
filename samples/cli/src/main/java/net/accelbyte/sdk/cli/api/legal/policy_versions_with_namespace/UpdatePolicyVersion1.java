...
@Command(name = "updatePolicyVersion1", mixinStandardHelpOptions = true)
public class UpdatePolicyVersion1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(UpdatePolicyVersion1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new UpdatePolicyVersion1()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace
                  .UpdatePolicyVersion1.builder()
                  .namespace(namespace)
                  .policyVersionId(policyVersionId)
                  .body(new ObjectMapper().readValue(body, UpdatePolicyVersionRequest.class))
                  .build();
      final UpdatePolicyVersionResponse response = wrapper.updatePolicyVersion1(operation);
