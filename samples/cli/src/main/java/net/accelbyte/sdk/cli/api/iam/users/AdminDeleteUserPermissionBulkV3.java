...
public class AdminDeleteUserPermissionBulkV3 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users.AdminDeleteUserPermissionBulkV3 operation =
          net.accelbyte.sdk.api.iam.operations.users.AdminDeleteUserPermissionBulkV3.builder()
              .namespace(namespace)
              .userId(userId)
              .body(
                  new ObjectMapper()
                      .readValue(body, new TypeReference<List<ModelPermissionDeleteRequest>>() {}))
              .build();
