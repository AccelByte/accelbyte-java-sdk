...
@Command(name = "deleteBulkLeaderboardConfigurationAdminV3", mixinStandardHelpOptions = true)
public class DeleteBulkLeaderboardConfigurationAdminV3 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(DeleteBulkLeaderboardConfigurationAdminV3.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteBulkLeaderboardConfigurationAdminV3()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3
          ...
          operation =
              net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3
                  .DeleteBulkLeaderboardConfigurationAdminV3.builder()
                  .namespace(namespace)
      ...
      final ModelsDeleteBulkLeaderboardsResp response =
          wrapper.deleteBulkLeaderboardConfigurationAdminV3(operation);
