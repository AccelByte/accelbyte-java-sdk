...
public class PublicGetMessages implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.dsmc.operations.dsmc_operations.PublicGetMessages operation =
                    net.accelbyte.sdk.api.dsmc.operations.dsmc_operations.PublicGetMessages.builder()
                            .build();
