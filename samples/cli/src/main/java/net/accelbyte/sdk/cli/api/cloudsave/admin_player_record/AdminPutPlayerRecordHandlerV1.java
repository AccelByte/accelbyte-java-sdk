...
public class AdminPutPlayerRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminPutPlayerRecordHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminPutPlayerRecordHandlerV1.builder()
                            .key(key)
                            .namespace(namespace)
                            .userId(userId)
