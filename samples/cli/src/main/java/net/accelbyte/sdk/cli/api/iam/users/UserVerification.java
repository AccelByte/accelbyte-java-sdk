...
@Command(name = "userVerification", mixinStandardHelpOptions = true)
public class UserVerification implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(UserVerification.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new UserVerification()).execute(args);
