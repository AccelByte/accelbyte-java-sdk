...
@Command(name = "adminCreateConfigurationAlertV1", mixinStandardHelpOptions = true)
public class AdminCreateConfigurationAlertV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminCreateConfigurationAlertV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminCreateConfigurationAlertV1()).execute(args);
