...
@Command(name = "createMemberRoleAdminV1", mixinStandardHelpOptions = true)
public class CreateMemberRoleAdminV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(CreateMemberRoleAdminV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new CreateMemberRoleAdminV1()).execute(args);
