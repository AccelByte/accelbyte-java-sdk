...
public class GetCurrentWeekLeaderboardRankingAdminV1 implements Runnable {
    ...
    public void run() {
        try {
            ...
            .getCurrentWeekLeaderboardRankingAdminV1(
                new net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetCurrentWeekLeaderboardRankingAdminV1(
                    leaderboardCode,
                    namespace,
                    limit,
                    offset
