...
public class SpecificEventIDDescriptionHandler implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.eventlog.operations.event_descriptions.SpecificEventIDDescriptionHandler
          operation =
              net.accelbyte.sdk.api.eventlog.operations.event_descriptions
                  .SpecificEventIDDescriptionHandler.builder()
                  .eventIds(eventIds)
                  .build();
      ModelsMultipleEventID response = wrapper.specificEventIDDescriptionHandler(operation);
