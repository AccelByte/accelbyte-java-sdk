...
@Command(name = "adminGetAllConfigurationTemplatesV1", mixinStandardHelpOptions = true)
public class AdminGetAllConfigurationTemplatesV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminGetAllConfigurationTemplatesV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminGetAllConfigurationTemplatesV1()).execute(args);
