...
@Command(name = "deleteRevocationPluginConfig", mixinStandardHelpOptions = true)
public class DeleteRevocationPluginConfig implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DeleteRevocationPluginConfig.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteRevocationPluginConfig()).execute(args);
      ...
      final net.accelbyte.sdk.api.platform.operations.service_plugin_config
          ...
          operation =
              net.accelbyte.sdk.api.platform.operations.service_plugin_config
                  .DeleteRevocationPluginConfig.builder()
                  .namespace(namespace)
                  .build();
