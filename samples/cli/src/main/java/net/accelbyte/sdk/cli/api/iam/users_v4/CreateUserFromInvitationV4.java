...
public class CreateUserFromInvitationV4 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users_v4.CreateUserFromInvitationV4 operation =
          net.accelbyte.sdk.api.iam.operations.users_v4.CreateUserFromInvitationV4.builder()
              ...
              .build();
      AccountCreateUserResponseV4 response = wrapper.createUserFromInvitationV4(operation);
