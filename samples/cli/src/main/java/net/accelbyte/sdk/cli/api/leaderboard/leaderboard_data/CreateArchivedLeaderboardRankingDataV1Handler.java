...
public class CreateArchivedLeaderboardRankingDataV1Handler implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(CreateArchivedLeaderboardRankingDataV1Handler.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new CreateArchivedLeaderboardRankingDataV1Handler()).execute(args);
      ...
      final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data
          ...
          operation =
              net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data
                  .CreateArchivedLeaderboardRankingDataV1Handler.builder()
                  .namespace(namespace)
