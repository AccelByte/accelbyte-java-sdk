...
public class AdminRequestDataRetrieval implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.gdpr.operations.data_retrieval.AdminRequestDataRetrieval
          operation =
              net.accelbyte.sdk.api.gdpr.operations.data_retrieval.AdminRequestDataRetrieval
                  .builder()
                  .namespace(namespace)
                  .userId(userId)
                  .password(password != null ? password : null)
                  .build();
      ModelsDataRetrievalResponse response = wrapper.adminRequestDataRetrieval(operation);
