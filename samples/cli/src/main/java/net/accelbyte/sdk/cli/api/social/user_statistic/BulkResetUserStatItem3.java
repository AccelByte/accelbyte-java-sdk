...
public class BulkResetUserStatItem3 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.social.operations.user_statistic.BulkResetUserStatItem3 operation =
          net.accelbyte.sdk.api.social.operations.user_statistic.BulkResetUserStatItem3.builder()
              .namespace(namespace)
              .userId(userId)
              .body(
                  new ObjectMapper()
              ...
              .build();
      List<BulkStatItemOperationResult> response = wrapper.bulkResetUserStatItem3(operation);
