...
public class GetGroupListAdminV1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.group.operations.group.GetGroupListAdminV1 operation =
          net.accelbyte.sdk.api.group.operations.group.GetGroupListAdminV1.builder()
              ...
              .offset(offset)
              .build();
      ModelsGetGroupsListResponseV1 response = wrapper.getGroupListAdminV1(operation);
