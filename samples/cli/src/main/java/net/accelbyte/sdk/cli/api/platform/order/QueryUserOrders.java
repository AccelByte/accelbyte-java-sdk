...
public class QueryUserOrders implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.platform.operations.order.QueryUserOrders operation =
            ...
            OrderPagingSlicedResult response =
                    wrapper.queryUserOrders(operation);
