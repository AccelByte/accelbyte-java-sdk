...
public class PublicGeneratedUploadUrl implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.basic.operations.file_upload.PublicGeneratedUploadUrl operation =
          net.accelbyte.sdk.api.basic.operations.file_upload.PublicGeneratedUploadUrl.builder()
              .folder(folder)
              .namespace(namespace)
              .fileType(fileType)
              .build();
      FileUploadUrlInfo response = wrapper.publicGeneratedUploadUrl(operation);
