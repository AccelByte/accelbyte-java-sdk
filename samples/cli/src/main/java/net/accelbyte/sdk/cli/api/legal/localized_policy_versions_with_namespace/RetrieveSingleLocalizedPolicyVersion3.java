...
@Command(name = "retrieveSingleLocalizedPolicyVersion3", mixinStandardHelpOptions = true)
public class RetrieveSingleLocalizedPolicyVersion3 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(RetrieveSingleLocalizedPolicyVersion3.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new RetrieveSingleLocalizedPolicyVersion3()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
                  .RetrieveSingleLocalizedPolicyVersion3.builder()
                  .localizedPolicyVersionId(localizedPolicyVersionId)
                  .namespace(namespace)
                  .build();
      final RetrieveLocalizedPolicyVersionPublicResponse response =
          wrapper.retrieveSingleLocalizedPolicyVersion3(operation);
