...
@Command(name = "updateUserPointAdminV1", mixinStandardHelpOptions = true)
public class UpdateUserPointAdminV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(UpdateUserPointAdminV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new UpdateUserPointAdminV1()).execute(args);
