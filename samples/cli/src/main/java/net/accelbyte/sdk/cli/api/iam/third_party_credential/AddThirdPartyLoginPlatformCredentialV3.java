...
public class AddThirdPartyLoginPlatformCredentialV3 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(AddThirdPartyLoginPlatformCredentialV3.class);
      ...
      final net.accelbyte.sdk.api.iam.operations.third_party_credential
          ...
          operation =
              net.accelbyte.sdk.api.iam.operations.third_party_credential
                  .AddThirdPartyLoginPlatformCredentialV3.builder()
                  .namespace(namespace)
