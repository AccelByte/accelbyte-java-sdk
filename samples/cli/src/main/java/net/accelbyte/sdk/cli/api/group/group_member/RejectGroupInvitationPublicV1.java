...
public class RejectGroupInvitationPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.group.operations.group_member.RejectGroupInvitationPublicV1 operation =
                    net.accelbyte.sdk.api.group.operations.group_member.RejectGroupInvitationPublicV1.builder()
                            .groupId(groupId)
                            .namespace(namespace)
                            .build();
            ModelsMemberRequestGroupResponseV1 response =
                    wrapper.rejectGroupInvitationPublicV1(operation);
