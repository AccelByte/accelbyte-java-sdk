...
public class SendPartyFreeformNotificationV1Admin implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(SendPartyFreeformNotificationV1Admin.class);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.lobby.operations.notification.SendPartyFreeformNotificationV1Admin
          operation =
              net.accelbyte.sdk.api.lobby.operations.notification
                  .SendPartyFreeformNotificationV1Admin.builder()
                  .namespace(namespace)
                  .partyId(partyId)
                  .body(
