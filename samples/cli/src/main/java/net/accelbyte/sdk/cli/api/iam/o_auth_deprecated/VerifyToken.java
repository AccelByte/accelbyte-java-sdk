...
public class VerifyToken implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.VerifyToken operation =
          net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.VerifyToken.builder()
