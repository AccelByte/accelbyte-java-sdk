...
public class ListCrossNamespaceAccountLink implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users.ListCrossNamespaceAccountLink operation =
