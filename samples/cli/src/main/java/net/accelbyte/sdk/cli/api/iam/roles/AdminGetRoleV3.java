...
public class AdminGetRoleV3 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.roles.AdminGetRoleV3 operation =
          net.accelbyte.sdk.api.iam.operations.roles.AdminGetRoleV3.builder()
              .roleId(roleId)
              .build();
      final ModelRoleResponseV3 response = wrapper.adminGetRoleV3(operation);
