...
public class PublicGetUserAppEntitlementOwnershipByAppId implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(PublicGetUserAppEntitlementOwnershipByAppId.class);
      ...
      final net.accelbyte.sdk.api.platform.operations.entitlement
          ...
          operation =
              net.accelbyte.sdk.api.platform.operations.entitlement
                  .PublicGetUserAppEntitlementOwnershipByAppId.builder()
                  .namespace(namespace)
                  .userId(userId)
                  .appId(appId)
                  .build();
