...
public class SetUserLeaderboardVisibilityStatusV2 implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(SetUserLeaderboardVisibilityStatusV2.class);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.leaderboard.operations.user_visibility
          ...
          operation =
              net.accelbyte.sdk.api.leaderboard.operations.user_visibility
                  .SetUserLeaderboardVisibilityStatusV2.builder()
