...
public class CheckUserSubscriptionSubscribableByItemId implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(CheckUserSubscriptionSubscribableByItemId.class);
      ...
      final net.accelbyte.sdk.api.platform.operations.subscription
          ...
          operation =
              net.accelbyte.sdk.api.platform.operations.subscription
                  .CheckUserSubscriptionSubscribableByItemId.builder()
                  .namespace(namespace)
                  .userId(userId)
                  .itemId(itemId)
                  .build();
