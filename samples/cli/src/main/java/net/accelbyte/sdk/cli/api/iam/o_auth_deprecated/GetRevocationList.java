...
public class GetRevocationList implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.GetRevocationList operation =
          net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.GetRevocationList.builder()
              .build();
