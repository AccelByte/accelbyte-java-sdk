...
@Command(name = "getUserFriendsWithPlatform", mixinStandardHelpOptions = true)
public class GetUserFriendsWithPlatform implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(GetUserFriendsWithPlatform.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GetUserFriendsWithPlatform()).execute(args);
