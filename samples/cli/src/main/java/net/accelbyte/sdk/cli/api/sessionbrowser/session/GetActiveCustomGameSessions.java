...
public class GetActiveCustomGameSessions implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.sessionbrowser.operations.session.GetActiveCustomGameSessions operation =
                    net.accelbyte.sdk.api.sessionbrowser.operations.session.GetActiveCustomGameSessions.builder()
                            .namespace(namespace)
