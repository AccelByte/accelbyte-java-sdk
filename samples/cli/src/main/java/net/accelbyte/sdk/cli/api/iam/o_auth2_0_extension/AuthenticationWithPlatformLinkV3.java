...
public class AuthenticationWithPlatformLinkV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.AuthenticationWithPlatformLinkV3 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.AuthenticationWithPlatformLinkV3.builder()
