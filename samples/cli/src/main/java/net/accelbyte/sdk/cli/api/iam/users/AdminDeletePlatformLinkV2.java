...
public class AdminDeletePlatformLinkV2 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users.AdminDeletePlatformLinkV2 operation =
