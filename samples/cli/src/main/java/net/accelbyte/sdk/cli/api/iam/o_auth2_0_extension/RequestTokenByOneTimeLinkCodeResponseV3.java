...
@Command(name = "requestTokenByOneTimeLinkCodeResponseV3", mixinStandardHelpOptions = true)
public class RequestTokenByOneTimeLinkCodeResponseV3 implements Callable<Integer> {
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new RequestTokenByOneTimeLinkCodeResponseV3()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final OauthmodelTokenResponseV3 response =
          wrapper.requestTokenByOneTimeLinkCodeResponseV3(operation);
