...
public class DeleteNotificationTemplateSlugV1Admin implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(DeleteNotificationTemplateSlugV1Admin.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.lobby.operations.notification.DeleteNotificationTemplateSlugV1Admin
          operation =
              net.accelbyte.sdk.api.lobby.operations.notification
                  .DeleteNotificationTemplateSlugV1Admin.builder()
                  .namespace(namespace)
