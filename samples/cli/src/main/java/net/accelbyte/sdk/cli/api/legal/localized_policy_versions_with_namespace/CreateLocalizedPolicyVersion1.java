...
@Command(name = "createLocalizedPolicyVersion1", mixinStandardHelpOptions = true)
public class CreateLocalizedPolicyVersion1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(CreateLocalizedPolicyVersion1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new CreateLocalizedPolicyVersion1()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
                  .CreateLocalizedPolicyVersion1.builder()
                  .namespace(namespace)
      ...
      final CreateLocalizedPolicyVersionResponse response =
          wrapper.createLocalizedPolicyVersion1(operation);
