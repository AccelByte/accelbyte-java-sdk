...
public class UpdateNamespace implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.basic.operations.namespace.UpdateNamespace operation =
            ...
            NamespaceInfo response =
                    wrapper.updateNamespace(operation);
