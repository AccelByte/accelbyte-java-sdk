...
@Command(name = "downloadExportedAgreementsInCSV", mixinStandardHelpOptions = true)
public class DownloadExportedAgreementsInCSV implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DownloadExportedAgreementsInCSV.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DownloadExportedAgreementsInCSV()).execute(args);
