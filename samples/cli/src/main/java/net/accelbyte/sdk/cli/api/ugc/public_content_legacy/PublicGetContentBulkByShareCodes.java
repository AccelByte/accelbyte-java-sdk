...
@Command(name = "publicGetContentBulkByShareCodes", mixinStandardHelpOptions = true)
public class PublicGetContentBulkByShareCodes implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PublicGetContentBulkByShareCodes.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicGetContentBulkByShareCodes()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.ugc.operations.public_content_legacy
          ...
          operation =
              net.accelbyte.sdk.api.ugc.operations.public_content_legacy
                  .PublicGetContentBulkByShareCodes.builder()
                  .namespace(namespace)
                  .body(
                      new ObjectMapper()
      ...
      final List<ModelsContentDownloadResponse> response =
          wrapper.publicGetContentBulkByShareCodes(operation);
