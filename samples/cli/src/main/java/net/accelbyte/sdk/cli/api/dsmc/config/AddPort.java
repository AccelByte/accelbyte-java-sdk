...
public class AddPort implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.dsmc.operations.config.AddPort operation =
          net.accelbyte.sdk.api.dsmc.operations.config.AddPort.builder()
              ...
              .build();
      final ModelsDSMConfigRecord response = wrapper.addPort(operation);
