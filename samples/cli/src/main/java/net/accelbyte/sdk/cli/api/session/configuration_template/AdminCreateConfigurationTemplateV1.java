...
@Command(name = "adminCreateConfigurationTemplateV1", mixinStandardHelpOptions = true)
public class AdminCreateConfigurationTemplateV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminCreateConfigurationTemplateV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminCreateConfigurationTemplateV1()).execute(args);
      ...
      final net.accelbyte.sdk.api.session.operations.configuration_template
          ...
          operation =
              net.accelbyte.sdk.api.session.operations.configuration_template
                  ...
                  .body(
                      new ObjectMapper()
                          .readValue(body, ApimodelsCreateConfigurationTemplateRequest.class))
                  .build();
      final ApimodelsConfigurationTemplateResponse response =
          wrapper.adminCreateConfigurationTemplateV1(operation);
