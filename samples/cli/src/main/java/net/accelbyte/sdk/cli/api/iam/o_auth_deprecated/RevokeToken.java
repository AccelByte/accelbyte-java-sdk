...
public class RevokeToken implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.RevokeToken operation =
          net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.RevokeToken.builder()
