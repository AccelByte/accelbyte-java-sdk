...
public class TestXsollaConfigById implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.payment_config.TestXsollaConfigById operation =
          net.accelbyte.sdk.api.platform.operations.payment_config.TestXsollaConfigById.builder()
              .id(id)
              .build();
      TestResult response = wrapper.testXsollaConfigById(operation);
