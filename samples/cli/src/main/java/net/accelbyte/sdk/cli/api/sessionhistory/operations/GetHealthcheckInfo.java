...
public class GetHealthcheckInfo implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.sessionhistory.operations.operations.GetHealthcheckInfo operation =
                    net.accelbyte.sdk.api.sessionhistory.operations.operations.GetHealthcheckInfo.builder()
                            .build();
