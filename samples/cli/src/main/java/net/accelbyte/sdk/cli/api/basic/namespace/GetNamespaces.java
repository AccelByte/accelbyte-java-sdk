...
public class GetNamespaces implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.basic.operations.namespace.GetNamespaces operation =
                    net.accelbyte.sdk.api.basic.operations.namespace.GetNamespaces.builder()
                            .activeOnly(activeOnly)
                            .build();
            List<NamespaceInfo> response =
                    wrapper.getNamespaces(operation);
