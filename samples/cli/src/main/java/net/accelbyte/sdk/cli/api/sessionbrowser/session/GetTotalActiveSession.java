...
public class GetTotalActiveSession implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.sessionbrowser.operations.session.GetTotalActiveSession operation =
          net.accelbyte.sdk.api.sessionbrowser.operations.session.GetTotalActiveSession.builder()
              .namespace(namespace)
              .sessionType(sessionType)
              .build();
      ModelsCountActiveSessionResponse response = wrapper.getTotalActiveSession(operation);
