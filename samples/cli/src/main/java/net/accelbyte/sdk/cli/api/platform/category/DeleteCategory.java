...
public class DeleteCategory implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.platform.operations.category.DeleteCategory operation =
            ...
            FullCategoryInfo response =
                    wrapper.deleteCategory(operation);
