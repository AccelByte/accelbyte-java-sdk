...
public class PublicGetPaymentMethods implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.payment_station.PublicGetPaymentMethods operation =
          net.accelbyte.sdk.api.platform.operations.payment_station.PublicGetPaymentMethods
              .builder()
              .namespace(namespace)
              .paymentOrderNo(paymentOrderNo)
              .build();
      List<PaymentMethod> response = wrapper.publicGetPaymentMethods(operation);
