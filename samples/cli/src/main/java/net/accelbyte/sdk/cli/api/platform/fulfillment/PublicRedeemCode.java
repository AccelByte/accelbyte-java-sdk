...
public class PublicRedeemCode implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.platform.operations.fulfillment.PublicRedeemCode operation =
            ...
            FulfillmentResult response =
                    wrapper.publicRedeemCode(operation);
