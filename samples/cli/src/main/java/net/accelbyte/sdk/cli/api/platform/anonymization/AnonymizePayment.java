...
public class AnonymizePayment implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.platform.operations.anonymization.AnonymizePayment operation =
          net.accelbyte.sdk.api.platform.operations.anonymization.AnonymizePayment.builder()
              .namespace(namespace)
              .userId(userId)
              .build();
