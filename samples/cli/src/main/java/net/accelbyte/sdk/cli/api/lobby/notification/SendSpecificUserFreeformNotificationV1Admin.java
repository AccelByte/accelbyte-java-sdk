...
public class SendSpecificUserFreeformNotificationV1Admin implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(SendSpecificUserFreeformNotificationV1Admin.class);
      ...
      final net.accelbyte.sdk.api.lobby.operations.notification
          ...
          operation =
              net.accelbyte.sdk.api.lobby.operations.notification
                  .SendSpecificUserFreeformNotificationV1Admin.builder()
                  .namespace(namespace)
                  .userId(userId)
                  .body(
