...
@Command(name = "postGameBinaryPresignedURLV1", mixinStandardHelpOptions = true)
public class PostGameBinaryPresignedURLV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PostGameBinaryPresignedURLV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PostGameBinaryPresignedURLV1()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record
          ...
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record
                  .PostGameBinaryPresignedURLV1.builder()
                  .key(key)
                  .namespace(namespace)
      ...
      final ModelsUploadBinaryRecordResponse response =
          wrapper.postGameBinaryPresignedURLV1(operation);
