...
@Command(name = "checkWallet", mixinStandardHelpOptions = true)
public class CheckWallet implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(CheckWallet.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new CheckWallet()).execute(args);
