...
public class AdminUpdateGoals implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.challenge.operations.goal_configuration.AdminUpdateGoals operation =
                    net.accelbyte.sdk.api.challenge.operations.goal_configuration.AdminUpdateGoals.builder()
            ...
            final ModelGoalResponse response =
                    wrapper.adminUpdateGoals(operation);
