...
public class PublicExistsAnyUserActiveEntitlement implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(PublicExistsAnyUserActiveEntitlement.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.platform.operations.entitlement.PublicExistsAnyUserActiveEntitlement
          operation =
              net.accelbyte.sdk.api.platform.operations.entitlement
                  .PublicExistsAnyUserActiveEntitlement.builder()
                  .namespace(namespace)
                  .userId(userId)
                  .appIds(appIds)
                  .itemIds(itemIds)
                  .skus(skus)
                  .build();
      Ownership response = wrapper.publicExistsAnyUserActiveEntitlement(operation);
