...
public class PublicExistsAnyUserActiveEntitlement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.platform.operations.entitlement.PublicExistsAnyUserActiveEntitlement operation =
                    net.accelbyte.sdk.api.platform.operations.entitlement.PublicExistsAnyUserActiveEntitlement.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .appIds(appIds)
                            .itemIds(itemIds)
                            ...
                            .build();
            Ownership response =
                    wrapper.publicExistsAnyUserActiveEntitlement(operation);
