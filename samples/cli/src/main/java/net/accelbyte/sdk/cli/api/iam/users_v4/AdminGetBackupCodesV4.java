...
@Command(name = "adminGetBackupCodesV4", mixinStandardHelpOptions = true)
public class AdminGetBackupCodesV4 implements Callable<Integer> {
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminGetBackupCodesV4()).execute(args);
