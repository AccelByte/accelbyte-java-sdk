...
@Command(name = "deleteSteamIAPConfig", mixinStandardHelpOptions = true)
public class DeleteSteamIAPConfig implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DeleteSteamIAPConfig.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteSteamIAPConfig()).execute(args);
