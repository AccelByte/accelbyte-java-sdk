...
@Command(name = "getTodayLeaderboardRankingAdminV1", mixinStandardHelpOptions = true)
public class GetTodayLeaderboardRankingAdminV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(GetTodayLeaderboardRankingAdminV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GetTodayLeaderboardRankingAdminV1()).execute(args);
