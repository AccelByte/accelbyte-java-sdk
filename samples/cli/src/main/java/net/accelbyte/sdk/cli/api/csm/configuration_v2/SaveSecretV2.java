...
@Command(name = "saveSecretV2", mixinStandardHelpOptions = true)
public class SaveSecretV2 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(SaveSecretV2.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new SaveSecretV2()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.csm.operations.configuration_v2.SaveSecretV2 operation =
