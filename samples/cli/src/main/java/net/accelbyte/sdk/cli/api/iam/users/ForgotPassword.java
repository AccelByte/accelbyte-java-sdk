...
@Command(name = "forgotPassword", mixinStandardHelpOptions = true)
public class ForgotPassword implements Callable<Integer> {
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new ForgotPassword()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users.ForgotPassword operation =
