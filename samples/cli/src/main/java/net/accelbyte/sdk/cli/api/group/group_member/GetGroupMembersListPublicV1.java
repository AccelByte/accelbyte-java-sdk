...
public class GetGroupMembersListPublicV1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.group.operations.group_member.GetGroupMembersListPublicV1 operation =
          net.accelbyte.sdk.api.group.operations.group_member.GetGroupMembersListPublicV1.builder()
              .groupId(groupId)
              .namespace(namespace)
              .limit(limit)
              .offset(offset)
              .order(order)
              .build();
      ModelsGetGroupMemberListResponseV1 response = wrapper.getGroupMembersListPublicV1(operation);
