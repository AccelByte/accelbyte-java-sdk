...
public class GetGroupMembersListPublicV1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.group.operations.group_member.GetGroupMembersListPublicV1
          operation =
              net.accelbyte.sdk.api.group.operations.group_member.GetGroupMembersListPublicV1
                  .builder()
                  .groupId(groupId)
                  .namespace(namespace)
                  .limit(limit)
