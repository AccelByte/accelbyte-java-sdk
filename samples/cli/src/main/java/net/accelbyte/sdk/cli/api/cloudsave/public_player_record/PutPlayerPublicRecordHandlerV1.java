...
public class PutPlayerPublicRecordHandlerV1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.cloudsave.operations.public_player_record.PutPlayerPublicRecordHandlerV1
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_player_record
                  .PutPlayerPublicRecordHandlerV1.builder()
                  .key(key)
                  .namespace(namespace)
                  .userId(userId)
                  .body(new ObjectMapper().readValue(body, ModelsPlayerRecordRequest.class))
                  .build();
      ModelsPlayerRecordResponse response = wrapper.putPlayerPublicRecordHandlerV1(operation);
