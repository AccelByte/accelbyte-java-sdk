...
public class PublicCreateTestUserV4 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.iam.operations.users_v4.PublicCreateTestUserV4 operation =
          net.accelbyte.sdk.api.iam.operations.users_v4.PublicCreateTestUserV4.builder()
              .namespace(namespace)
              .body(new ObjectMapper().readValue(body, AccountCreateTestUserRequestV4.class))
              .build();
      final AccountCreateUserResponseV4 response = wrapper.publicCreateTestUserV4(operation);
