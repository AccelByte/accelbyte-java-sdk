...
@Command(name = "publicEnableBackupCodesV4", mixinStandardHelpOptions = true)
public class PublicEnableBackupCodesV4 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(PublicEnableBackupCodesV4.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicEnableBackupCodesV4()).execute(args);
