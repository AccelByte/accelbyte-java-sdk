...
public class AdminQueryTopic implements Callable<Integer> {
    ...
    @Option(names = {"--includeMembers"}, description = "includeMembers")
    Boolean includeMembers;

    @Option(names = {"--includePastMembers"}, description = "includePastMembers")
        ...
        try {
            ...
            final net.accelbyte.sdk.api.chat.operations.topic.AdminQueryTopic operation =
                    net.accelbyte.sdk.api.chat.operations.topic.AdminQueryTopic.builder()
                            ...
                            .userId(userId)
                            .build();
            final List<ModelsTopicInfo> response =
                    wrapper.adminQueryTopic(operation);
