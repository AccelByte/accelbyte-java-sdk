...
@Command(name = "adminUpdateConfigurationTemplateV1", mixinStandardHelpOptions = true)
public class AdminUpdateConfigurationTemplateV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(AdminUpdateConfigurationTemplateV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new AdminUpdateConfigurationTemplateV1()).execute(args);
      ...
      final net.accelbyte.sdk.api.session.operations.configuration_template
          ...
          operation =
              net.accelbyte.sdk.api.session.operations.configuration_template
                  ...
                  .body(
                      new ObjectMapper()
                          .readValue(body, ApimodelsUpdateConfigurationTemplateRequest.class))
                  .build();
      final ApimodelsConfigurationTemplateResponse response =
          wrapper.adminUpdateConfigurationTemplateV1(operation);
