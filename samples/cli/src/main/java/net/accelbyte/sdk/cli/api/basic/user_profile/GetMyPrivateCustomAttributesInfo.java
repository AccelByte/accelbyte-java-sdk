...
@Command(name = "getMyPrivateCustomAttributesInfo", mixinStandardHelpOptions = true)
public class GetMyPrivateCustomAttributesInfo implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(GetMyPrivateCustomAttributesInfo.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GetMyPrivateCustomAttributesInfo()).execute(args);
