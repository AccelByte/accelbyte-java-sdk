...
@Command(name = "oldRetrieveLocalizedPolicyVersions", mixinStandardHelpOptions = true)
public class OldRetrieveLocalizedPolicyVersions implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(OldRetrieveLocalizedPolicyVersions.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new OldRetrieveLocalizedPolicyVersions()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions
                  .OldRetrieveLocalizedPolicyVersions.builder()
                  .policyVersionId(policyVersionId)
                  .build();
      final List<RetrieveLocalizedPolicyVersionResponse> response =
          wrapper.oldRetrieveLocalizedPolicyVersions(operation);
