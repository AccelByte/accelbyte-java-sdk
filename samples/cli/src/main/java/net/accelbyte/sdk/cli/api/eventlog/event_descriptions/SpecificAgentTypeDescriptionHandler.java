...
public class SpecificAgentTypeDescriptionHandler implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.eventlog.operations.event_descriptions.SpecificAgentTypeDescriptionHandler operation =
                    net.accelbyte.sdk.api.eventlog.operations.event_descriptions.SpecificAgentTypeDescriptionHandler.builder()
