...
public class PublicGetMyUserV3 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.iam.operations.users.PublicGetMyUserV3 operation =
          net.accelbyte.sdk.api.iam.operations.users.PublicGetMyUserV3.builder().build();
      ModelUserResponseV3 response = wrapper.publicGetMyUserV3(operation);
