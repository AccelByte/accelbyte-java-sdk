...
@Command(name = "getOtherPlayerPublicRecordKeyHandlerV1", mixinStandardHelpOptions = true)
public class GetOtherPlayerPublicRecordKeyHandlerV1 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(GetOtherPlayerPublicRecordKeyHandlerV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new GetOtherPlayerPublicRecordKeyHandlerV1()).execute(args);
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.public_player_record
          ...
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_player_record
                  .GetOtherPlayerPublicRecordKeyHandlerV1.builder()
                  .namespace(namespace)
                  .userId(userId)
                  .limit(limit)
                  .offset(offset)
