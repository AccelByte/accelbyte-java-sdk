...
public class GetUserStatus implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.basic.operations.user_action.GetUserStatus operation =
          net.accelbyte.sdk.api.basic.operations.user_action.GetUserStatus.builder()
              .namespace(namespace)
              .userId(userId)
              .build();
      final ADTOObjectForEqu8UserStatus response = wrapper.getUserStatus(operation);
