...
public class AdminPutPlayerPublicRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminPutPlayerPublicRecordHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminPutPlayerPublicRecordHandlerV1.builder()
                            .key(key)
                            .namespace(namespace)
                            .userId(userId)
                            .body(new ObjectMapper().readValue(body, ModelsPlayerRecordRequest.class)) 
                            .build();
                    wrapper.adminPutPlayerPublicRecordHandlerV1(operation);
