...
@Command(name = "publicQueryUserThirdPartySubscription", mixinStandardHelpOptions = true)
public class PublicQueryUserThirdPartySubscription implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(PublicQueryUserThirdPartySubscription.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new PublicQueryUserThirdPartySubscription()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.platform.operations.iap_subscription
          ...
          operation =
              net.accelbyte.sdk.api.platform.operations.iap_subscription
                  .PublicQueryUserThirdPartySubscription.builder()
                  .namespace(namespace)
                  .platform(platform)
                  .userId(userId)
      ...
      final ThirdPartyUserSubscriptionPagingSlicedResult response =
          wrapper.publicQueryUserThirdPartySubscription(operation);
