...
public class SendMultipleUsersFreeformNotificationV1Admin implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(SendMultipleUsersFreeformNotificationV1Admin.class);
  ...
  public static void main(String[] args) {
    int exitCode =
        new CommandLine(new SendMultipleUsersFreeformNotificationV1Admin()).execute(args);
      ...
      final net.accelbyte.sdk.api.lobby.operations.notification
          ...
          operation =
              net.accelbyte.sdk.api.lobby.operations.notification
                  .SendMultipleUsersFreeformNotificationV1Admin.builder()
                  .namespace(namespace)
                  .body(
                      new ObjectMapper()
                          .readValue(body, ModelBulkUsersFreeFormNotificationRequestV1.class))
                  .build();
