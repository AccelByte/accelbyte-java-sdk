...
@Command(name = "oldUpdateLocalizedPolicyVersion", mixinStandardHelpOptions = true)
public class OldUpdateLocalizedPolicyVersion implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(OldUpdateLocalizedPolicyVersion.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new OldUpdateLocalizedPolicyVersion()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions
              .OldUpdateLocalizedPolicyVersion
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions
                  .OldUpdateLocalizedPolicyVersion.builder()
      ...
      final UpdateLocalizedPolicyVersionResponse response =
          wrapper.oldUpdateLocalizedPolicyVersion(operation);
