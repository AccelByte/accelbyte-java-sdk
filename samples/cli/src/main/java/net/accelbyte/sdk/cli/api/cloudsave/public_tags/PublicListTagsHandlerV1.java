...
package net.accelbyte.sdk.cli.api.cloudsave.public_tags;

import com.fasterxml.jackson.databind.ObjectMapper;
import java.util.*;
import java.util.concurrent.Callable;
import net.accelbyte.sdk.api.cloudsave.models.*;
import net.accelbyte.sdk.api.cloudsave.wrappers.PublicTags;
...
public class PublicListTagsHandlerV1 implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.public_tags.PublicListTagsHandlerV1
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_tags.PublicListTagsHandlerV1
                  .builder()
                  .namespace(namespace)
                  .limit(limit)
                  .offset(offset)
