...
public class ReportUser implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.basic.operations.user_action.ReportUser operation =
          net.accelbyte.sdk.api.basic.operations.user_action.ReportUser.builder()
              .namespace(namespace)
