...
@Command(name = "setDefaultLocalizedPolicy", mixinStandardHelpOptions = true)
public class SetDefaultLocalizedPolicy implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(SetDefaultLocalizedPolicy.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new SetDefaultLocalizedPolicy()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
                  .SetDefaultLocalizedPolicy.builder()
