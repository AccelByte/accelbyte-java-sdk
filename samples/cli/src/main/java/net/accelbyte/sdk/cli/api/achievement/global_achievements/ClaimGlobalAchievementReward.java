...
@Command(name = "claimGlobalAchievementReward", mixinStandardHelpOptions = true)
public class ClaimGlobalAchievementReward implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(ClaimGlobalAchievementReward.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new ClaimGlobalAchievementReward()).execute(args);
      ...
      final net.accelbyte.sdk.api.achievement.operations.global_achievements
          ...
          operation =
              net.accelbyte.sdk.api.achievement.operations.global_achievements
                  .ClaimGlobalAchievementReward.builder()
