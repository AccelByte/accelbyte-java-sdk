...
@Command(name = "retrieveAllUsersByPolicyVersion1", mixinStandardHelpOptions = true)
public class RetrieveAllUsersByPolicyVersion1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(RetrieveAllUsersByPolicyVersion1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new RetrieveAllUsersByPolicyVersion1()).execute(args);
