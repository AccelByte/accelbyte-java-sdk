...
@Command(name = "bulkGetMyBinaryRecordV1", mixinStandardHelpOptions = true)
public class BulkGetMyBinaryRecordV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(BulkGetMyBinaryRecordV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new BulkGetMyBinaryRecordV1()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record
          ...
          operation =
              net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record
                  .BulkGetMyBinaryRecordV1.builder()
                  .namespace(namespace)
      ...
      final ModelsBulkGetPlayerBinaryRecordResponse response =
          wrapper.bulkGetMyBinaryRecordV1(operation);
