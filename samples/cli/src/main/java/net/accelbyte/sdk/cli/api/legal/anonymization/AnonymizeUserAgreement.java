...
public class AnonymizeUserAgreement implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.legal.operations.anonymization.AnonymizeUserAgreement operation =
