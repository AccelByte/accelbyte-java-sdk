...
public class PlatformTokenRequestHandler implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.PlatformTokenRequestHandler operation =
          net.accelbyte.sdk.api.iam.operations.o_auth_deprecated.PlatformTokenRequestHandler
              .builder()
              .namespace(namespace)
