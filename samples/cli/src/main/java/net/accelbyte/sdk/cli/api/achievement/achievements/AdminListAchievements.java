...
public class AdminListAchievements implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.achievement.operations.achievements.AdminListAchievements operation =
          net.accelbyte.sdk.api.achievement.operations.achievements.AdminListAchievements.builder()
              .namespace(namespace)
              .limit(limit)
              .offset(offset)
              .sortBy(sortBy)
              .build();
      ModelsPaginatedAchievementResponse response = wrapper.adminListAchievements(operation);
