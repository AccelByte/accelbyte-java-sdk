...
@Command(name = "deletePolicyVersion", mixinStandardHelpOptions = true)
public class DeletePolicyVersion implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(DeletePolicyVersion.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeletePolicyVersion()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace
                  .DeletePolicyVersion.builder()
                  .namespace(namespace)
                  .policyVersionId(policyVersionId)
                  .build();
      wrapper.deletePolicyVersion(operation);
