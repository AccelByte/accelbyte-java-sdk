...
@Command(name = "deleteAllUserRankingByCycleIdAdminV3", mixinStandardHelpOptions = true)
public class DeleteAllUserRankingByCycleIdAdminV3 implements Callable<Integer> {

  private static final Logger log =
      LogManager.getLogger(DeleteAllUserRankingByCycleIdAdminV3.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new DeleteAllUserRankingByCycleIdAdminV3()).execute(args);
      ...
      final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
          ...
          operation =
              net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3
                  .DeleteAllUserRankingByCycleIdAdminV3.builder()
                  .cycleId(cycleId)
