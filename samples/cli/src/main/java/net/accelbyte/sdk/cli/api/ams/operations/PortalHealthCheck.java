...
public class PortalHealthCheck implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.ams.operations.operations.PortalHealthCheck operation =
          net.accelbyte.sdk.api.ams.operations.operations.PortalHealthCheck.builder().build();
