...
@Command(name = "retrievePolicyCountry1", mixinStandardHelpOptions = true)
public class RetrievePolicyCountry1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(RetrievePolicyCountry1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new RetrievePolicyCountry1()).execute(args);
      ...
      final net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace
                  .RetrievePolicyCountry1.builder()
                  .basePolicyId(basePolicyId)
                  .countryCode(countryCode)
                  .namespace(namespace)
                  .build();
      final RetrievePolicyResponse response = wrapper.retrievePolicyCountry1(operation);
