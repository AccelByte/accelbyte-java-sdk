...
@Command(name = "updateLocalizedPolicyVersion1", mixinStandardHelpOptions = true)
public class UpdateLocalizedPolicyVersion1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(UpdateLocalizedPolicyVersion1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new UpdateLocalizedPolicyVersion1()).execute(args);
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
          ...
          operation =
              net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace
                  .UpdateLocalizedPolicyVersion1.builder()
      ...
      final UpdateLocalizedPolicyVersionResponse response =
          wrapper.updateLocalizedPolicyVersion1(operation);
