...
public class GetAllTimeLeaderboardRankingPublicV1 implements Runnable {
    ...
    public void run() {
        try {
            ...
            .getAllTimeLeaderboardRankingPublicV1(
                new net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetAllTimeLeaderboardRankingPublicV1(
                    leaderboardCode,
                    namespace,
                    limit,
                    offset
