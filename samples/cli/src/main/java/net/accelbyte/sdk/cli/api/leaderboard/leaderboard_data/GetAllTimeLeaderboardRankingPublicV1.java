...
public class GetAllTimeLeaderboardRankingPublicV1 implements Callable<Integer> {
    ...
    private static final Logger log = LogManager.getLogger(GetAllTimeLeaderboardRankingPublicV1.class);
    ...
    public Integer call() {
        try {
            ...
            net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetAllTimeLeaderboardRankingPublicV1 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetAllTimeLeaderboardRankingPublicV1.builder()
