...
@Command(name = "leaveGroupPublicV1", mixinStandardHelpOptions = true)
public class LeaveGroupPublicV1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(LeaveGroupPublicV1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new LeaveGroupPublicV1()).execute(args);
