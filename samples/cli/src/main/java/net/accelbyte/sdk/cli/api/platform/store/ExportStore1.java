...
@Command(name = "exportStore1", mixinStandardHelpOptions = true)
public class ExportStore1 implements Callable<Integer> {

  private static final Logger log = LogManager.getLogger(ExportStore1.class);
  ...
  public static void main(String[] args) {
    int exitCode = new CommandLine(new ExportStore1()).execute(args);
