...
public class GetRegisteredEventsByEventTypeHandler implements Callable<Integer> {
  ...
  public Integer call() {
    try {
      ...
      final net.accelbyte.sdk.api.eventlog.operations.event_registry
          ...
          operation =
              net.accelbyte.sdk.api.eventlog.operations.event_registry
                  ...
                  .eventType(eventType)
                  .build();
      final ModelsEventRegistry response = wrapper.getRegisteredEventsByEventTypeHandler(operation);
