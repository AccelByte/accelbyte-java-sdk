...
public class GetRegisteredEventsByEventTypeHandler implements Callable<Integer> {
  ...
  private static final Logger log =
      LogManager.getLogger(GetRegisteredEventsByEventTypeHandler.class);
  ...
  public Integer call() {
    try {
      ...
      net.accelbyte.sdk.api.eventlog.operations.event_registry.GetRegisteredEventsByEventTypeHandler
          operation =
              net.accelbyte.sdk.api.eventlog.operations.event_registry
                  .GetRegisteredEventsByEventTypeHandler.builder()
                  .eventType(eventType)
                  .build();
      ModelsEventRegistry response = wrapper.getRegisteredEventsByEventTypeHandler(operation);
