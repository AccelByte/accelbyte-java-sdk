...
#- 15 ConnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: connectNotif\nlobbySessionId: rBePwvLy' -u \
    > test.out 2>&1
eval_tap $? 15 'ConnectNotif' test.out

#- 16 DisconnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: disconnectNotif\nconnectionId: 8dLPRiTV\nnamespace: trFianvJ' -u \
    > test.out 2>&1
eval_tap $? 16 'DisconnectNotif' test.out

#- 17 DsNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: dsNotif\nalternateIps: [i9QFRAcp,it4swP4U,AFirxxy3]\ncustomAttribute: h96RGzl8\ndeployment: UoZqGoOM\ngameVersion: C6oGm3xe\nimageVersion: Vquu1HX7\nip: wAz1PDeP\nisOK: True\nisOverrideGameVersion: True\nlastUpdate: aCknaegg\nmatchId: 5zsT7RB6\nmessage: H9uABUcJ\nnamespace: cOrSQeZM\npodName: xPGMmQCC\nport: 80\nports: {"pkFCRmCS":13,"eGEF7RsW":54,"Z7oDnkZC":49}\nprotocol: FkJjQmo9\nprovider: mKDA4rwO\nregion: eKdsCcdn\nsessionId: AEcgZhl6\nstatus: rElqW3Wz' -u \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: friendsStatusResponse\nid: eU1JBtSP\nactivity: [NYjGu8If,p8KnmAAP,cyWk13Dw]\navailability: [10,9,11]\ncode: 98\nfriendIds: [zDq2c697,zpWwv6Vc,mNFUPoY0]\nlastSeenAt: [o1ZiJWxi,UeyRIX9r,s6QRUaxK]' -u \
    > test.out 2>&1
