...
#- 15 ConnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: connectNotif\nlobbySessionId: B7CPgsCE' -u \
    > test.out 2>&1
eval_tap $? 15 'ConnectNotif' test.out

#- 16 DisconnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: disconnectNotif\nconnectionId: GDr35sc4\nnamespace: hMmU49lS' -u \
    > test.out 2>&1
eval_tap $? 16 'DisconnectNotif' test.out

#- 17 DsNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: dsNotif\nalternateIps: [ZYOWD39d,eafWrbl2,09ejwjCe]\ncustomAttribute: kTtLFD0e\ndeployment: 7lP1zke6\ngameVersion: 1XmE5yeV\nimageVersion: hnLcOxOT\nip: xi6HY1QJ\nisOK: True\nisOverrideGameVersion: False\nlastUpdate: 1vFfk6uP\nmatchId: h7ToeKnO\nmessage: XaJGX7Mu\nnamespace: YgbKKRqb\npodName: 04ukGjq0\nport: 44\nports: {"wmL13EPX":64,"Suqv6oAC":77,"LS7pQAB6":91}\nprotocol: klO2L8jM\nprovider: Y8lljKTL\nregion: 1S20Z6Ub\nsessionId: nkEKwVFx\nstatus: btpjEIDy' -u \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: friendsStatusResponse\nid: 1EvHOBZB\nactivity: [BcNGEWPG,SFlO8iLp,ZJk7xK43]\navailability: [33,16,91]\ncode: 7\nfriendIds: [UkSzuBdS,FSX3w8Td,Cr82Bz9F]\nlastSeenAt: [ZI8N6Hoa,eCFSxAp4,IDv3ZpNR]' -u \
    > test.out 2>&1
