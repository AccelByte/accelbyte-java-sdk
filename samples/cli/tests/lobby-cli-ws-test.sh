...
#- 15 ConnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: connectNotif\nlobbySessionId: IcioSlSP' -u \
    > test.out 2>&1
eval_tap $? 15 'ConnectNotif' test.out

#- 16 DisconnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: disconnectNotif\nconnectionId: oKSaTqoA\nnamespace: rNsTIXbq' -u \
    > test.out 2>&1
eval_tap $? 16 'DisconnectNotif' test.out

#- 17 DsNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: dsNotif\nalternateIps: [Hsghaf2J,a1loIu9j,1F9IcJYc]\ncustomAttribute: WaokaenI\ndeployment: Wm8EaahT\ngameVersion: 0r8wOmXv\nimageVersion: 7hKJqM0j\nip: d7BGalGG\nisOK: True\nisOverrideGameVersion: False\nlastUpdate: vRZ31vh3\nmatchId: sDTRcZVw\nmessage: GIx49dxW\nnamespace: zzbMGB6i\npodName: Mcy7xXZ3\nport: 69\nports: {"zdxnLh4L":1,"5baCR0WL":86,"Xwlv474g":57}\nprotocol: oiGiO0aS\nprovider: yBxU04op\nregion: ziGLX02w\nsessionId: ysPBZ6mJ\nstatus: liD7koxh' -u \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: friendsStatusResponse\nid: nRP46cHM\nactivity: [w0gTnTal,xN3LbtjY,e2iLHquo]\navailability: [3,26,59]\ncode: 27\nfriendIds: [PAOqAI2Z,wpnn810H,RqIXjBxS]\nlastSeenAt: [7tVTeQpf,rs4oGKtt,2F07ykK4]' -u \
    > test.out 2>&1
