...
#- 15 ConnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: connectNotif\nlobbySessionId: 2yXHovIa' -u \
    > test.out 2>&1
eval_tap $? 15 'ConnectNotif' test.out

#- 16 DisconnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: disconnectNotif\nconnectionId: knQS0s9C\nnamespace: w2Eoho63' -u \
    > test.out 2>&1
eval_tap $? 16 'DisconnectNotif' test.out

#- 17 DsNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: dsNotif\nalternateIps: [u7yeP7dn,gRW3doC1,T4aO6jz3]\ncustomAttribute: VAYRWMp0\ndeployment: zghlXhX6\ngameVersion: 3MugU3u0\nimageVersion: LCgNlx9g\nip: 3vtAjuLh\nisOK: False\nisOverrideGameVersion: False\nlastUpdate: Qi3od5lr\nmatchId: vlJidbZU\nmessage: 88p6XCj3\nnamespace: swtyr107\npodName: BKKzCO1z\nport: 85\nports: {"gpthzHLl":100,"bYIjgPGV":86,"Vn5QvoM2":45}\nprotocol: EEwRIQg4\nprovider: bio6X5bL\nregion: mPFFNNZF\nsessionId: kdphaBEk\nstatus: fOCwNceS' -u \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: friendsStatusResponse\nid: fncclGIc\nactivity: [OVgUOslz,xhQsd8aO,qiFsk9oN]\navailability: [100,58,93]\ncode: 54\nfriendIds: [LL5oGYuB,bq3D4z4Q,CgFlTDIk]\nlastSeenAt: [iHhIBU5a,SHmn5uQ6,hDErsVS9]' -u \
    > test.out 2>&1
