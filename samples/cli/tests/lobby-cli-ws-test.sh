...
#- 15 ConnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: connectNotif\nlobbySessionId: BHiFG7Mc' -u \
    > test.out 2>&1
eval_tap $? 15 'ConnectNotif' test.out

#- 16 DisconnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: disconnectNotif\nconnectionId: 0VUCZuZV\nnamespace: S9pTWXQN' -u \
    > test.out 2>&1
eval_tap $? 16 'DisconnectNotif' test.out

#- 17 DsNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: dsNotif\nalternateIps: [n4NKK4dQ,YgRr3NWR,cyzWf9zU]\ncustomAttribute: cN7z87Jq\ndeployment: qFuYtyLp\ngameVersion: 8E05g6y3\nimageVersion: oRD3fzP4\nip: jkzIwfEb\nisOK: True\nisOverrideGameVersion: True\nlastUpdate: v9T9SOnJ\nmatchId: ad8lrnq9\nmessage: jrYjGcie\nnamespace: Vxpl0ZjJ\npodName: zxQEWtzt\nport: 68\nports: {"EtA06O00":16,"hL5fAsxJ":83,"xWEMKTXx":94}\nprotocol: BcgmLO1p\nprovider: VZcCsV8S\nregion: 2wVZd2Zh\nsessionId: siZ79j9h\nstatus: OPqvBPIj' -u \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: friendsStatusResponse\nid: VldsvvEG\nactivity: [1nLMRtsC,ICRz5gTG,3waP3ZSq]\navailability: [12,62,91]\ncode: 76\nfriendIds: [2xTg8Fv2,ZW4Iyi33,vVzOjepQ]\nlastSeenAt: [XhvNqfxR,DrawXZFB,g916QLVM]' -u \
    > test.out 2>&1
