...
#- 15 ConnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: connectNotif\nlobbySessionId: 2ZjhqUU9' -u \
    > test.out 2>&1
eval_tap $? 15 'ConnectNotif' test.out

#- 16 DisconnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: disconnectNotif\nconnectionId: ZjpSspiw\nnamespace: xeiQvdml' -u \
    > test.out 2>&1
eval_tap $? 16 'DisconnectNotif' test.out

#- 17 DsNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: dsNotif\nalternateIps: [b5DQZmNO,peHeopAq,HfvjA7pK]\ncustomAttribute: mhgT7I9u\ndeployment: TRjHrYrt\ngameVersion: BA1yvVjD\nimageVersion: G4TKt0Ah\nip: gdAxlJNV\nisOK: True\nisOverrideGameVersion: True\nlastUpdate: Zptza5Df\nmatchId: ILqBa9wu\nmessage: 7Gg4dqCS\nnamespace: 0jCQtvjd\npodName: dVvPc7p9\nport: 26\nports: {"fTm2mNMK":58,"8xeh4Kbj":28,"evRfNg04":60}\nprotocol: AykSPLb7\nprovider: 3n3A3445\nregion: 3V0XiLQB\nsessionId: H9FPtupP\nstatus: Z1I61xbP' -u \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: friendsStatusResponse\nid: uKqzoj4D\nactivity: [CyvcPWhv,Po4mkML0,n3ow8Zdl]\navailability: [61,37,76]\ncode: 81\nfriendIds: [ReZ62O0P,cmgX6JDg,XrfMJEjm]\nlastSeenAt: [qfdEpZX3,PAsdS613,5uldwKpn]' -u \
    > test.out 2>&1
