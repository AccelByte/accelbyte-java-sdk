...
#- 15 ConnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: connectNotif\nlobbySessionId: HTjsxyyo' -u \
    > test.out 2>&1
eval_tap $? 15 'ConnectNotif' test.out

#- 16 DisconnectNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: disconnectNotif\nconnectionId: nHmYUbW9\nnamespace: 3JFe44Gl' -u \
    > test.out 2>&1
eval_tap $? 16 'DisconnectNotif' test.out

#- 17 DsNotif
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: dsNotif\nalternateIps: [mYnaDoss,ijpdVmcX,8yYdRMih]\ncustomAttribute: vBPthtOZ\ndeployment: 3OWF6PYG\ngameVersion: ygboI6hA\nimageVersion: 1shL5DFz\nip: dRr2Cec8\nisOK: False\nisOverrideGameVersion: True\nlastUpdate: ABQw3Ty2\nmatchId: sKFi8DJu\nmessage: yduy5YSK\nnamespace: enx53e0x\npodName: g9U4IKRO\nport: 64\nports: {"cowP0P3j":73,"wxThRvHZ":78,"TJLFO3cZ":40}\nprotocol: PNQXOxdL\nprovider: vKs1jK84\nregion: qiOyU8aL\nsessionId: 4B1pe6vu\nstatus: f1UIGeWq' -u \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: friendsStatusResponse\nid: Kb0tSEun\nactivity: [lkHEGdFX,Lri5lzFS,yr4oTpXZ]\navailability: [73,98,6]\ncode: 30\nfriendIds: [64fIs1ba,zD3vlLPs,kI3rdI7d]\nlastSeenAt: [SmH3GsaB,NoSiPokP,6cVdrSsA]' -u \
    > test.out 2>&1
