...
./ng net.accelbyte.sdk.cli.Main platform queryItems \
    ...
    --sortBy 'displayOrder:desc,updatedAt:asc,name:desc' \
...
./ng net.accelbyte.sdk.cli.Main platform queryUncategorizedItems \
    ...
    --limit '39' \
    --offset '21' \
    --sortBy 'createdAt,displayOrder:desc,displayOrder:asc' \
...
./ng net.accelbyte.sdk.cli.Main platform updateItemPurchaseCondition \
    ...
    --body '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 49, "code": "b21jxeWXk80y9uxg", "comparison": "isNot", "name": "LGgK8aVSCN6oCETQ", "predicateType": "EntitlementPredicate", "value": "MJbJIYLssMvy9gkf", "values": ["C8hEguCqlMHiQN3H", "DfNfPGYYSTunMgt3", "TMRrXVRcAVRDX6gm"]}, {"anyOf": 99, "code": "GRufOUGfMjTU226l", "comparison": "isNot", "name": "7jPlcYaqYM7YfBmh", "predicateType": "SeasonPassPredicate", "value": "AEl6A9sh2x2ur2cc", "values": ["2e6gtn5pUARJM1T8", "p7R7OqPqIjS4i0N9", "ytb3c8pVZ8GlU896"]}, {"anyOf": 87, "code": "aixUUvmzbajE2gjo", "comparison": "isGreaterThan", "name": "6a280S5RNB5dVCsB", "predicateType": "StatisticCodePredicate", "value": "tkWaMOH47CAT7cBP", "values": ["nBBR84iAO7sBQt6Y", "0918JaEBQBP766LU", "J2tWwF7RnP1oK3c4"]}]}, {"operator": "and", "predicates": [{"anyOf": 98, "code": "0sMY8es36r1FgR70", "comparison": "includes", "name": "ol1qqbalgizL97yc", "predicateType": "StatisticCodePredicate", "value": "V5YqE2myQzl7X9fH", "values": ["r6WvBxmBvNj3ktaD", "zaZUTmvsEzLPnnGs", "f9B22HGgxakPt7IY"]}, {"anyOf": 27, "code": "7H7yIS7b5TSDRIoM", "comparison": "includes", "name": "1vyamjsEzwtLPxK1", "predicateType": "SeasonPassPredicate", "value": "IaEMW5bhJyL72WDy", "values": ["hBsCCbnfihnXKxGx", "SHQh8I9xk3sFl0cb", "aupnTTq9ihZkvFKf"]}, {"anyOf": 41, "code": "hniEHLbEQKc0aUvr", "comparison": "is", "name": "DIjYC4df9qswSlpC", "predicateType": "StatisticCodePredicate", "value": "4ulonMFjmYqE1wJh", "values": ["SaZAIadKDEZywonA", "fogWg2Apm0sUy18a", "Wn65Co0vdCk8so6J"]}]}, {"operator": "or", "predicates": [{"anyOf": 62, "code": "aulsL6NOV5agpS6A", "comparison": "includes", "name": "mkufBpWVxIK9D2bT", "predicateType": "EntitlementPredicate", "value": "Wbs5qugklBUS6uwW", "values": ["cyNkUvqn6eXr6FNb", "rCQt86Jrg8tLAJWp", "KJ05Orya6LSSUlug"]}, {"anyOf": 70, "code": "uQNGIDeHlf6IcX1K", "comparison": "is", "name": "JrK6Or2xx7rLwrPo", "predicateType": "SeasonPassPredicate", "value": "jrpRo4mYrCeQUnYo", "values": ["j3dbRTI0i6dO3zkb", "ID2UqO0iAXA9dB4i", "b8HDOJ8TNiP8KgEA"]}, {"anyOf": 60, "code": "B0sL2xt6fX9j7rhZ", "comparison": "isNot", "name": "qVUaWMJBjrV0p9A7", "predicateType": "SeasonTierPredicate", "value": "E7CL1cQCSoqHvH7g", "values": ["rF5i3gr3Cc4M2O7N", "63cOx6yrIw37pKOL", "rTQO7KLdZDGwqx7T"]}]}]}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkCredit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"creditRequest": {"amount": 50, "expireAt": "1992-12-13T00:00:00Z", "metadata": {"yze6zPKu5sE89JW8": {}, "UU0RsB6dvrpmInhH": {}, "YzVVlHGFSwjby6rM": {}}, "origin": "System", "reason": "kVQnZDUAbINRKQsx", "source": "REWARD"}, "currencyCode": "UnHnfrEdDfY4TTxu", "userIds": ["ZEuXQACDDQryNf9V", "dcQqZ9F1uivPob0Y", "8goZgsX4RwfM4qnU"]}, {"creditRequest": {"amount": 67, "expireAt": "1990-07-08T00:00:00Z", "metadata": {"rqgEIsMwNbfti0Lo": {}, "TBcNzyoCSw1t653G": {}, "3ydYmGzvx9bSqqyA": {}}, "origin": "Xbox", "reason": "6xNel4Bxb9KwFYqd", "source": "CONSUME_ENTITLEMENT"}, "currencyCode": "o7gOFVLZCBWuVIRO", "userIds": ["NkaIQJfkFDhSeSGX", "ZuqdJBi8pkn98VtL", "tZU5SuIhMSaDRp17"]}, {"creditRequest": {"amount": 9, "expireAt": "1992-12-25T00:00:00Z", "metadata": {"WHcjrb6qNeKpOxPr": {}, "lG9svdqsiVTqPbzY": {}, "1yxl7zeEpmSPO6Kw": {}}, "origin": "IOS", "reason": "djaJuUzFIeqaVr1C", "source": "PROMOTION"}, "currencyCode": "9OoiPdnq9KBqBwiN", "userIds": ["wW3EwLre1bL4dJnk", "CsnK8CcO1OHbpQZt", "RLJbMvOGSd7uMrmQ"]}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkDebit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"currencyCode": "2SaLd6M7TM3wnJyE", "request": {"allowOverdraft": true, "amount": 91, "balanceOrigin": "Other", "balanceSource": "PAYMENT", "metadata": {"o5z9RAcYgYZb7cAa": {}, "kJpqN6eubdp49JFw": {}, "XG0EvoSHNC97eEyh": {}}, "reason": "nL1QH5AlYRAqCAC2"}, "userIds": ["6jW6fjtBcO3fWq9q", "gy1WF9QLNgDxAkwg", "fB8jIecOx5ugNCDd"]}, {"currencyCode": "fmBv0XgJB6a7uykA", "request": {"allowOverdraft": true, "amount": 26, "balanceOrigin": "System", "balanceSource": "DLC_REVOCATION", "metadata": {"pinFcH2ZMSYijqEu": {}, "MfuYFUS079tOpZYM": {}, "1XV0Op0damycnTUO": {}}, "reason": "oMkOppZNOkqxc42H"}, "userIds": ["SxwzuIpGBYHTHoSV", "Kv5wvtPJVsuzaBci", "xgQCbpZx5yMGIQ1Z"]}, {"currencyCode": "xVIefYlKBJyQMqUE", "request": {"allowOverdraft": false, "amount": 15, "balanceOrigin": "Steam", "balanceSource": "OTHER", "metadata": {"ikX6yOlgZrn0I6T0": {}, "hvcAFTaSWR4VOGIY": {}, "7hM6uhonkAe0FdTS": {}}, "reason": "SEluBxM47BTww3nB"}, "userIds": ["FeExlOFjRh8mLFTJ", "TVmBFZ6TIs9bTi2m", "7eNsYEqKkeuLWDfe"]}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform publicQueryItems \
    ...
    --sortBy 'name:asc,createdAt,displayOrder:desc' \
