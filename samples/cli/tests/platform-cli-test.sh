...
./ng net.accelbyte.sdk.cli.Main platform queryItems \
    ...
    --sortBy 'displayOrder:asc,displayOrder,name:asc' \
...
./ng net.accelbyte.sdk.cli.Main platform queryUncategorizedItems \
    ...
    --limit '73' \
    --offset '6' \
    --sortBy 'updatedAt:desc,createdAt:asc,name:asc' \
...
./ng net.accelbyte.sdk.cli.Main platform updateItemPurchaseCondition \
    ...
    --body '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 72, "comparison": "includes", "name": "gVZCj9ObVGT0Scwl", "predicateType": "EntitlementPredicate", "value": "m7MKclr5igjNTVIt", "values": ["OmbfJrCJQIj1haAo", "nyq8OzTE89WDNoMc", "rH2X78hxJgaVfw5V"]}, {"anyOf": 38, "comparison": "isLessThanOrEqual", "name": "KglqaCXE9ytpIO8b", "predicateType": "SeasonPassPredicate", "value": "HoSpGt1g0GGbT4Hf", "values": ["2PPKOldkbgX9CWJK", "wXXSbv5eg9q86IaD", "Fjjx6uZerWbtwTX9"]}, {"anyOf": 13, "comparison": "excludes", "name": "NRByjbE8lOLAfTXK", "predicateType": "SeasonTierPredicate", "value": "LCv8q4Thmq09bBgP", "values": ["drRoM6FoqCYw7Alx", "3wDwD9RKvQX4yFQF", "AYxrBE9jlnTgtgW3"]}]}, {"operator": "or", "predicates": [{"anyOf": 34, "comparison": "excludes", "name": "dFpc71sSck3ggZWJ", "predicateType": "EntitlementPredicate", "value": "NmvvNtjJNQepUTGh", "values": ["AEvdRF9bqMj4ro5B", "wlY4lPzlsCR5rVsy", "fcH7WjP7HuGz3b5W"]}, {"anyOf": 1, "comparison": "excludes", "name": "VE838c7OydVw0zCq", "predicateType": "EntitlementPredicate", "value": "8i8krFWJhe03coRF", "values": ["z9C05YabFX4FCK5u", "ok5d3AyGrZO8GuoX", "NSoVEBG7VbBPUWip"]}, {"anyOf": 4, "comparison": "isGreaterThanOrEqual", "name": "3rqBmILhtWm8RQvR", "predicateType": "SeasonPassPredicate", "value": "bUDSiefGEdLucrtO", "values": ["zS9SiGUjVAw4v3q6", "JRHcn7KaoCEkRdo6", "2gCQD057DrDlgC2n"]}]}, {"operator": "or", "predicates": [{"anyOf": 68, "comparison": "isGreaterThan", "name": "YIZWnXqQ1oHFJ9Q0", "predicateType": "SeasonPassPredicate", "value": "XegSEhrPpK2q8kxR", "values": ["VeHv0L2Acm960EYQ", "4BuEksS2A9VOA8H9", "EuGJVl8xs1WId9Wl"]}, {"anyOf": 1, "comparison": "is", "name": "HgoXCR6XOMXwKdfq", "predicateType": "EntitlementPredicate", "value": "xwEdkyuT3MgzReRq", "values": ["6v2AEozWWaYvBLE4", "6bpuJip8JyxJ39vr", "0112ISArROIodcmM"]}, {"anyOf": 40, "comparison": "isLessThan", "name": "mb01yA7U7dGMjupZ", "predicateType": "EntitlementPredicate", "value": "gwhYzk33J34fiTxK", "values": ["euLAbBgejqc0apxq", "63OHpnUCGBVfpctN", "FUsUQ6ZXQcb2o1J5"]}]}]}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkCredit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"creditRequest": {"amount": 7, "expireAt": "1996-06-20T00:00:00Z", "metadata": {"fHdITmN9opaF0kh3": {}, "pCRB3infEVxArF7T": {}, "B6A6a71zAJpaPeud": {}}, "origin": "Other", "reason": "0v25yAObZIbrA8XA", "source": "REDEEM_CODE"}, "currencyCode": "YZw4MWzWFTuNPf5J", "userIds": ["DL4yx5I0euBsccHP", "ZbQUnUxS6m68WL3H", "CSDyYy4e5qoTZxSo"]}, {"creditRequest": {"amount": 54, "expireAt": "1999-02-03T00:00:00Z", "metadata": {"v9XP9enfEX7lloLg": {}, "IYqxFfSNJlHCjxLN": {}, "nYUlGQsFpy9ZVlLI": {}}, "origin": "System", "reason": "ruDukun42zPZvOd4", "source": "OTHER"}, "currencyCode": "9ilm3cauhrw9Yn2z", "userIds": ["3wfNGyWf3VujS7Bq", "5bcfPW4pPZB9YXlt", "5cnbm7z2Aa24yBTw"]}, {"creditRequest": {"amount": 60, "expireAt": "1975-07-17T00:00:00Z", "metadata": {"yBGygWFTAY3Th5mO": {}, "wPCPKVPlOGfFBlu2": {}, "ZP0IkiYXGk6BoBmS": {}}, "origin": "Twitch", "reason": "kulpM4SRtUE5P4kx", "source": "GIFT"}, "currencyCode": "lMlY8UjprhCxhzW6", "userIds": ["VdjPutJ8dkAVOJ5i", "ZM7LkTVrtVJZVhxC", "mghdfVhjnjd66A1S"]}]' \
    > test.out 2>&1
