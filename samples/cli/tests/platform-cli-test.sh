...
./ng net.accelbyte.sdk.cli.Main platform queryItems \
    ...
    --sortBy 'displayOrder:asc,updatedAt:asc,displayOrder:desc' \
...
./ng net.accelbyte.sdk.cli.Main platform queryUncategorizedItems \
    ...
    --limit '43' \
    --offset '48' \
    --sortBy 'updatedAt:desc,updatedAt:asc,displayOrder:desc' \
...
./ng net.accelbyte.sdk.cli.Main platform updateItemPurchaseCondition \
    ...
    --body '{"purchaseCondition": {"conditionGroups": [{"operator": "and", "predicates": [{"anyOf": 14, "comparison": "isGreaterThanOrEqual", "name": "EDqSTOfoNewWjwMW", "predicateType": "SeasonPassPredicate", "value": "rPye7fCwi7Il2wIF", "values": ["lHm9N6owMHMtJy1O", "0nx8TqSZdZ5C8mFI", "qn59tEGm9NYeUT5P"]}, {"anyOf": 80, "comparison": "excludes", "name": "nvzEqBNMF9CZvPxT", "predicateType": "SeasonPassPredicate", "value": "v9k4fv3kMiuQ3Dhs", "values": ["DBmTLH9kP9U53z6j", "oBAhAlJGI2YYb6aj", "KLxjt5srPFxBgpFt"]}, {"anyOf": 56, "comparison": "isLessThanOrEqual", "name": "jgq6eY4PBNHKPx62", "predicateType": "SeasonPassPredicate", "value": "YutgXucx85vHA009", "values": ["ETQ8gIDRdD2wwMXw", "FAb21jxeWXk80y9u", "xgVLGgK8aVSCN6oC"]}]}, {"operator": "and", "predicates": [{"anyOf": 22, "comparison": "includes", "name": "PhEJsc7rZpxaPHc9", "predicateType": "SeasonPassPredicate", "value": "DfNfPGYYSTunMgt3", "values": ["C8hEguCqlMHiQN3H", "eDrwEuTyM2qohglz", "WJw9zIWsiP2JQ24m"]}, {"anyOf": 83, "comparison": "includes", "name": "8AEl6A9sh2x2ur2c", "predicateType": "EntitlementPredicate", "value": "dKPCFUIeyYEymNXz", "values": ["BaixUUvmzbajE2gj", "NX6TGh4UdEweeBsJ", "EvBbAvCmlh6Z1oz9"]}, {"anyOf": 30, "comparison": "isGreaterThan", "name": "6a280S5RNB5dVCsB", "predicateType": "SeasonPassPredicate", "value": "tkWaMOH47CAT7cBP", "values": ["J2tWwF7RnP1oK3c4", "0918JaEBQBP766LU", "nBBR84iAO7sBQt6Y"]}]}, {"operator": "and", "predicates": [{"anyOf": 98, "comparison": "includes", "name": "sMY8es36r1FgR70e", "predicateType": "SeasonTierPredicate", "value": "l1qqbalgizL97ycJ", "values": ["V5YqE2myQzl7X9fH", "f9B22HGgxakPt7IY", "r6WvBxmBvNj3ktaD"]}, {"anyOf": 51, "comparison": "excludes", "name": "aj6Vxs3GuA4S1dS7", "predicateType": "SeasonTierPredicate", "value": "mBerp84qjwzWpCF1", "values": ["dFfC8x5aHLsXHlm1", "s4qR8LaQzEb39sZT", "vyamjsEzwtLPxK1o"]}, {"anyOf": 89, "comparison": "isLessThan", "name": "JTTy9JrNz1K5M1qg", "predicateType": "SeasonTierPredicate", "value": "Qh8I9xk3sFl0cbuC", "values": ["hlh80BhYe2fJDS6T", "RM69XKkLwioRaKnW", "75Q4ulonMFjmYqE1"]}]}]}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkCredit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"creditRequest": {"amount": 33, "expireAt": "1981-09-07T00:00:00Z", "origin": "IOS", "reason": "hopdqGrqRZ124P7P", "source": "ACHIEVEMENT"}, "currencyCode": "vRQb7c0vmjWq9fQq", "userIds": ["ikslpyL9BYLVVznF", "YMVfiAMa6Pco7Mfv", "zulLGfQMqSLQDlRF"]}, {"creditRequest": {"amount": 9, "expireAt": "1974-10-20T00:00:00Z", "origin": "Xbox", "reason": "PCbs8jWmTteJhwNb", "source": "PROMOTION"}, "currencyCode": "0ilGQFwHUtZugblT", "userIds": ["3aIDKn9qJXncm5ig", "pAewbmnWk0E7YaPb", "lcWEyNgvs5LEZrQX"]}, {"creditRequest": {"amount": 52, "expireAt": "1977-12-30T00:00:00Z", "origin": "Playstation", "reason": "QRWRs9EGnRPgYlJE", "source": "GIFT"}, "currencyCode": "RnLcLbp7OmcrDJ7u", "userIds": ["Heb0CaPFDjrSotKn", "1rrRPcnG89rnNW1Y", "jfn8lY4DnYRxY8Zh"]}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkDebit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"currencyCode": "pJWALpToj9rgr5Rf", "request": {"allowOverdraft": false, "amount": 68, "balanceOrigin": "Xbox", "reason": "wunQwpC2eCFUAHZa"}, "userIds": ["aSRmHU5iR3hXIbzW", "YSvsWiNJtqXltZF6", "PKOkzftOgDQAWhul"]}, {"currencyCode": "brDf7q4cAnpmLiEu", "request": {"allowOverdraft": true, "amount": 59, "balanceOrigin": "Nintendo", "reason": "NtX2lnqi7cHTSdGo"}, "userIds": ["sEYogFWiH9z4E8zm", "LZbC3UJruU4uIXBZ", "aZ5cg0REtUWY4fVI"]}, {"currencyCode": "dqwCWF5wmbOubTxA", "request": {"allowOverdraft": true, "amount": 26, "balanceOrigin": "GooglePlay", "reason": "dXVvaPQzzKdFg7N7"}, "userIds": ["pHt7MdKu9Xwn5GHJ", "EIs3GC9VTK7tkJWF", "piT8VcrXLZnuMNpK"]}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform publicQueryItems \
    ...
    --sortBy 'createdAt:asc,updatedAt:asc,displayOrder' \
...
./ng net.accelbyte.sdk.cli.Main platform queryItems1 \
    ...
    --sectionExclusive  \
    --sortBy 'displayOrder:asc,name:asc' \
