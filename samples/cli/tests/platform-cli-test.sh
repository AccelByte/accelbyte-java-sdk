...
./ng net.accelbyte.sdk.cli.Main platform queryUncategorizedItems \
    ...
    --limit '12' \
    --offset '79' \
    --sortBy 'createdAt,displayOrder:desc,updatedAt:asc' \
...
./ng net.accelbyte.sdk.cli.Main platform updateItemPurchaseCondition \
    ...
    --body '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 58, "comparison": "isNot", "name": "mFI9TnvzEqBNMF9C", "predicateType": "SeasonTierPredicate", "value": "vPxT5zbreMc9fBoU", "values": ["3RHNDFjLKFrepy56", "eW1kmb15QeIQF51c", "4MqJzDSvELgBe6db"]}, {"anyOf": 29, "comparison": "excludes", "name": "dhkBzAzPkt1efGJe", "predicateType": "SeasonTierPredicate", "value": "Px62tHxDb06ZFy3u", "values": ["0RT6LvcnGMJbJIYL", "RD7HD6LCgdFxRGj0", "glSp2UxvF2uLXWil"]}, {"anyOf": 37, "comparison": "isLessThan", "name": "sMvy9gkfTMRrXVRc", "predicateType": "SeasonPassPredicate", "value": "pxaPHc9r8eToFmkH", "values": ["J6BPOKFLxIwKssw6", "47YwDudnGRufOUGf", "MjTU226l07jPlcYa"]}]}, {"operator": "or", "predicates": [{"anyOf": 34, "comparison": "isGreaterThan", "name": "7YfBmhjI9Y28qVce", "predicateType": "SeasonTierPredicate", "value": "2ur2ccp7R7OqPqIj", "values": ["RJM1T8QwMNOAzXmy", "GlU8962e6gtn5pUA", "S4i0N9ytb3c8pVZ8"]}, {"anyOf": 69, "comparison": "is", "name": "EV4g9P6a280S5RNB", "predicateType": "EntitlementPredicate", "value": "dVCsB7xL4axSPgPC", "values": ["RVTl0tR00oQgcHdG", "iwLxCFLDixZwVtt3", "GK3x76U1EIcklttm"]}, {"anyOf": 35, "comparison": "isGreaterThanOrEqual", "name": "oK3c4RVfjB0zi3Xr", "predicateType": "SeasonTierPredicate", "value": "UiN24ol1qqbalgiz", "values": ["l7X9fHr6WvBxmBvN", "j3ktaDf9B22HGgxa", "L97ycJV5YqE2myQz"]}]}, {"operator": "and", "predicates": [{"anyOf": 49, "comparison": "excludes", "name": "t7IYzaZUTmvsEzLP", "predicateType": "EntitlementPredicate", "value": "S1dS7H7yIS7b5TSD", "values": ["72WDyhBsCCbnfihn", "RIoMg7Dc5APzfzXD", "ELJFaIaEMW5bhJyL"]}, {"anyOf": 75, "comparison": "isLessThanOrEqual", "name": "lm1RJTTy9JrNz1K5", "predicateType": "SeasonTierPredicate", "value": "KfSHQh8I9xk3sFl0", "values": ["cbuCRM69XKkLwioR", "DS6T75Q4ulonMFjm", "aKnWhlh80BhYe2fJ"]}, {"anyOf": 83, "comparison": "isGreaterThanOrEqual", "name": "SesE5p0DwUj2HKUv", "predicateType": "SeasonTierPredicate", "value": "Uy18aWn65Co0vdCk", "values": ["ywonA2SrEdN2tmGu", "8so6JSaZAIadKDEZ", "X6r0gBVUUeKKlPKt"]}]}]}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkCredit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"creditRequest": {"amount": 35, "expireAt": "1992-05-21T00:00:00Z", "origin": "Xbox", "reason": "RPcnG89rnNW1Yjfn", "source": "GIFT"}, "currencyCode": "lY4DnYRxY8ZhHeb0", "userIds": ["LpToj9rgr5RffM5J", "CaPFDjrSotKnpJWA", "XvPdzEpDln04F8BQ"]}, {"creditRequest": {"amount": 19, "expireAt": "1980-07-30T00:00:00Z", "origin": "Nintendo", "reason": "iNJtqXltZF6aSRmH", "source": "SELL_BACK"}, "currencyCode": "fkStOqdXqhDMQ6tB", "userIds": ["KMHK5fbqioeoRIpl", "LljC7gcT3M1DArk4", "L80aXFY7SQkym9Kv"]}, {"creditRequest": {"amount": 95, "expireAt": "1985-10-18T00:00:00Z", "origin": "Twitch", "reason": "ruU4uIXBZsEYogFW", "source": "GIFT"}, "currencyCode": "o6M11LLZWKgWxn9Y", "userIds": ["QzzKdFg7N7piT8Vc", "L16HQdtAneXGgxNg", "33ZIUrIkfmdXVvaP"]}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkDebit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"currencyCode": "rXLZnuMNpKEIs3GC", "request": {"allowOverdraft": true, "amount": 74, "balanceOrigin": "Epic", "reason": "7tkJWFpHt7MdKu9X"}, "userIds": ["wn5GHJDGatrYOMO9", "7mMuBXPDKCriRKzT", "1CYEjX867n9PT9fR"]}, {"currencyCode": "Z7TXAVRnUVbxEJcK", "request": {"allowOverdraft": true, "amount": 68, "balanceOrigin": "Other", "reason": "64EwhQfxFKIOGT1W"}, "userIds": ["KSmLoA0ILaESC1GJ", "XsoBwqh0TQXa2j7v", "3zQJoQLTAlW75icI"]}, {"currencyCode": "KUpXazsFrmaGNoi3", "request": {"allowOverdraft": true, "amount": 85, "balanceOrigin": "Other", "reason": "TgWotLNz0u8ySxA0"}, "userIds": ["yrjz4q7e0EJnADXC", "K56dsYI5SKV5pDAN", "2y0DY1E1SMK9oA4v"]}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform publicQueryItems \
    ...
    --sortBy 'updatedAt:desc,createdAt:desc,name:asc' \
...
./ng net.accelbyte.sdk.cli.Main platform queryItems1 \
    ...
    --sectionExclusive  \
    --sortBy 'updatedAt:desc,displayOrder,updatedAt' \
