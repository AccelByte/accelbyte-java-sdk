...
./ng net.accelbyte.sdk.cli.Main platform updateCatalogConfig \
    --namespace "$AB_NAMESPACE" \
    --body '{"enableInventoryCheck": true, "itemDeletionCheckConfig": ["REWARD", "CAMPAIGN", "DLC"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform disableItem \
    ...
    --body '{"featuresToCheck": ["IAP", "REWARD", "ENTITLEMENT"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkDebit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"currencyCode": "2SaLd6M7TM3wnJyE", "request": {"allowOverdraft": true, "amount": 91, "balanceOrigin": "Other", "balanceSource": "PAYMENT", "metadata": {"o5z9RAcYgYZb7cAa": {}, "kJpqN6eubdp49JFw": {}, "XG0EvoSHNC97eEyh": {}}, "reason": "nL1QH5AlYRAqCAC2"}, "userIds": ["fB8jIecOx5ugNCDd", "gy1WF9QLNgDxAkwg", "6jW6fjtBcO3fWq9q"]}, {"currencyCode": "fmBv0XgJB6a7uykA", "request": {"allowOverdraft": true, "amount": 26, "balanceOrigin": "System", "balanceSource": "DLC_REVOCATION", "metadata": {"pinFcH2ZMSYijqEu": {}, "MfuYFUS079tOpZYM": {}, "1XV0Op0damycnTUO": {}}, "reason": "oMkOppZNOkqxc42H"}, "userIds": ["SxwzuIpGBYHTHoSV", "xgQCbpZx5yMGIQ1Z", "Kv5wvtPJVsuzaBci"]}, {"currencyCode": "xVIefYlKBJyQMqUE", "request": {"allowOverdraft": false, "amount": 15, "balanceOrigin": "Steam", "balanceSource": "OTHER", "metadata": {"ikX6yOlgZrn0I6T0": {}, "hvcAFTaSWR4VOGIY": {}, "7hM6uhonkAe0FdTS": {}}, "reason": "SEluBxM47BTww3nB"}, "userIds": ["TVmBFZ6TIs9bTi2m", "FeExlOFjRh8mLFTJ", "7eNsYEqKkeuLWDfe"]}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform publicPreviewOrderPrice \
    ...
    --body '{"currencyCode": "LJ73mCPhhmUyIwgQ", "discountCodes": ["O1I3KISTbn4yEa2A", "ZQ9lVMNyCiytnfMo", "S9kVFUbeTeB9KgnF"], "discountedPrice": 0, "itemId": "q79Du28SRRAMaQFE", "price": 52, "quantity": 33}' \
    > test.out 2>&1
