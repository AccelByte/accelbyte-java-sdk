...
./ng net.accelbyte.sdk.cli.Main platform queryItems \
    ...
    --sortBy 'updatedAt,name:asc,createdAt' \
...
./ng net.accelbyte.sdk.cli.Main platform queryUncategorizedItems \
    ...
    --limit '12' \
    --offset '79' \
    --sortBy 'displayOrder:desc,updatedAt:asc,createdAt' \
...
./ng net.accelbyte.sdk.cli.Main platform updateItemPurchaseCondition \
    ...
    --body '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 58, "comparison": "isNot", "name": "mFI9TnvzEqBNMF9C", "predicateType": "SeasonTierPredicate", "value": "vPxT5zbreMc9fBoU", "values": ["eW1kmb15QeIQF51c", "3RHNDFjLKFrepy56", "4MqJzDSvELgBe6db"]}, {"anyOf": 29, "comparison": "excludes", "name": "dhkBzAzPkt1efGJe", "predicateType": "SeasonTierPredicate", "value": "Px62tHxDb06ZFy3u", "values": ["RD7HD6LCgdFxRGj0", "0RT6LvcnGMJbJIYL", "glSp2UxvF2uLXWil"]}, {"anyOf": 37, "comparison": "isLessThan", "name": "sMvy9gkfTMRrXVRc", "predicateType": "SeasonPassPredicate", "value": "pxaPHc9r8eToFmkH", "values": ["MjTU226l07jPlcYa", "J6BPOKFLxIwKssw6", "47YwDudnGRufOUGf"]}]}, {"operator": "or", "predicates": [{"anyOf": 34, "comparison": "isGreaterThan", "name": "7YfBmhjI9Y28qVce", "predicateType": "SeasonTierPredicate", "value": "2ur2ccp7R7OqPqIj", "values": ["GlU8962e6gtn5pUA", "RJM1T8QwMNOAzXmy", "S4i0N9ytb3c8pVZ8"]}, {"anyOf": 69, "comparison": "is", "name": "EV4g9P6a280S5RNB", "predicateType": "EntitlementPredicate", "value": "dVCsB7xL4axSPgPC", "values": ["RVTl0tR00oQgcHdG", "GK3x76U1EIcklttm", "iwLxCFLDixZwVtt3"]}, {"anyOf": 35, "comparison": "isGreaterThanOrEqual", "name": "oK3c4RVfjB0zi3Xr", "predicateType": "SeasonTierPredicate", "value": "UiN24ol1qqbalgiz", "values": ["l7X9fHr6WvBxmBvN", "L97ycJV5YqE2myQz", "j3ktaDf9B22HGgxa"]}]}, {"operator": "and", "predicates": [{"anyOf": 49, "comparison": "excludes", "name": "t7IYzaZUTmvsEzLP", "predicateType": "EntitlementPredicate", "value": "S1dS7H7yIS7b5TSD", "values": ["RIoMg7Dc5APzfzXD", "ELJFaIaEMW5bhJyL", "72WDyhBsCCbnfihn"]}, {"anyOf": 75, "comparison": "isLessThanOrEqual", "name": "lm1RJTTy9JrNz1K5", "predicateType": "SeasonTierPredicate", "value": "KfSHQh8I9xk3sFl0", "values": ["cbuCRM69XKkLwioR", "DS6T75Q4ulonMFjm", "aKnWhlh80BhYe2fJ"]}, {"anyOf": 83, "comparison": "isGreaterThanOrEqual", "name": "SesE5p0DwUj2HKUv", "predicateType": "SeasonTierPredicate", "value": "Uy18aWn65Co0vdCk", "values": ["8so6JSaZAIadKDEZ", "ywonA2SrEdN2tmGu", "X6r0gBVUUeKKlPKt"]}]}]}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkDebit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"currencyCode": "rXLZnuMNpKEIs3GC", "request": {"allowOverdraft": true, "amount": 75, "balanceOrigin": "Epic", "reason": "7tkJWFpHt7MdKu9X"}, "userIds": ["7mMuBXPDKCriRKzT", "wn5GHJDGatrYOMO9", "1CYEjX867n9PT9fR"]}, {"currencyCode": "Z7TXAVRnUVbxEJcK", "request": {"allowOverdraft": true, "amount": 69, "balanceOrigin": "Other", "reason": "64EwhQfxFKIOGT1W"}, "userIds": ["XsoBwqh0TQXa2j7v", "KSmLoA0ILaESC1GJ", "3zQJoQLTAlW75icI"]}, {"currencyCode": "KUpXazsFrmaGNoi3", "request": {"allowOverdraft": true, "amount": 86, "balanceOrigin": "Other", "reason": "TgWotLNz0u8ySxA0"}, "userIds": ["K56dsYI5SKV5pDAN", "yrjz4q7e0EJnADXC", "2y0DY1E1SMK9oA4v"]}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform queryItems1 \
    ...
    --sectionExclusive  \
    --sortBy 'updatedAt,displayOrder,updatedAt:desc' \
