...
./ng net.accelbyte.sdk.cli.Main legal createPolicy \
    --body '{"affectedClientIds": ["diRilZ7oFgx4c8Ou", "su8XfqlqNiTvB6Sd", "mKtPDKJDXn7Z4U68"], "affectedCountries": ["AdIhUDrwoZ5MecdK", "i5r6QEa1ysLEzth6", "mXhzkzWkFeZSoEAc"], "basePolicyName": "BdW19m4eu6d5tA5j", "description": "UmiTqpyhPFdxLzFQ", "namespace": "N05MYzYiKWe5dNRl", "tags": ["u6Vpbsx5w8hqUI06", "vkLGMS0lyuI9a2I9", "jv7IPrDQQRgat0Se"], "typeId": "UpOXGSLmCVuHOPlL"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal partialUpdatePolicy \
    ...
    --body '{"affectedClientIds": ["7FXGk2s9Q0mPVo3t", "ahFjkQsfCaTmt1d6", "wu0MesTCf9x4rt69"], "affectedCountries": ["lna7qxNeIxPz6Mbw", "L6IY69z1UaLqYSYW", "ytLPziZMdjxcBZuf"], "basePolicyName": "QxGiHPllG4cYEzfT", "description": "D1ZBm3MqHcUmLZZb", "namespace": "Sqb8RwNmn9HrNQy4", "tags": ["uZAAiE0mit9RGCCH", "8yu7Vk6Jt4Ymos9J", "YzUOcEdscKHPEqgA"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal retrieveAcceptedAgreementsForMultiUsers \
    --namespace "$AB_NAMESPACE" \
    --body '{"currentPublishedOnly": true, "userIds": ["jEEztx1WsYSiZqan", "VPHbn4Xxtu7LQREN", "0nSBJroav91GXlvP"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal createPolicy1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"affectedClientIds": ["8l9lyNApflxqMrj3", "SZjtqXyJ58f7Gc26", "oZk03QXcKMDYDDxH"], "affectedCountries": ["SaiGVkydwYWQG26y", "UZNmTBcvrbYCwZtx", "FHyPLtI8ilbyDPUI"], "basePolicyName": "j88cekdqCt81P1kt", "description": "fIovmv9gsR5cJcHm", "tags": ["3SZLxoRDFuuuySj2", "9a9LJE8HoRS1X2PF", "AAMwzHPxB1UskYs4"], "typeId": "Yw20DOqOBSC2DKHR"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal partialUpdatePolicy1 \
    ...
    --namespace "$AB_NAMESPACE" \
    --body '{"affectedClientIds": ["RE2w1yEkLgh3tIYt", "i8KlloeH0JT1ydua", "t2vQR3biBfsu4jms"], "affectedCountries": ["IHeHSKLCa3xreNDU", "4SqYUTLDx9gIiDan", "dpGT2t24aOMh5eC3"], "basePolicyName": "WehwH3q31A806DJg", "description": "as4b6z3LNUj7fdgL", "tags": ["EDoNf3n0hEoRCAcf", "A84Z8YYk6QEgJjBb", "80zfFyabWAgIUXiI"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal indirectBulkAcceptVersionedPolicyV2 \
    --clientId '3PrIfapq5AAeMe4L' \
    --countryCode '3mDWORBVXTIIJM9X' \
    --namespace "$AB_NAMESPACE" \
    --userId 'sYIIZxiXNMR9BgaW' \
    --body '[{"isAccepted": false, "isNeedToSendEventMarketing": true, "localizedPolicyVersionId": "FX3SUBhyoTsMWPAx", "policyId": "UMkawaGpAyrIwMif", "policyVersionId": "3BOdkocVTd4BxqGW"}, {"isAccepted": false, "isNeedToSendEventMarketing": false, "localizedPolicyVersionId": "BNXzAFdO0Khqf6ki", "policyId": "TdSGv2LFjAKY7Cbg", "policyVersionId": "sWqFWZX7kPBom8F9"}, {"isAccepted": true, "isNeedToSendEventMarketing": true, "localizedPolicyVersionId": "CjtuzFMbAG9YI89h", "policyId": "mguB8FOTjMLo4b9r", "policyVersionId": "IzqYkEpstyVTBcrM"}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal retrieveLatestPolicies \
    --countryCode 'kwfLM9uSybRzWek2' \
    --defaultOnEmpty  \
    --policyType 'LEGAL_DOCUMENT_TYPE' \
    --tags 'l8kUXzt6bSc6bWvg' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal retrieveLatestPoliciesPublic \
    ...
    --tags 'MLhrTrcBE2ItBS3K' \
    > test.out 2>&1
eval_tap $? 62 'RetrieveLatestPoliciesPublic' test.out

#- 63 RetrieveLatestPoliciesByNamespaceAndCountryPublic
./ng net.accelbyte.sdk.cli.Main legal retrieveLatestPoliciesByNamespaceAndCountryPublic \
    --countryCode 'tKZWe8aoFzAyBME7' \
    --namespace "$AB_NAMESPACE" \
    --alwaysIncludeDefault  \
    --defaultOnEmpty  \
    --policyType 'LEGAL_DOCUMENT_TYPE' \
    --tags 'HUtipUWYhWV1qx8C' \
    > test.out 2>&1
