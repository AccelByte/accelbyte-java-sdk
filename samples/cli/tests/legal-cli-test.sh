...
./ng net.accelbyte.sdk.cli.Main legal createPolicyUnderBasePolicy \
    ...
    --namespace "$AB_NAMESPACE" \
    --body '{"countries": ["4zGYY7KQI1AeFgPq", "RSKs6gQxC3Gb7S0o", "ZVJSPqJiwv1qlYB1"], "countryCode": "aOkvo1aolB4lkKB4", "countryGroupName": "EYOkQ1jMD3cym8xI", "countryType": "COUNTRY", "description": "On0jJLHC9LxhvNXT", "isDefaultSelection": true, "isMandatory": true, "policyName": "GBCtohLtl9Zuhytm", "shouldNotifyOnUpdate": true}' \
    > test.out 2>&1
