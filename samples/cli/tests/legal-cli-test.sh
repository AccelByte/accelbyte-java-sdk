...
./ng net.accelbyte.sdk.cli.Main legal createPolicy \
    --body '{"affectedClientIds": ["mKtPDKJDXn7Z4U68", "diRilZ7oFgx4c8Ou", "su8XfqlqNiTvB6Sd"], "affectedCountries": ["AdIhUDrwoZ5MecdK", "i5r6QEa1ysLEzth6", "mXhzkzWkFeZSoEAc"], "basePolicyName": "BdW19m4eu6d5tA5j", "countryGroupName": "UmiTqpyhPFdxLzFQ", "countryType": "COUNTRY", "description": "5MYzYiKWe5dNRljv", "isHidden": true, "isHiddenPublic": false, "namespace": "DQQRgat0SevkLGMS", "tags": ["LmCVuHOPlLlkvR8s", "x5w8hqUI06UpOXGS", "0lyuI9a2I9u6Vpbs"], "typeId": "KgnuRkgghGoYupD3"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal partialUpdatePolicy \
    ...
    --body '{"affectedClientIds": ["NeIxPz6MbwL6IY69", "TCf9x4rt69lna7qx", "s9Q0mPVo3twu0Mes"], "affectedCountries": ["z1UaLqYSYWytLPzi", "ZMdjxcBZufQxGiHP", "llG4cYEzfTD1ZBm3"], "basePolicyName": "MqHcUmLZZbSqb8Rw", "countryGroupName": "Nmn9HrNQy4uZAAiE", "countryType": "COUNTRY_GROUP", "description": "mit9RGCCHYzUOcEd", "isHidden": true, "isHiddenPublic": false, "namespace": "i9gwQYv7t1o7TTr1", "tags": ["DmrhZv15T7quIOvB", "pBFmaLoxozr6wfNP", "McaYmvCkGZ5dAgqx"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal updatePolicy1 \
    ...
    --body '{"countries": ["mKy8M9zVrjfGXZnq", "bhMssAHjapIkY9Rf", "4wP57dBZNR88YbCt"], "countryGroupName": "AQUoY1GjlIIk0iKo", "description": "TTS1j02o7JjTXAQN", "isDefaultOpted": true, "isMandatory": false, "policyName": "ccLjMXJRk0eaKQDO", "readableId": "JvrTefglSs6g4iY9", "shouldNotifyOnUpdate": true}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal updatePolicy \
    ...
    --body '{"countries": ["SC00PYeDcagginxn", "RcrEveMdAdiPKDUV", "FIna3yddcbsPheTH"], "countryGroupName": "26IUJNvYuGRUvpZa", "description": "HCuESOiIZsMfB4ZH", "isDefaultOpted": false, "isMandatory": true, "policyName": "mDWORBVXTIIJM9Xs", "readableId": "YIIZxiXNMR9BgaWc", "shouldNotifyOnUpdate": false}' \
    > test.out 2>&1
