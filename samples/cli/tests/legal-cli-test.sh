...
./ng net.accelbyte.sdk.cli.Main legal partialUpdatePolicy \
    ...
    --body '{"affectedClientIds": ["ahFjkQsfCaTmt1d6", "wu0MesTCf9x4rt69", "7FXGk2s9Q0mPVo3t"], "affectedCountries": ["lna7qxNeIxPz6Mbw", "L6IY69z1UaLqYSYW", "ytLPziZMdjxcBZuf"], "basePolicyName": "QxGiHPllG4cYEzfT", "description": "D1ZBm3MqHcUmLZZb", "namespace": "Sqb8RwNmn9HrNQy4", "tags": ["YzUOcEdscKHPEqgA", "uZAAiE0mit9RGCCH", "8yu7Vk6Jt4Ymos9J"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main legal partialUpdatePolicy1 \
    ...
    --namespace "$AB_NAMESPACE" \
    --body '{"affectedClientIds": ["i8KlloeH0JT1ydua", "RE2w1yEkLgh3tIYt", "t2vQR3biBfsu4jms"], "affectedCountries": ["4SqYUTLDx9gIiDan", "dpGT2t24aOMh5eC3", "IHeHSKLCa3xreNDU"], "basePolicyName": "WehwH3q31A806DJg", "description": "as4b6z3LNUj7fdgL", "tags": ["80zfFyabWAgIUXiI", "A84Z8YYk6QEgJjBb", "EDoNf3n0hEoRCAcf"]}' \
    > test.out 2>&1
