...
./ng net.accelbyte.sdk.cli.Main social bulkGetOrDefaultByUserId \
    ...
    --body '{"statCodes": ["510kHr4isTKWjmv6", "7nuHCXWfwnwGioVw", "6hIWDZrpP7rz3ISW"]}' \
    > test.out 2>&1
