...
./ng net.accelbyte.sdk.cli.Main social updateStat \
    ...
    --body '{"cycleIds": ["LVd3DlhLuIpomM8s", "iOG4UcqsuGKHhMRW", "m1MiaI1mX2tJoARt"], "defaultValue": 0.06079653984735289, "description": "bBe7udsMrok0WvGY", "ignoreAdditionalDataOnValueRejected": false, "isPublic": false, "name": "WjLfFmteue9nzJ6f", "tags": ["ZpjvsugAOS7u8RiW", "H24T805tVg8JqU0j", "yerCSa8SRgwsAj1i"]}' \
    > test.out 2>&1
