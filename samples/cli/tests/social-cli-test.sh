...
./ng net.accelbyte.sdk.cli.Main social createStat \
    --namespace "$AB_NAMESPACE" \
    --body '{"cycleIds": ["OvDz9KOs", "b392k6Ym", "zDmeIP6r"], "defaultValue": 0.5793456161760823, "description": "FfRByjlB", "incrementOnly": false, "maximum": 0.9967557290714741, "minimum": 0.605745334271637, "name": "JE8HoRS1", "setAsGlobal": false, "setBy": "SERVER", "statCode": "AnkCmBUq", "tags": ["MiVi10sG", "X9y1aZSW", "g2SCnqnt"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main social updateStat \
    --namespace "$AB_NAMESPACE" \
    --statCode 'CSz9WEi8' \
    --body '{"cycleIds": ["KlloeH0J", "vQR3biBf", "T1yduat2"], "defaultValue": 0.3013449407187887, "description": "u4jmsRE2", "name": "w1yEkLgh", "tags": ["YUTLDx9g", "3tIYt4Sq", "IiDandpG"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main social createStat1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"cycleIds": ["7WnbdSJt", "PZnGBt4P", "jX7ZshZy"], "defaultValue": 0.8293567122625791, "description": "l5x4bRXB", "incrementOnly": true, "maximum": 0.75107051173064, "minimum": 0.7417007734915865, "name": "rDzZSKsc", "setAsGlobal": false, "setBy": "CLIENT", "statCode": "OcYu3dpC", "tags": ["ROYqUiGK", "sPwVOEDS", "XVFCmpo6"]}' \
    > test.out 2>&1
