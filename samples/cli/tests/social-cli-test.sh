...
./ng net.accelbyte.sdk.cli.Main social createStat \
    --namespace "$AB_NAMESPACE" \
    --body '{"cycleIds": ["bRPZTF6oQAXVG7tn", "sZg5QgXjvyGJPN4e", "XbJE5Vs2GcyomQoI"], "defaultValue": 0.8000271572434526, "description": "imBJehyxlNsjUgxB", "ignoreAdditionalDataOnValueRejected": false, "incrementOnly": true, "isPublic": false, "maximum": 0.515988595940881, "minimum": 0.6762168411735996, "name": "oJeQediogEhhM2rI", "setAsGlobal": false, "setBy": "CLIENT", "statCode": "zGdKvOPdq5xrgxSm", "tags": ["y1DN9LFkYW5DQyj4", "bj5Ro2ogaKt2ujQS", "a3Zdb65UXmy0Zp6i"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main social updateStat \
    ...
    --body '{"cycleIds": ["iOG4UcqsuGKHhMRW", "m1MiaI1mX2tJoARt", "LVd3DlhLuIpomM8s"], "defaultValue": 0.06079653984735289, "description": "bBe7udsMrok0WvGY", "ignoreAdditionalDataOnValueRejected": false, "isPublic": false, "name": "WjLfFmteue9nzJ6f", "tags": ["H24T805tVg8JqU0j", "yerCSa8SRgwsAj1i", "ZpjvsugAOS7u8RiW"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main social createStat1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"cycleIds": ["CE48L5oLF6M4lNa4", "dNQrmsApRA6HX3Rw", "rKt2ecozL0TOg54v"], "defaultValue": 0.5734890418300337, "description": "UMSHNgqRqCV7usam", "ignoreAdditionalDataOnValueRejected": true, "incrementOnly": true, "isPublic": false, "maximum": 0.16524676040011177, "minimum": 0.833758698680912, "name": "lOX9Sfo95HgXqKhT", "setAsGlobal": false, "setBy": "SERVER", "statCode": "kLOsp0LZ5njN86Hl", "tags": ["VyW9dD1kOmvrAejc", "8kUXzt6bSc6bWvgp", "q2LgkQuaS7RBx3vi"]}' \
    > test.out 2>&1
