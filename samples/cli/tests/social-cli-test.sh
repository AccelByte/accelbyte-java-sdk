...
./ng net.accelbyte.sdk.cli.Main social updateStat \
    ...
    --body '{"cycleIds": ["m1MiaI1mX2tJoARt", "iOG4UcqsuGKHhMRW", "LVd3DlhLuIpomM8s"], "defaultValue": 0.06079653984735289, "description": "bBe7udsMrok0WvGY", "ignoreAdditionalDataOnValueRejected": false, "isPublic": false, "name": "WjLfFmteue9nzJ6f", "tags": ["ZpjvsugAOS7u8RiW", "yerCSa8SRgwsAj1i", "H24T805tVg8JqU0j"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main social bulkGetStatCycle1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"cycleIds": ["3aoRtlqOECohViHA", "apq5AAeMe4L3mDWO", "5CzgFSy8X1A3PrIf"]}' \
    > test.out 2>&1
