...
./ng net.accelbyte.sdk.cli.Main social bulkGetOrDefaultByUserId \
    ...
    --body '{"statCodes": ["7nuHCXWfwnwGioVw", "6hIWDZrpP7rz3ISW", "510kHr4isTKWjmv6"]}' \
    > test.out 2>&1
