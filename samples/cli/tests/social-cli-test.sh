...
./ng net.accelbyte.sdk.cli.Main social updateStat \
    ...
    --body '{"cycleIds": ["FviMarv8mnfHK8CC", "uUccE536ugBp3HBv", "mE2lPnsbD3SGEdlw"], "defaultValue": 0.06522164549941556, "description": "pnDCjgyJlXe36mgW", "globalAggregationMethod": "MAX", "ignoreAdditionalDataOnValueRejected": false, "isPublic": false, "name": "9xbnGezKsDwG2omO", "tags": ["R2nvYI9TVqJdvzcW", "TxBmZjdrrIxsB0NR", "bfUpaXp5JMl5LL4b"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main social bulkGetStatCycle1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"cycleIds": ["ZH3mtgWgU4pCAKxe", "9G4AvQkqsGnmyo5J", "E70CaunQNxot371W"]}' \
    > test.out 2>&1
