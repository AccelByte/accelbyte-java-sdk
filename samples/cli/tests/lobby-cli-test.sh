...
./ng net.accelbyte.sdk.cli.Main lobby userRequestFriend \
    --namespace "$AB_NAMESPACE" \
    --body '{"friendId": "dD4BFyf3", "friendPublicId": "1x9vlKsX"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby addFriendsWithoutConfirmation \
    --namespace "$AB_NAMESPACE" \
    --userId 'Vc8TpaC4' \
    --body '{"friendIds": ["WJV8v5kz", "BA2tbu3u", "LpR9Yd6o"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby adminUpdateConfigV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"allowInviteNonConnectedUser": false, "allowJoinPartyDuringMatchmaking": true, "autoKickOnDisconnect": false, "autoKickOnDisconnectDelay": 57, "cancelTicketOnDisconnect": false, "chatRateLimitBurst": 86, "chatRateLimitDuration": 35, "concurrentUsersLimit": 28, "disableInvitationOnJoinParty": false, "enableChat": true, "entitlementCheck": true, "entitlementItemID": "8wPS6Ox2", "generalRateLimitBurst": 90, "generalRateLimitDuration": 54, "keepPresenceActivityOnDisconnect": false, "maxDSWaitTime": 16, "maxPartyMember": 44, "profanityFilter": true, "readyConsentTimeout": 67}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby sendMultipleUsersFreeformNotificationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --body '{"message": "LytD9oDK", "topicName": "uFTENzI7", "userIds": ["jAm3Apoj", "nGaizx4M", "OTgWXADz"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby sendUsersFreeformNotificationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --body '{"message": "Isij2t5A", "topicName": "JhWIYzDy"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby sendPartyFreeformNotificationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --partyId 'x5qplp4g' \
    --body '{"message": "oIRjxnE8", "topicName": "5IYEPXRU"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby sendPartyTemplatedNotificationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --partyId 'Ea5y6ojl' \
    --body '{"templateContext": {"aB894PyD": "W0bQcJWX", "uqOOar0C": "AgPwAluW", "MxUdPPBD": "xxpX22Lu"}, "templateLanguage": "yvAKywQy", "templateSlug": "OBW5HSod", "topicName": "MHhdTowm"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby createNotificationTemplateV1Admin \
    --namespace "$AB_NAMESPACE" \
    --body '{"templateContent": "MUgTWXOh", "templateLanguage": "gYmOPOCW", "templateSlug": "ac1XNzqK"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby sendUsersTemplatedNotificationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --body '{"templateContext": {"0dLclMX0": "Zumez0kw", "UkKMqTEZ": "9JkK4iCb", "tOCzhYeH": "ppz325jX"}, "templateLanguage": "vjlKt4WV", "templateSlug": "IYjd6wGb", "topicName": "SQNSpk4L"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby getSingleTemplateLocalizationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --templateLanguage 'YEVDf4h7' \
    --templateSlug 'Rrp0Ybgv' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby updateTemplateLocalizationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --templateLanguage 'q6CSTon6' \
    --templateSlug '1idoLNa0' \
    --body '{"templateContent": "tSs2pdQx"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby deleteTemplateLocalizationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --templateLanguage 'QXmF5JOl' \
    --templateSlug 'ccnHUu6c' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby publishTemplateLocalizationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --templateLanguage '35ZdHdgj' \
    --templateSlug 'FKyZj3Lk' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby createNotificationTopicV1Admin \
    --namespace "$AB_NAMESPACE" \
    --body '{"description": "ZRpPz3m6", "topicName": "4VSnuFFH"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby sendSpecificUserFreeformNotificationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --userId '3wRxvsNZ' \
    --body '{"message": "puSMjvKJ", "topicName": "hQjZ1znX"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby sendSpecificUserTemplatedNotificationV1Admin \
    --namespace "$AB_NAMESPACE" \
    --userId 'olHb8V8c' \
    --body '{"templateContext": {"LFOJ67ZE": "lvGvFBol", "u0hSEeKZ": "z792l6Xh", "8xDIgaab": "S3cwm8y2"}, "templateLanguage": "9OOzmg9j", "templateSlug": "2hDsqq4w", "topicName": "6lGllGUp"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby adminUpdatePartyAttributesV1 \
    --namespace "$AB_NAMESPACE" \
    --partyId 'xuBaGRyL' \
    --body '{"custom_attribute": {"PZ8M4JNi": {}, "GpaYGKhg": {}, "vjZj92Ty": {}}, "updatedAt": 27}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby adminSetPlayerSessionAttribute \
    --namespace "$AB_NAMESPACE" \
    --userId '2zmL4ruV' \
    --body '{"attributes": {"429o4vSh": "YqXYGnkh", "RjlMpnzU": "O1QKDMDW", "wtU5bxwq": "ScRo98Mi"}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby adminBulkBlockPlayersV1 \
    --namespace "$AB_NAMESPACE" \
    --userId 'B4aThda2' \
    --body '{"listBlockedUserId": ["xjFDmvjk", "3LqXYXIE", "U6WWIO6C"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby adminAddProfanityFilterIntoList \
    --list 'cb3JOny5' \
    --namespace "$AB_NAMESPACE" \
    --body '{"filter": "wwCZuUNC", "note": "k7UQKiM6"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby adminAddProfanityFilters \
    --list 'YWI9I4n1' \
    --namespace "$AB_NAMESPACE" \
    --body '{"filters": [{"filter": "xxDilkQ7", "note": "3e99Lu9B"}, {"filter": "M7tlbr42", "note": "X4zLNpYP"}, {"filter": "2rMEI38D", "note": "ryrqTDZq"}]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby adminCreateProfanityList \
    --namespace "$AB_NAMESPACE" \
    --body '{"isEnabled": true, "isMandatory": false, "name": "YzbxOjds"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby adminUpdateProfanityList \
    --list '68BTLVZn' \
    --namespace "$AB_NAMESPACE" \
    --body '{"isEnabled": true, "isMandatory": false, "newName": "VeSy7CpV"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby adminVerifyMessageProfanityResponse \
    --namespace "$AB_NAMESPACE" \
    --body '{"message": "Us7Xh7lG", "profanityLevel": "uMDDbeXU"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby publicUpdatePartyAttributesV1 \
    --namespace "$AB_NAMESPACE" \
    --partyId 'kbYqnyNw' \
    --body '{"custom_attribute": {"w6sdm020": {}, "YNjAYHBU": {}, "nySzWZkL": {}}, "updatedAt": 82}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby freeFormNotification \
    --namespace "$AB_NAMESPACE" \
    --body '{"message": "gS57Brrw", "topic": "Va34dXO5"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby notificationWithTemplate \
    --namespace "$AB_NAMESPACE" \
    --body '{"templateContext": {"egCQdSWJ": "SqLTTUsi", "7ctjcURP": "ebMAtNo5", "CqqTrrO6": "nDCskmfD"}, "templateLanguage": "kugIsv3I", "templateSlug": "U77Cq977", "topic": "1aqKgSXO"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby createTemplate \
    --namespace "$AB_NAMESPACE" \
    --body '{"templateContent": "jpvHsaRA", "templateLanguage": "CsKcTk4Z", "templateSlug": "UnFCuxy1"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby getLocalizationTemplate \
    --namespace "$AB_NAMESPACE" \
    --templateLanguage 'YtdHu21q' \
    --templateSlug 'Ny2q1m1X' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby updateLocalizationTemplate \
    --namespace "$AB_NAMESPACE" \
    --templateLanguage 'DL9iERvY' \
    --templateSlug '0rfm8z76' \
    --body '{"templateContent": "ngw0skLh"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby deleteTemplateLocalization \
    --namespace "$AB_NAMESPACE" \
    --templateLanguage 'AIWDKhV6' \
    --templateSlug '3XXe6E9m' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby publishTemplate \
    --namespace "$AB_NAMESPACE" \
    --templateLanguage 'gbDb7QYm' \
    --templateSlug 'eqCt43Sx' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby createTopic \
    --namespace "$AB_NAMESPACE" \
    --body '{"description": "DlbBd7tO", "topic": "hNsvj14X"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby freeFormNotificationByUserID \
    --namespace "$AB_NAMESPACE" \
    --userId 'uEjSIaHQ' \
    --body '{"message": "P9W9Kjpq", "topic": "9Nkuhute"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main lobby notificationWithTemplateByUserID \
    --namespace "$AB_NAMESPACE" \
    --userId '7z042o4R' \
    --body '{"templateContext": {"EvHVjhUE": "eE2AnG8n", "g48WGzcF": "kZtGHHq2", "hHWYYUhu": "1OiKRi3I"}, "templateLanguage": "AX14Ytzp", "templateSlug": "TdyFW2b6", "topic": "OI0x6OU7"}' \
    > test.out 2>&1
