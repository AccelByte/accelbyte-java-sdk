...
./ng net.accelbyte.sdk.cli.Main seasonpass updateReward \
    ...
    --namespace "$AB_NAMESPACE" \
    --seasonId 'cyiuATus' \
    --body '{"currency": {"currencyCode": "9hsfpFDc", "namespace": "SDG8aMVG"}, "image": {"as": "LiBNrDjq", "caption": "oxcwgGLX", "height": 32, "imageUrl": "cekdqCt8", "smallImageUrl": "1P1ktfIo", "width": 44}, "itemId": "eIP6rOvD", "nullFields": ["z9KOsb39", "2k6YmJFf", "RByjlBiu"], "quantity": 65, "type": "ITEM"}' \
    > test.out 2>&1
