...
public class Main {
    ...
    // Please read the note in settings.gradle (samples/login-or-refresh/settings.gradle) for this project
    public static void main(String[] args) {
        ...
        boolean result = sdk.loginOrRefreshUser(System.getenv("AB_USERNAME"), System.getenv("AB_PASSWORD"));
