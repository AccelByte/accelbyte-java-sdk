...
@Getter
@Setter
public class AdminGetUnusedReasons extends Operation {
  /** generated field's value */
  private String path = "/reporting/v1/admin/namespaces/{namespace}/reasons/unused";
  ...
  public RestapiUnusedReasonListResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new RestapiUnusedReasonListResponse().createFromJson(json);
  }
