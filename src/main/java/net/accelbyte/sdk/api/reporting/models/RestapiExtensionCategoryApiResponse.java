...
public class RestapiExtensionCategoryApiResponse extends Model {
  ...
  @JsonIgnore
  public RestapiExtensionCategoryApiResponse createFromJson(String json)
      throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<RestapiExtensionCategoryApiResponse> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<RestapiExtensionCategoryApiResponse>>() {});
  }
}
