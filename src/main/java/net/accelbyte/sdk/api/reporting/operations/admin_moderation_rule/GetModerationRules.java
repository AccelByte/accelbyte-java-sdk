...
@Getter
@Setter
public class GetModerationRules extends Operation {
  ...
  public GetModerationRules(
      String namespace, String category, String extensionCategory, Integer limit, Integer offset) {
  ...
  public RestapiModerationRulesList parseResponse(int code, String contentType, InputStream payload)
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new RestapiModerationRulesList().createFromJson(json);
  }
