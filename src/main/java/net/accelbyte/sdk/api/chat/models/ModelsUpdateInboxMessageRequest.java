...
public class ModelsUpdateInboxMessageRequest extends Model {
    ...
    @JsonIgnore
    public ModelsUpdateInboxMessageRequest createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ModelsUpdateInboxMessageRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsUpdateInboxMessageRequest>>() {});
    }
