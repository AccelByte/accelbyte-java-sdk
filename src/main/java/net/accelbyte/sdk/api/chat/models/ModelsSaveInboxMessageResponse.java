...
public class ModelsSaveInboxMessageResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelsSaveInboxMessageResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsSaveInboxMessageResponse>>() {});
    }
