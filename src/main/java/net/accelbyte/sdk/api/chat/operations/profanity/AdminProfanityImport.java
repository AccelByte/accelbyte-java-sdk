...
public class AdminProfanityImport extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("showResult", this.showResult == null ? null : Arrays.asList(String.valueOf(this.showResult)));
        return queryParams;
    }
    ...
    public ModelsDictionaryImportResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
