...
public class AdminQueryTopicLog extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("senderUserId", this.senderUserId == null ? null : Arrays.asList(this.senderUserId));
    ...
    public ModelsTopicLogWithPaginationResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
