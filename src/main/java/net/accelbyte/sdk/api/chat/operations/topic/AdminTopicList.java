...
@Getter
@Setter
public class AdminTopicList extends Operation {
  ...
  @Deprecated
  public AdminTopicList(String namespace, Integer limit, Integer offset, String topicType) {
  ...
  public List<ModelsTopicResponse> parseResponse(int code, String contentType, InputStream payload)
