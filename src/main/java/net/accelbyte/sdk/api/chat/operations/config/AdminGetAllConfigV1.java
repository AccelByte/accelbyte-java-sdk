...
public class AdminGetAllConfigV1 extends Operation {
     ...
     */
    private String path = "/chat/v1/admin/config";
    ...
    */
    ...
    public ModelsConfigList parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
