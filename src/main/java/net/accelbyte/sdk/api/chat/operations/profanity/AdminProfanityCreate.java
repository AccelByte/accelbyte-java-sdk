...
@Getter
@Setter
public class AdminProfanityCreate extends Operation {
    /**
    ...
    private ModelsDictionaryInsertRequest body;
    ...
    */
    ...
    @Override
    public ModelsDictionaryInsertRequest getBodyParams(){
        return this.body;
    }
    ...
    public ModelsDictionary parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
