...
public class Profanity {
     ...
     */
    public ModelsDictionaryQueryResult adminProfanityQuery(AdminProfanityQuery input) throws Exception {
     ...
     */
    public List<ModelsDictionaryGroup> adminProfanityGroup(AdminProfanityGroup input) throws Exception {
        final HttpResponse httpResponse = sdk.runRequest(input);
        return input
            .parseResponse(
        httpResponse.getCode(), httpResponse.getContentType(), httpResponse.getPayload()
     ...
     */
    public ModelsDictionaryImportResult adminProfanityImport(AdminProfanityImport input) throws Exception {
        final HttpResponse httpResponse = sdk.runRequest(input);
        return input
            .parseResponse(
        httpResponse.getCode(), httpResponse.getContentType(), httpResponse.getPayload()
