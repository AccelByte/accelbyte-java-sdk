...
public class ModelsSaveInboxMessageRequest extends Model {
    ...
    @JsonIgnore
    public List<ModelsSaveInboxMessageRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsSaveInboxMessageRequest>>() {});
    }
