...
public class AdminGetInboxMessages extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("endCreatedAt", this.endCreatedAt == null ? null : Arrays.asList(String.valueOf(this.endCreatedAt)));
        ...
        queryParams.put("startCreatedAt", this.startCreatedAt == null ? null : Arrays.asList(String.valueOf(this.startCreatedAt)));
        queryParams.put("status", this.status == null ? null : Arrays.asList(this.status));
        queryParams.put("transient", this.transient_ == null ? null : Arrays.asList(String.valueOf(this.transient_)));
        return queryParams;
    }
    ...
    public ModelsGetInboxMessagesResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
