...
@Getter
@Setter
public class AdminGetChatSnapshot extends Operation {
  ...
  @Deprecated
  public AdminGetChatSnapshot(String chatId, String namespace) {
    this.chatId = chatId;
  ...
  public ModelsChatSnapshots parseResponse(int code, String contentType, InputStream payload)
