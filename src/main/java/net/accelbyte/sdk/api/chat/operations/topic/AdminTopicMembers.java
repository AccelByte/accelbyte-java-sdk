...
public class AdminTopicMembers extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("isBanned", this.isBanned == null ? null : Arrays.asList(String.valueOf(this.isBanned)));
        queryParams.put("isModerator", this.isModerator == null ? null : Arrays.asList(String.valueOf(this.isModerator)));
    ...
    public ModelsTopicMemberWithPaginationResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
