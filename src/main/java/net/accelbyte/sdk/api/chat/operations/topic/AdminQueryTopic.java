...
public class AdminQueryTopic extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("includeMembers", this.includeMembers == null ? null : Arrays.asList(String.valueOf(this.includeMembers)));
        queryParams.put("includePastMembers", this.includePastMembers == null ? null : Arrays.asList(String.valueOf(this.includePastMembers)));
        queryParams.put("includePastTopics", this.includePastTopics == null ? null : Arrays.asList(String.valueOf(this.includePastTopics)));
        queryParams.put("limit", this.limit == null ? null : Arrays.asList(String.valueOf(this.limit)));
        queryParams.put("offset", this.offset == null ? null : Arrays.asList(String.valueOf(this.offset)));
        queryParams.put("topic", this.topic == null ? null : this.topic);
        queryParams.put("topicSubType", this.topicSubType == null ? null : Arrays.asList(this.topicSubType));
    ...
    public List<ModelsTopicInfo> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
