...
public class ModelsAddInboxCategoryResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelsAddInboxCategoryResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsAddInboxCategoryResponse>>() {});
    }
