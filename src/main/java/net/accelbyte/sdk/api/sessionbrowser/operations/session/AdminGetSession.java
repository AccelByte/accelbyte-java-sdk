...
public class AdminGetSession extends Operation {
     ...
     */
    private String url = "/sessionbrowser/admin/namespaces/{namespace}/gamesession/{sessionID}";
    ...
    */
    ...
    public ModelsAdminSessionResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
