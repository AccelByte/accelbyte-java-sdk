...
public class GetTotalActiveSession extends Operation {
     ...
     */
    private String url = "/sessionbrowser/admin/namespaces/{namespace}/gamesession/active/count";
    ...
    */
    ...
    @Override
    public ModelsCountActiveSessionResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
