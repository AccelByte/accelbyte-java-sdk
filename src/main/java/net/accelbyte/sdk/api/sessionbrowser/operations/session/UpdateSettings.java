...
import net.accelbyte.sdk.api.sessionbrowser.models.ModelsUpdateSettingsRequest;
 ...
 *
 * <p>Update game session, used to update OtherSettings
 */
@Getter
@Setter
public class UpdateSettings extends Operation {
   ...
   */
  @Builder
  public UpdateSettings(String namespace, String sessionID, ModelsUpdateSettingsRequest body) {
