...
public class GetSessionByUserIDs extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("user_ids", this.userIds == null ? null : Arrays.asList(this.userIds));
        return queryParams;
    }
    ...
    public ModelsSessionByUserIDsResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
