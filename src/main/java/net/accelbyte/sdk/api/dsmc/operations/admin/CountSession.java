 ...
 *
 * <p>This endpoint count all of sessions in a namespace managed by this service.
 */
@Getter
@Setter
public class CountSession extends Operation {
  ...
  @Deprecated
  public CountSession(String namespace, String region) {
  ...
  public ModelsCountSessionResponse parseResponse(int code, String contentType, InputStream payload)
