 ...
 * DeleteConfig
 *
 * <p>``` Required permission: ADMIN:NAMESPACE:{namespace}:DSM:CONFIG [DELETE] Required scope:
 * social
 *
 * <p>This endpoint removes config. When there are ready servers, those servers will be removed. ```
 */
@Getter
@Setter
