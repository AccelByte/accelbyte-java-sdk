...
public class GetImageLimit extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/dsmcontroller/admin/namespaces/{namespace}/images/limit";
    ...
    */
    ...
    @Override
    @JsonIgnore
    public ModelsGetImageLimitResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
