...
public class DeleteLocalServer extends Operation {
     ...
     */
    private String url = "/dsmcontroller/admin/namespaces/{namespace}/servers/local/{name}";
    ...
    */
    ...
    public DeleteLocalServer createFromJson(String json) throws JsonProcessingException {
