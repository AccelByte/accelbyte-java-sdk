 ...
 *
 * <p>Required permission: NAMESPACE:{namespace}:DSM:CONFIG [CREATE]
 *
 * <p>Required scope: social
 *
 * <p>This endpoint create a dedicated servers deployment in a namespace.
 */
@Getter
@Setter
public class CreateDeploymentClient extends Operation {
  ...
  public CreateDeploymentClient(
      String deployment, String namespace, ModelsCreateDeploymentRequest body) {
