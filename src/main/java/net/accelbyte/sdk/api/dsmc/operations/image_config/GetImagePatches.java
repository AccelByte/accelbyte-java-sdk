...
public class GetImagePatches extends Operation {
     ...
     */
    private String path = "/dsmcontroller/admin/namespaces/{namespace}/images/versions/{version}/patches";
    ...
    */
    ...
    public ModelsListImagePatchesResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
