...
import net.accelbyte.sdk.api.dsmc.models.ModelsCreateDSMConfigRequest;
 ...
 * Required scope: social This endpoint creates config. Port is where your game
 * listens for incoming UDP connection, if empty it'll be set to 15000 CPU and
 * Memory limit / request are formatted with Kubernetes format, e.g. CPU of 1000m
 * is 1 core, and Memory of 512Mi is 512 MB. The
 * creation/claim/session/unreachable/heartbeat timeouts are all in seconds.
