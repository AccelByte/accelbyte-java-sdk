 ...
 *
 * <p>This endpoint is intended to be called by dedicated server to query its session ID. DS should
...
public class GetServerSession extends Operation {
  ...
  public ModelsServerSessionResponse parseResponse(int code, String contentTpe, InputStream payload)
