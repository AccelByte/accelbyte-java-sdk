...
@NoArgsConstructor
public class ModelsServerDetailsResponse extends Model {
  ...
  @JsonIgnore
  public ModelsServerDetailsResponse createFromJson(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<ModelsServerDetailsResponse> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<ModelsServerDetailsResponse>>() {});
  }
}
