...
public class ModelsDetailedCountServerResponse extends Model {
  ...
  @JsonIgnore
  public ModelsDetailedCountServerResponse createFromJson(String json)
      throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<ModelsDetailedCountServerResponse> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<ModelsDetailedCountServerResponse>>() {});
  }
}
