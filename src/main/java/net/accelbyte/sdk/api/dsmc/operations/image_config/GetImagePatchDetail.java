...
public class GetImagePatchDetail extends Operation {
     ...
     */
    private String url = "/dsmcontroller/admin/namespaces/{namespace}/images/versions/{version}/patches/{versionPatch}";
    ...
    */
    ...
    public GetImagePatchDetail createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public ModelsGetImagePatchDetailResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
