 ...
 * scope: social This endpoint get a all pod configs in a namespace
 */
@Getter
@Setter
...
public class GetAllPodConfig extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/dsmcontroller/admin/namespaces/{namespace}/configs/pods";
    ...
    */
    ...
    @Override
    @JsonIgnore
    public ModelsListPodConfigResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
