...
public class ExportImages extends Operation {
     ...
     */
    private String url = "/dsmcontroller/admin/namespaces/{namespace}/images/export";
    ...
    */
    ...
    public List<ModelsImageRecord> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
