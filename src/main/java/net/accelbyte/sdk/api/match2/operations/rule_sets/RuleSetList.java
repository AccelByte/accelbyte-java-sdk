...
@Getter
@Setter
public class RuleSetList extends Operation {
  ...
  @Deprecated
  public RuleSetList(String namespace, Integer limit, String name, Integer offset) {
  ...
  public ApiListRuleSetsResponse parseResponse(int code, String contentType, InputStream payload)
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApiListRuleSetsResponse().createFromJson(json);
  }
