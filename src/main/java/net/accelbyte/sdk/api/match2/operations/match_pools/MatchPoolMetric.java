 ...
 * MatchPoolMetric
 *
 * <p>Required Permission: NAMESPACE:{namespace}:MATCHMAKING:POOL:METRICS [READ]
 *
 * <p>Required Scope: social
 *
 * <p>Get metric for a specific match pool
 *
 * <p>Result: queueTime in seconds
 */
@Getter
@Setter
public class MatchPoolMetric extends Operation {
  ...
  public ApiTicketMetricResultRecord parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApiTicketMetricResultRecord().createFromJson(json);
  }
}
