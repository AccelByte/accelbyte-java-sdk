...
@Getter
@Setter
public class MatchPoolList extends Operation {
  ...
  @Deprecated
  public MatchPoolList(String namespace, Integer limit, String name, Integer offset) {
  ...
  public ApiListMatchPoolsResponse parseResponse(int code, String contentType, InputStream payload)
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApiListMatchPoolsResponse().createFromJson(json);
  }
