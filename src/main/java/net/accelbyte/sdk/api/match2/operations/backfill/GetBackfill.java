 ...
 *
 * <p>Get backfill ticket by ID
 */
@Getter
@Setter
public class GetBackfill extends Operation {
  ...
  @Deprecated
  public GetBackfill(String backfillID, String namespace) {
  ...
  public ApiBackfillGetResponse parseResponse(int code, String contentType, InputStream payload)
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApiBackfillGetResponse().createFromJson(json);
  }
}
