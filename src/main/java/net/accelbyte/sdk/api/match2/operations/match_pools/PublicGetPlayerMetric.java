 ...
 *
 * <p>Public get player metric for a specific match pool
 */
@Getter
@Setter
public class PublicGetPlayerMetric extends Operation {
  ...
  @Deprecated
  public PublicGetPlayerMetric(String namespace, String pool) {
