 ...
 * PublicListItems
 *
 * <p>Listing all user's owned items in an inventory. The response body will be in the form of
 * standard pagination.
 */
@Getter
@Setter
public class PublicListItems extends Operation {
  ...
  public static class PublicListItemsBuilder {
    ...
    public PublicListItemsBuilder sortBy(final String sortBy) {
      this.sortBy = sortBy;
      return this;
    }

    public PublicListItemsBuilder sortByFromEnum(final SortBy sortBy) {
