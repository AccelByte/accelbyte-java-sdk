...
public class ApimodelsTradeItem extends Model {
  ...
  @JsonIgnore
  public List<ApimodelsTradeItem> createFromJsonList(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsTradeItem>>() {});
  }
}
