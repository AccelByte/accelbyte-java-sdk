 ...
 *
 * <p>Getting an inventory configuration info.
 *
 * <p>Permission: ADMIN:NAMESPACE:{namespace}:INVENTORY:CONFIGURATION [READ]
 */
@Getter
@Setter
public class AdminGetInventoryConfiguration extends Operation {
  ...
  @Deprecated
  public AdminGetInventoryConfiguration(String inventoryConfigurationId, String namespace) {
