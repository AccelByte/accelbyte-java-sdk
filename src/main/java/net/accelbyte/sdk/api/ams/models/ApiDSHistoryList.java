...
public class ApiDSHistoryList extends Model {
  ...
  @JsonIgnore
  public List<ApiDSHistoryList> createFromJsonList(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, new TypeReference<List<ApiDSHistoryList>>() {});
  }
}
