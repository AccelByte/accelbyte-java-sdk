...
@Getter
@Setter
public class FleetCreate extends Operation {
  ...
  @Deprecated
  public FleetCreate(String namespace, ApiFleetParameters body) {
  ...
  public ApiFleetCreateResponse parseResponse(int code, String contentType, InputStream payload)
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApiFleetCreateResponse().createFromJson(json);
  }
}
