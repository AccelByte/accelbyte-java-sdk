 ...
 * ImagesStorage
 *
 * <p>Returns information regarding the account's usage for images storage including the free tier
 * quota
 *
...
public class ImagesStorage extends Operation {
  ...
  @Deprecated
  public ImagesStorage(String namespace) {
  ...
  public ApiImageStorage parseResponse(int code, String contentType, InputStream payload)
