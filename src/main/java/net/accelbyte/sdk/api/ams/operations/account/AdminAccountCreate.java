...
public class AdminAccountCreate extends Operation {
  ...
  private ApiAccountCreateRequest body;
  ...
  @Override
  public ApiAccountCreateRequest getBodyParams() {
    return this.body;
  }
  ...
  public ApiAccountCreateResponse parseResponse(int code, String contentType, InputStream payload)
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApiAccountCreateResponse().createFromJson(json);
  }
}
