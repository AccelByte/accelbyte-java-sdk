...
public class ApiFleetListResponse extends Model {
  ...
  @JsonIgnore
  public List<ApiFleetListResponse> createFromJsonList(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, new TypeReference<List<ApiFleetListResponse>>() {});
  }
}
