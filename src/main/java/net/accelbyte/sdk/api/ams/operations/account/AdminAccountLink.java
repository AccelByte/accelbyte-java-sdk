 ...
 * AdminAccountLink
 *
 * <p>This route will attempt to register the account to namespace linkage in AMS and requires a
 * valid account link token. This route fails if an account is already linked
 *
...
public class AdminAccountLink extends Operation {
  ...
  @Deprecated
  public AdminAccountLink(String namespace, ApiAccountLinkRequest body) {
