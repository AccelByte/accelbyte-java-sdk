...
@Getter
@Setter
public class PublicIndirectBulkAcceptVersionedPolicy extends Operation {
  ...
  @Deprecated
  public PublicIndirectBulkAcceptVersionedPolicy(String userId, List<AcceptAgreementRequest> body) {
    this.userId = userId;
    this.body = body;
