 ...
 * deleteBasePolicy
 *
 * <p>Delete base legal policy.Can only be deleted if match these criteria:
 *
 * <p>* Base policy don't have published policy version * Policy version under base policy has never
 * been accepted by any user
 */
@Getter
@Setter
public class DeleteBasePolicy extends Operation {
  ...
  @Deprecated
  public DeleteBasePolicy(String basePolicyId, String namespace) {
