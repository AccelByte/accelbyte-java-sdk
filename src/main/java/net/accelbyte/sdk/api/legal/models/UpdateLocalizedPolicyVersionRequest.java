...
public class UpdateLocalizedPolicyVersionRequest extends Model {
  ...
  @JsonIgnore
  public UpdateLocalizedPolicyVersionRequest createFromJson(String json)
      throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<UpdateLocalizedPolicyVersionRequest> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<UpdateLocalizedPolicyVersionRequest>>() {});
  }
}
