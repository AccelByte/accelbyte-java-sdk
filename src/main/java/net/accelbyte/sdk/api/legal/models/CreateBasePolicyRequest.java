...
public class CreateBasePolicyRequest extends Model {
  ...
  @JsonIgnore
  public List<CreateBasePolicyRequest> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<CreateBasePolicyRequest>>() {});
  }
  ...
  public static class CreateBasePolicyRequestBuilder {
    ...
    public CreateBasePolicyRequestBuilder countryType(final String countryType) {
      this.countryType = countryType;
      return this;
    }

    public CreateBasePolicyRequestBuilder countryTypeFromEnum(final CountryType countryType) {
      this.countryType = countryType.toString();
      return this;
    }
  }
