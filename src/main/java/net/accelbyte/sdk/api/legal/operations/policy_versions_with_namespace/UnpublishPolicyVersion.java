 ...
 *
 * <p>Un-publish a policy version from policy.Can only be un-publish if match these criteria:
 *
 * <p>* Policy version has never been accepted by any user
 */
@Getter
@Setter
public class UnpublishPolicyVersion extends Operation {
  ...
  @Deprecated
  public UnpublishPolicyVersion(String namespace, String policyVersionId) {
