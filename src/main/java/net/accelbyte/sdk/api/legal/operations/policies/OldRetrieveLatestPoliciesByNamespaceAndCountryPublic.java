...
@Getter
@Setter
public class OldRetrieveLatestPoliciesByNamespaceAndCountryPublic extends Operation {
  ...
  public static class OldRetrieveLatestPoliciesByNamespaceAndCountryPublicBuilder {
    private String policyType;

    public OldRetrieveLatestPoliciesByNamespaceAndCountryPublicBuilder policyType(
        final String policyType) {
      this.policyType = policyType;
      return this;
    }

    public OldRetrieveLatestPoliciesByNamespaceAndCountryPublicBuilder policyTypeFromEnum(
