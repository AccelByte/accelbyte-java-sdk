...
@Getter
@Setter
public class CreateTopicHandler extends Operation {
  ...
  private ApimodelCreateTopicRequest body;
  ...
  @Deprecated
  public CreateTopicHandler(String namespace, ApimodelCreateTopicRequest body) {
  ...
  @Override
  public ApimodelCreateTopicRequest getBodyParams() {
    return this.body;
  }
