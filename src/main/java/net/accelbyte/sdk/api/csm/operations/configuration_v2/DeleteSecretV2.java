 ...
 *
 * <p>Delete an environment secret by its config id
 */
@Getter
@Setter
public class DeleteSecretV2 extends Operation {
  ...
  @Deprecated
  public DeleteSecretV2(String app, String configId, String namespace) {
    this.app = app;
