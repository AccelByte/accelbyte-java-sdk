 ...
 *
 * <p>Required permission : `ADMIN:NAMESPACE:{namespace}:EXTEND:NOSQL:DATABASES [CREATE]`
 *
...
@Getter
@Setter
public class CreateNoSQLDatabaseV2 extends Operation {
  ...
  private ApimodelCreateNoSQLAppDatabaseRequest body;
  ...
  public CreateNoSQLDatabaseV2(
      String app, String namespace, ApimodelCreateNoSQLAppDatabaseRequest body) {
    this.app = app;
  ...
  @Override
  public ApimodelCreateNoSQLAppDatabaseRequest getBodyParams() {
    return this.body;
  }
