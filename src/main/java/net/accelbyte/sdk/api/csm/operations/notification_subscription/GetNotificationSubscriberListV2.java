...
@Getter
@Setter
public class GetNotificationSubscriberListV2 extends Operation {
  ...
  @Deprecated
  public GetNotificationSubscriberListV2(String app, String namespace, String notificationType) {
    this.app = app;
