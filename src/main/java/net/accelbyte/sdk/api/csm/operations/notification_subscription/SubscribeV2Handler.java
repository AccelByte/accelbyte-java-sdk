 ...
 * [CREATE]`
 *
 * <p>Subscribe to app down notification Request body: - notificationType : type of the app
 * notification to be subscribed - Required. - values: - "all" - "app-down" -
...
public class SubscribeV2Handler extends Operation {
  ...
  public SubscribeV2Handler(
      String app, String namespace, ApimodelSelfSubscribeNotificationRequest body) {
    this.app = app;
