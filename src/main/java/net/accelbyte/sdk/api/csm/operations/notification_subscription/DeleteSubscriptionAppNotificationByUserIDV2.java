...
@Getter
@Setter
public class DeleteSubscriptionAppNotificationByUserIDV2 extends Operation {
  ...
  @Deprecated
  public DeleteSubscriptionAppNotificationByUserIDV2(String app, String namespace, String userId) {
    this.app = app;
