 ...
 *
 * <p>`status` field - indicates the NoSQL cluster status: - `updating` : The cluster is being
 ...
 * of being deleted and is not accessible. - `stopping` : The cluster is in the process of stopping
 * and will soon become inaccessible. - `stopped` : The cluster is stopped and not accessible. -
 * `available` : The cluster is accessible. - `failed` : The cluster failed to provision or is in an
 * error state and not accessible. - `starting` : The cluster is transitioning from stopped to
 * running, or is rebooting. - `maintenance` : The cluster is undergoing maintenance operations and
 * is not accessible. - `unknown` : The cluster status is not recognized
 */
@Getter
@Setter
