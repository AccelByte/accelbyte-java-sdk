 ...
 *
 * <p>`status` field - indicates the NoSQL cluster status: - `stopping` : The cluster is in the
 * process of stopping and will soon become inaccessible. - `starting` : The cluster is
 * transitioning from stopped to running, or is rebooting. - `maintenance` : The cluster is
 * undergoing maintenance operations and is not accessible. - `unknown` : The cluster status is not
 * recognized - `available` : The cluster is accessible. - `creating` : The cluster or instance is
 * being created and is not yet accessible. - `deleting` : The cluster is in the process of being
 * deleted and is not accessible. - `stopped` : The cluster is stopped and not accessible. -
