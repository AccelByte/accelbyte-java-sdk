...
@Getter
@Setter
public class UpdateAppResourcesV2 extends Operation {
  /** generated field's value */
  private String path = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/resources";
  ...
  private ApimodelUpdateAppResourceRequest body;
  ...
  @Deprecated
  public UpdateAppResourcesV2(String app, String namespace, ApimodelUpdateAppResourceRequest body) {
    this.app = app;
  ...
  @Override
  public ApimodelUpdateAppResourceRequest getBodyParams() {
    return this.body;
  }
