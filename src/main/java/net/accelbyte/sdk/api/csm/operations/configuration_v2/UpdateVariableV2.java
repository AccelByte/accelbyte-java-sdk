 ...
 * UpdateVariableV2
 *
 * <p>Required permission : `ADMIN:NAMESPACE:{namespace}:EXTEND:VARIABLE [UPDATE]`
 *
 * <p>Update an environment variable. Request body: - value : configuration value - Required. -
...
@Getter
@Setter
public class UpdateVariableV2 extends Operation {
  /** generated field's value */
  private String path = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/variables/{configId}";
  ...
  public UpdateVariableV2(
      String app, String configId, String namespace, ApimodelUpdateConfigurationV2Request body) {
    this.app = app;
  ...
  public ApimodelUpdateConfigurationV2Response parseResponse(
