...
@Getter
@Setter
public class StartAppV2 extends Operation {
  /** generated field's value */
  private String path = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/start";
  ...
  @Deprecated
  public StartAppV2(String app, String namespace) {
    this.app = app;
