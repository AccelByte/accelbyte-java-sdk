...
@NoArgsConstructor
public class GeneratedGetAppListV1DataItem extends Model {
  ...
  @JsonIgnore
  public GeneratedGetAppListV1DataItem createFromJson(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<GeneratedGetAppListV1DataItem> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<GeneratedGetAppListV1DataItem>>() {});
  }
}
