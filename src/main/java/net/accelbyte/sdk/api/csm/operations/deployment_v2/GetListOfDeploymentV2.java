 ...
 * Request : - appIds : list of app ids - deploymentIds: list of deployment ids - statuses:
 * deployment-in-progress deployment-failed deployment-timeout deployment-running deployment-down
...
public class GetListOfDeploymentV2 extends Operation {
  ...
  public GetListOfDeploymentV2(
      String namespace, Integer limit, Integer offset, ApimodelGetDeploymentListV2Request body) {
  ...
  public ApimodelGetDeploymentListV2Response parseResponse(
