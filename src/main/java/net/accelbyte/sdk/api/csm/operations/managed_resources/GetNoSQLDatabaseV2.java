 ...
 * transitioning from stopped to running, or is rebooting. - `unknown` : The cluster status is not
 * recognized - `failed` : The cluster failed to provision or is in an error state and not
