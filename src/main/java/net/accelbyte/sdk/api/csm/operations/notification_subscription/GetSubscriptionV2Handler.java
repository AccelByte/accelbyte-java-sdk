...
@Getter
@Setter
public class GetSubscriptionV2Handler extends Operation {
  ...
  @Deprecated
  public GetSubscriptionV2Handler(String app, String namespace) {
    this.app = app;
  ...
  public ApimodelGetNotificationSubscriberStatusResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApimodelGetNotificationSubscriberStatusResponse().createFromJson(json);
  }
}
