...
@Getter
@Setter
public class DeleteAppImagesV1 extends Operation {
  ...
  private GeneratedDeleteAppImagesV1Request body;
  ...
  @Deprecated
  public DeleteAppImagesV1(String app, String namespace, GeneratedDeleteAppImagesV1Request body) {
    this.app = app;
  ...
  @Override
  public GeneratedDeleteAppImagesV1Request getBodyParams() {
    return this.body;
  }
