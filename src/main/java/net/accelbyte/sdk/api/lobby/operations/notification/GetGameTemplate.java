...
public class GetGameTemplate extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/notification/namespaces/{namespace}/templates";
    ...
    */
    ...
    @Override
    public List<ModelTemplateResponse> parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
