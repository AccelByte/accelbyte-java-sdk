...
public class AdminGetAllPlayerSessionAttribute extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/lobby/v1/admin/player/namespaces/{namespace}/users/{userId}/attributes";
    ...
    */
    ...
    @JsonIgnore
    public AdminGetAllPlayerSessionAttribute createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public ModelsGetAllPlayerSessionAttributeResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
        String json = this.convertInputStreamToString(payload);
        if(code == 200){
            return new ModelsGetAllPlayerSessionAttributeResponse().createFromJson(json);
        }
