 ...
 * personalChatHistory
 *
 * <p>Required permission : `NAMESPACE:{namespace}:USER:{userId}:CHAT [READ]` with scope `social`
 *
 * <p>load personal chat history in a namespace.
 */
@Getter
@Setter
public class PersonalChatHistory extends Operation {
  /** generated field's value */
  private String path = "/lobby/chat/namespaces/{namespace}/users/{userId}/friend/{friendId}";
