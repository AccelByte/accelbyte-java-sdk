...
public class PartyInviteRequest {
  ...
  @Deprecated
  public PartyInviteRequest(String friendId, String id) {
  ...
  public static PartyInviteRequest createFromWSM(String message) {
    PartyInviteRequest result = new PartyInviteRequest();
  ...
  public String toWSM() {
    ...
    stringBuilder.append("type: ").append(PartyInviteRequest.getType());
    if (friendId != null) {
