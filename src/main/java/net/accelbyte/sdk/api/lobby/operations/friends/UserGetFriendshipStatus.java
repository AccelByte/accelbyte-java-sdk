...
public class UserGetFriendshipStatus extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/friends/namespaces/{namespace}/me/status/{friendId}";
    ...
    */
    ...
    @JsonIgnore
    public UserGetFriendshipStatus createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public ModelUserGetFriendshipStatusResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
