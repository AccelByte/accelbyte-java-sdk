...
@Getter
@Setter
public class GetIncomingFriendRequests extends Operation {
  /** generated field's value */
  private String path = "/lobby/v1/admin/friend/namespaces/{namespace}/users/{userId}/incoming";
  ...
  public ModelLoadIncomingFriendsWithTimeResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ModelLoadIncomingFriendsWithTimeResponse().createFromJson(json);
  }
