...
public class AdminGetPlayerBlockedByPlayersV1 extends Operation {
    ...
    */
    ...
    @JsonIgnore
    public AdminGetPlayerBlockedByPlayersV1 createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public ModelsGetAllPlayerBlockedByUsersResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
