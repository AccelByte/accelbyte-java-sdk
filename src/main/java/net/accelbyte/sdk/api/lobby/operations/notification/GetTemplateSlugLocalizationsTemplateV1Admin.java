...
public class GetTemplateSlugLocalizationsTemplateV1Admin extends Operation {
     ...
     */
    private String url = "/lobby/v1/admin/notification/namespaces/{namespace}/templates/{templateSlug}";
    ...
    */
    ...
    public ModelGetAllNotificationTemplateSlugResp parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
