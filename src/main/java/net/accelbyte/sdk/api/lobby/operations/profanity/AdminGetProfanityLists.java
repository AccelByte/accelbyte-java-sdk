...
public class AdminGetProfanityLists extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/lobby/v1/admin/profanity/namespaces/{namespace}/lists";
    ...
    */
    ...
    @Override
    @JsonIgnore
    public List<ModelsAdminGetProfanityListsListResponse> parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
