...
@Getter
@Setter
public class CreateNotificationTemplateV1Admin extends Operation {
  ...
  @Deprecated
  public CreateNotificationTemplateV1Admin(String namespace, ModelCreateTemplateRequest body) {
