...
public class AdminGetPlayerBlockedPlayersV1 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/lobby/v1/admin/player/namespaces/{namespace}/users/{userId}/blocked";
    ...
    */
    ...
    @JsonIgnore
    public AdminGetPlayerBlockedPlayersV1 createFromJson(String json) throws JsonProcessingException {
