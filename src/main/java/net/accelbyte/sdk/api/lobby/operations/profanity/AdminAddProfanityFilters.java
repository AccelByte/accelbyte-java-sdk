...
public class AdminAddProfanityFilters extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/lobby/v1/admin/profanity/namespaces/{namespace}/list/{list}/filters/bulk";
    ...
    */
    ...
    public AdminAddProfanityFilters createFromJson(String json) throws JsonProcessingException {
