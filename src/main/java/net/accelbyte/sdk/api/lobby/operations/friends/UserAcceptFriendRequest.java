...
import net.accelbyte.sdk.api.lobby.models.ModelUserAcceptFriendRequest;
...
public class UserAcceptFriendRequest extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/friends/namespaces/{namespace}/me/request/accept";
    ...
    */
    ...
    @JsonIgnore
    public UserAcceptFriendRequest createFromJson(String json) throws JsonProcessingException {
