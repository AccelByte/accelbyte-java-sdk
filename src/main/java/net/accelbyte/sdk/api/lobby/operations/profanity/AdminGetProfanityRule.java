...
public class AdminGetProfanityRule extends Operation {
    ...
    */
    ...
    @JsonIgnore
    public AdminGetProfanityRule createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public ModelsProfanityRule parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
        String json = this.convertInputStreamToString(payload);
        if(code == 200){
            return new ModelsProfanityRule().createFromJson(json);
        }
