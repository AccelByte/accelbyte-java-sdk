...
public class GetUserFriendsUpdated extends Operation {
     ...
     */
    private String path = "/friends/namespaces/{namespace}/me";
    ...
    */
    ...
    public List<ModelGetUserFriendsResponse> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
