...
public class GetSingleTemplateLocalizationV1Admin extends Operation {
     ...
     */
    private String path = "/lobby/v1/admin/notification/namespaces/{namespace}/templates/{templateSlug}/languages/{templateLanguage}";
    ...
    */
    ...
    public ModelLocalization parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
