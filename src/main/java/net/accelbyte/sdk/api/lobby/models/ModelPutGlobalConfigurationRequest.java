...
public class ModelPutGlobalConfigurationRequest extends Model {
  ...
  @JsonIgnore
  public ModelPutGlobalConfigurationRequest createFromJson(String json)
      throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<ModelPutGlobalConfigurationRequest> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<ModelPutGlobalConfigurationRequest>>() {});
  }
}
