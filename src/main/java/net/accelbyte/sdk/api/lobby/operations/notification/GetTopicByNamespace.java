...
@Getter
@Setter
public class GetTopicByNamespace extends Operation {
    /**
    ...
    */
    ...
    public ModelTopicByNamespacesResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
        String json = this.convertInputStreamToString(payload);
        if(code == 200){
            return new ModelTopicByNamespacesResponse().createFromJson(json);
        }
