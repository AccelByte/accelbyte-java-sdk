...
public class AdminVerifyMessageProfanityResponse extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/lobby/v1/admin/profanity/namespaces/{namespace}/verify";
    ...
    */
    ...
    @JsonIgnore
    public AdminVerifyMessageProfanityResponse createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public ModelsAdminVerifyMessageProfanityResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
