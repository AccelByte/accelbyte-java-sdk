...
public class PagedResponseGetNamespaceEventResponse extends Model {
  ...
  @JsonIgnore
  public List<PagedResponseGetNamespaceEventResponse> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<PagedResponseGetNamespaceEventResponse>>() {});
  }
}
