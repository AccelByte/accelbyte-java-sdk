 ...
 *
 * <p>This endpoint will validate the request's email address.
 *
 * <p>If it already been used, will response 409.
 *
 * <p>If it is available, we will send a verification code to this email address. This code can be
...
public class PublicSendRegistrationCode extends Operation {
  ...
  public PublicSendRegistrationCode(
      String namespace, ModelSendRegisterVerificationCodeRequest body) {
