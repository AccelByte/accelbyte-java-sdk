 ...
 *
 * <p>This API is for admin to delete user's linking restriction with target platform id.
 *
...
@Getter
@Setter
public class AdminDeleteUserLinkingRestrictionByPlatformIDV3 extends Operation {
  /** generated field's value */
  private String path =
      "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/link/restrictions";
