...
public class AdminPlatformUnlinkV3 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}";
    ...
    */
    ...
    @JsonIgnore
    public AdminPlatformUnlinkV3 createFromJson(String json) throws JsonProcessingException {
