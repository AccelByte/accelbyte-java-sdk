...
@Getter
@Setter
public class AdminGetAgeRestrictionStatusV2 extends Operation {
    /**
    ...
    */
    ...
    public AdminGetAgeRestrictionStatusV2 createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public ModelAgeRestrictionResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
