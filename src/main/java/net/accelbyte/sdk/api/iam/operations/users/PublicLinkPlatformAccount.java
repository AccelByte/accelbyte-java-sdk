...
import net.accelbyte.sdk.api.iam.models.ModelLinkPlatformAccountRequest;
 ...
 *
 * <p>It is going to be DEPRECATED for security purpose. Update Platform Account relation to current
 * User Account. Note: Game progression data (statistics, reward, etc) associated with previous User
 * Account will not be transferred. If the data is tight to game user ID, the user will have the
