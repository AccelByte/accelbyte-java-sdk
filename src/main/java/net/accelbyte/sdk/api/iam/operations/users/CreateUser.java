 ...
 * CreateUser
 *
 * <p>Required permission 'NAMESPACE:{namespace}:USER [CREATE]'.
 *
 * <p>Available Authentication Types:
 *
 * <p>1. EMAILPASSWD : an authentication type used for new user registration through email.
 *
 * <p>2. PHONEPASSWD : an authentication type used for new user registration through phone number.
 *
...
public class CreateUser extends Operation {
   ...
   */
  @Builder
  public CreateUser(String namespace, ModelUserCreateRequest body) {
  ...
  public ModelUserCreateResponse parseResponse(int code, String contentTpe, InputStream payload)
