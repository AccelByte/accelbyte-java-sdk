...
@Getter
@Setter
public class AdminGetUserBanV3 extends Operation {
    /**
    ...
    */
    ...
    public ModelGetUserBanV3Response parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
