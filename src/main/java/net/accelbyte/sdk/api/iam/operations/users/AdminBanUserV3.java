...
public class AdminBanUserV3 extends Operation {
  ...
  private String path = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/bans";
   ...
   */
  @Builder
  public AdminBanUserV3(String namespace, String userId, ModelBanCreateRequest body) {
  ...
  public ModelUserBanResponseV3 parseResponse(int code, String contentTpe, InputStream payload)
