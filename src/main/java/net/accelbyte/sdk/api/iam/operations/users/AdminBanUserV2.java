...
public class AdminBanUserV2 extends Operation {
     ...
     */
    private String url = "/iam/v2/admin/namespaces/{namespace}/users/{userId}/ban";
    ...
    */
    ...
    public AdminBanUserV2 createFromJson(String json) throws JsonProcessingException {
    ...
    public ModelUserBanResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
