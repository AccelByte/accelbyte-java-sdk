 ...
 * Discord OAuth. - **awscognito**: The ticketâs value is the aws cognito access token (JWT). -
 * **epicgames**: The ticketâs value is an access-token obtained from Epicgames EOS Account
 * Service. - **nintendo**: The ticketâs value is the authorization code(id_token) returned by
 * Nintendo OAuth.
 */
@Getter
@Setter
