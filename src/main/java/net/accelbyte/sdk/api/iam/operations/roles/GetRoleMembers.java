...
public class GetRoleMembers extends Operation {
    ...
    */
    ...
    public GetRoleMembers createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public ModelRoleMembersResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
