 ...
 *
 * <p>Required permission 'ADMIN:NAMESPACE:{namespace}:PERMISSION:USER:{userId} [CREATE]'
 *
 * <p>This endpoint will APPEND user's permissions with the ones defined in body
 *
...
public class AdminAddUserPermissionsV3 extends Operation {
  ...
  @Deprecated
  public AdminAddUserPermissionsV3(String namespace, String userId, AccountcommonPermissions body) {
