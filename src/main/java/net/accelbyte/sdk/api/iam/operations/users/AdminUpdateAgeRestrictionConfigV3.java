...
public class AdminUpdateAgeRestrictionConfigV3 extends Operation {
    ...
    */
    ...
    public AdminUpdateAgeRestrictionConfigV3 createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public ModelAgeRestrictionResponseV3 parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
