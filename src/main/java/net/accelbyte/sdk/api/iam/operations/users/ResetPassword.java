...
import net.accelbyte.sdk.api.iam.models.ModelResetPasswordRequest;
...
public class ResetPassword extends Operation {
     ...
     */
    private String url = "/iam/namespaces/{namespace}/users/resetPassword";
    ...
    */
    ...
    public ResetPassword createFromJson(String json) throws JsonProcessingException {
