...
public class AdminGetListCountryAgeRestrictionV3 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v3/admin/namespaces/{namespace}/agerestrictions/countries";
    ...
    */
    ...
    @Override
    @JsonIgnore
    public List<ModelCountryV3Response> parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
