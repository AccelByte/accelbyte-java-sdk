...
public class PublicBulkGetUsers extends Operation {
  ...
  private String path = "/iam/v3/public/namespaces/{namespace}/users/bulk/basic";
  ...
  @Deprecated
  public PublicBulkGetUsers(String namespace, ModelUserIDsRequest body) {
  ...
  public ModelListBulkUserResponse parseResponse(int code, String contentType, InputStream payload)
