...
import net.accelbyte.sdk.api.iam.models.ModelUpgradeHeadlessAccountV3Request;
...
public class PublicVerifyHeadlessAccountV3 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v3/public/namespaces/{namespace}/users/me/headless/verify";
    ...
    */
    ...
    @JsonIgnore
    public PublicVerifyHeadlessAccountV3 createFromJson(String json) throws JsonProcessingException {
