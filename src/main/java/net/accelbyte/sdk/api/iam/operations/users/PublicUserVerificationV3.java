...
public class PublicUserVerificationV3 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v3/public/namespaces/{namespace}/users/me/code/verify";
    ...
    */
    ...
    @JsonIgnore
    public PublicUserVerificationV3 createFromJson(String json) throws JsonProcessingException {
