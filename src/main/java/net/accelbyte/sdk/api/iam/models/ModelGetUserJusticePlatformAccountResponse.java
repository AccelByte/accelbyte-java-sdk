...
public class ModelGetUserJusticePlatformAccountResponse extends Model {
    ...
    @JsonIgnore
    public ModelGetUserJusticePlatformAccountResponse createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ModelGetUserJusticePlatformAccountResponse> createFromJsonList(String json) throws JsonProcessingException {
