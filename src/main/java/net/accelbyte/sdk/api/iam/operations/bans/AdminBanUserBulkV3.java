...
@Getter
@Setter
public class AdminBanUserBulkV3 extends Operation {
  ...
  private ModelBulkBanCreateRequestV3 body;
  ...
  @Deprecated
  public AdminBanUserBulkV3(String namespace, ModelBulkBanCreateRequestV3 body) {
  ...
  @Override
  public ModelBulkBanCreateRequestV3 getBodyParams() {
    return this.body;
  }
