...
public class AdminDeleteUserPermissionV3 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/permissions/{resource}/{action}";
    ...
    */
    ...
    @JsonIgnore
    public AdminDeleteUserPermissionV3 createFromJson(String json) throws JsonProcessingException {
