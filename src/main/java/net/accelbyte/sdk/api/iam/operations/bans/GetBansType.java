 ...
 *
 * <p>Required Permission 'BAN:ADMIN [READ]' is going to be DEPRECATED for security purpose. It is
 * going to be deprecated on 31 JANUARY 2019 , please use permission 'ADMIN:BAN [READ]' instead.
 */
@Getter
@Setter
