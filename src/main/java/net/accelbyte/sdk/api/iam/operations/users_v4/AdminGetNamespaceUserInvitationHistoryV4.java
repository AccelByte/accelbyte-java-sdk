...
@Getter
@Setter
public class AdminGetNamespaceUserInvitationHistoryV4 extends Operation {
  ...
  @Deprecated
  public AdminGetNamespaceUserInvitationHistoryV4(String namespace, Integer limit, Integer offset) {
  ...
  public ModelNamespaceInvitationHistoryUserV4Response parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ModelNamespaceInvitationHistoryUserV4Response().createFromJson(json);
  }
