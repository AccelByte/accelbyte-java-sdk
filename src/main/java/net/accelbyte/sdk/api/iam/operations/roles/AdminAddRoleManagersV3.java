 ...
 *
 * <p>Role can only be assigned to other users by the role's manager. action code: 10408
 */
@Getter
@Setter
public class AdminAddRoleManagersV3 extends Operation {
  ...
  @Deprecated
  public AdminAddRoleManagersV3(String roleId, ModelRoleManagersRequestV3 body) {
    this.roleId = roleId;
    this.body = body;
