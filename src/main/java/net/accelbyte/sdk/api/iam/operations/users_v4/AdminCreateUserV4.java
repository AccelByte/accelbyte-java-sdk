...
@Getter
@Setter
public class AdminCreateUserV4 extends Operation {
  /** generated field's value */
  private String path = "/iam/v4/admin/namespaces/{namespace}/users";
  ...
  @Deprecated
  public AdminCreateUserV4(String namespace, AccountCreateUserRequestV4 body) {
