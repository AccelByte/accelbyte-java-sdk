...
import net.accelbyte.sdk.api.iam.models.ClientmodelClientUpdateSecretRequest;
 ...
 *
 * <p>* Substitute endpoint: /iam/v3/admin/namespaces/{namespace}/{clientId}/secret [PUT]
 *
 * <p>* Note:
 *
 * @deprecated
...
public class UpdateClientSecret extends Operation {
   ...
   */
  @Builder
  public UpdateClientSecret(String clientId, ClientmodelClientUpdateSecretRequest body) {
