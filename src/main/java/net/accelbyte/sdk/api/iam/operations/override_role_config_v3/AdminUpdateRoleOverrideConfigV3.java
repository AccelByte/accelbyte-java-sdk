...
@Getter
@Setter
public class AdminUpdateRoleOverrideConfigV3 extends Operation {
  ...
  public AdminUpdateRoleOverrideConfigV3(
      String namespace, String identity, ModelRoleOverrideUpdateRequest body) {
  ...
  public static class AdminUpdateRoleOverrideConfigV3Builder {
    ...
    public AdminUpdateRoleOverrideConfigV3Builder identity(final String identity) {
      this.identity = identity;
      return this;
    }

    public AdminUpdateRoleOverrideConfigV3Builder identityFromEnum(final Identity identity) {
