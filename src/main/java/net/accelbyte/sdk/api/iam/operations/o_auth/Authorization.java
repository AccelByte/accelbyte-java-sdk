 ...
 *
 * <p>2. Response Type == "token":
 *
 * <p>*
 *
 * <p>Authorize success : redirects to the given URL with the following information:
 *
 * <p>#access_token={accesstoken}&expires;_in={expiration duration in seconds}&token;_type=Bearer
 *
 * <p>*
 *
 * <p>Authorize failure : redirects to the given URL with the following information:
 *
 * <p>?error=access_denied&error;_description=...
 */
@Getter
@Setter
