...
public class AdminGetBulkUserByEmailAddressV3 extends Operation {
  ...
  private String path = "/iam/v3/admin/namespaces/{namespace}/users/search/bulk";
  ...
  @Deprecated
  public AdminGetBulkUserByEmailAddressV3(String namespace, ModelListEmailAddressRequest body) {
  ...
  public ModelListUserResponseV3 parseResponse(int code, String contentType, InputStream payload)
