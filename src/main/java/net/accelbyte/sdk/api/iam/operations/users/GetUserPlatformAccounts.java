...
public class GetUserPlatformAccounts extends Operation {
     ...
     */
    private String url = "/iam/namespaces/{namespace}/users/{userId}/platforms";
    ...
    */
    ...
    public List<AccountcommonUserLinkedPlatform> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
