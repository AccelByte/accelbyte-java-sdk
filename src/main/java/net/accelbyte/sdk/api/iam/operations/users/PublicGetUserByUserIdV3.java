...
public class PublicGetUserByUserIdV3 extends Operation {
  ...
  private String path = "/iam/v3/public/namespaces/{namespace}/users/{userId}";
  ...
  public ModelPublicUserResponseV3 parseResponse(int code, String contentTpe, InputStream payload)
