...
public class PublicGetUserByUserIdV3 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v3/public/namespaces/{namespace}/users/{userId}";
    ...
    */
    ...
    @Override
    @JsonIgnore
    public ModelPublicUserResponseV3 parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
