 ...
 *
 * <p>## Supported platforms: - **steam**: The ticketâs value is the authentication code returned
 * by Steam. - **steamopenid**: Steam's user authentication method using OpenID 2.0. The ticket's
 * value is URL generated by Steam on web authentication - **facebook**: The ticketâs value is the
 ...
 * the Androidâs device ID - **ios**: The ticket's value is the iOSâs device ID. - **device**:
