...
public class GetListJusticePlatformAccounts extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v2/public/namespaces/{namespace}/users/{userId}/platforms/justice";
    ...
    */
    ...
    @JsonIgnore
    public GetListJusticePlatformAccounts createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public List<ModelGetUserMapping> parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
