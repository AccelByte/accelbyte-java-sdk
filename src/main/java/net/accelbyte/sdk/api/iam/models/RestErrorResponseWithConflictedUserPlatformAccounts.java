...
public class RestErrorResponseWithConflictedUserPlatformAccounts extends Model {
  ...
  @JsonIgnore
  public List<RestErrorResponseWithConflictedUserPlatformAccounts> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(
            json,
            new TypeReference<List<RestErrorResponseWithConflictedUserPlatformAccounts>>() {});
  }
}
