...
public class PublicUpdateUserV2 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v2/public/namespaces/{namespace}/users/{userId}";
    ...
    */
    ...
    @JsonIgnore
    public PublicUpdateUserV2 createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public List<ModelUserResponse> parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
