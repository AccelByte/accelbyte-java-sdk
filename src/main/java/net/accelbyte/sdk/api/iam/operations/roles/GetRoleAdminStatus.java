...
public class GetRoleAdminStatus extends Operation {
     ...
     */
    private String url = "/iam/roles/{roleId}/admin";
    ...
    */
    ...
    @Override
    public ModelRoleAdminStatusResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
