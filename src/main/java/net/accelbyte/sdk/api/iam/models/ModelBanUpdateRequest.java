...
public class ModelBanUpdateRequest extends Model {
    ...
    @JsonIgnore
    public ModelBanUpdateRequest createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ModelBanUpdateRequest> createFromJsonList(String json) throws JsonProcessingException {
