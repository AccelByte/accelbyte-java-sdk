...
import net.accelbyte.sdk.api.iam.models.ModelNamespaceRoleRequest;
...
public class AdminSaveUserRoleV3 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/roles";
    ...
    */
    ...
    @JsonIgnore
    public AdminSaveUserRoleV3 createFromJson(String json) throws JsonProcessingException {
