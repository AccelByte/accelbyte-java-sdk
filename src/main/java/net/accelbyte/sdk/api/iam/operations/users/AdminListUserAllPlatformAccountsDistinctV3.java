...
@Getter
@Setter
public class AdminListUserAllPlatformAccountsDistinctV3 extends Operation {
  /** generated field's value */
  private String path = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/distinctPlatforms";
  ...
  @Deprecated
  public AdminListUserAllPlatformAccountsDistinctV3(String namespace, String userId) {
