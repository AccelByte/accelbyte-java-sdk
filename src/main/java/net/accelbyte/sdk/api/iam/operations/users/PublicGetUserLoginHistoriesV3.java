 ...
 *
 * <p>Notes for this endpoint: - The maximum value of the limit is 100 and the minimum value of the
 * limit is 1. - This endpoint retrieve the first page of the data if `after` and `before`
 * parameters is empty. - This endpoint retrieve the next page of the data if we provide `after`
