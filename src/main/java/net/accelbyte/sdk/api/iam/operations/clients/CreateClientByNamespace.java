 ...
 *
 * <p>Required permission 'ADMIN:NAMESPACE:{namespace}:CLIENT [CREATE]' Endpoint migration guide
 *
 * <p>* Substitute endpoint: /v3/admin/namespaces/{namespace}/clients [POST]
 *
 * @deprecated
 */
@Deprecated
...
public class CreateClientByNamespace extends Operation {
  ...
  @Deprecated
  public CreateClientByNamespace(String namespace, ClientmodelClientCreateRequest body) {
