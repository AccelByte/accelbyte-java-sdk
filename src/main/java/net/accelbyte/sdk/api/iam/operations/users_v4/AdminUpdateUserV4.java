 ...
 * address. - User want to update email address of which have not been verified, { oldEmailAddress,
 * emailAddress} response field will be filled with new email address. - User want to update email
 * address of which have been verified and updated before, { oldEmailAddress, emailAddress} response
