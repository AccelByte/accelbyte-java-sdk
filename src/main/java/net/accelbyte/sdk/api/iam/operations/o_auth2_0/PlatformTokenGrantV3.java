 ...
 * **google**: The platform_tokenâs value is the authorization code or idToken returned by Google
 * OAuth - **googleplaygames**: The platform_tokenâs value is the authorization code or idToken
 * returned by Google play games OAuth - **oculus**: The platform_tokenâs value is a string
 * composed of Oculus's user ID and the nonce separated by a colon (:). - **twitch**: The
 ...
 * **apple**: The platform_tokenâs value is the authorization code or idToken returned by Apple
 * OAuth.(We will use this code to generate APP token) - **device**: Every device that doesânt run
 * Android and iOS is categorized as a device. The device_id is the deviceâs ID. - **justice**:
 * The platform_tokenâs value is the designated userâs access token. - **epicgames**: The
 * platform_tokenâs value is an access-token or authorization code obtained from Epicgames EOS
 ...
 * OAuth. - **nintendo**: The platform_tokenâs value is the id_token returned by Nintendo OAuth. -
...
public class PlatformTokenGrantV3 extends Operation {
  ...
  public Map<String, Object> getFormParams() {
    ...
    if (this.serviceLabel != null) {
      formDataParams.put(
          "serviceLabel", this.serviceLabel == null ? null : String.valueOf(this.serviceLabel));
    }
