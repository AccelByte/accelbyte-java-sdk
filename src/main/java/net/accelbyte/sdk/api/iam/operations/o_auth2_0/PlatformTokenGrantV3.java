 ...
 *
 * <p>* steam : The platform_tokenâs value is the binary ticket returned by Steam. If this ticket
 * was generated by Steam GetAuthTicketForWebApi with version >= 1.57, then platform token should
 * use this style: `{identity}:{ticket}`,
 *
 * <p>the `{identity}` was the parameter to call GetAuthTicketForWebApi when the ticket was created.
 * Note: Do not contain `:` in this `{identity}`.
 *
