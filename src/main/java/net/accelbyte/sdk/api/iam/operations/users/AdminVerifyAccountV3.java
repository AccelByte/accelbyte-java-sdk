...
public class AdminVerifyAccountV3 extends Operation {
     ...
     */
    private String url = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/code/verify";
    ...
    */
    ...
    public AdminVerifyAccountV3 createFromJson(String json) throws JsonProcessingException {
