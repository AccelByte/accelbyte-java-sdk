 ...
 *
 * <p>This endpoint will REPLACE user's permissions with the ones defined in body
 *
...
@Getter
@Setter
public class AdminUpdateUserPermissionV3 extends Operation {
  ...
  public AdminUpdateUserPermissionV3(
      String namespace, String userId, AccountcommonPermissions body) {
