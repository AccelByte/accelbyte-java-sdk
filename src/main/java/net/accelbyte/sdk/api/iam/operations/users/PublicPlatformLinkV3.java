 ...
 *
 * <p>* steam : The ticketâs value is the binary ticket returned by Steam.
 *
 ...
 *
 * <p>* ps4 : The ticketâs value is the authorization code returned by PSN OAuth.
 *
 * <p>* ps5 : The ticketâs value is the authorization code returned by PSN OAuth.
 *
 * <p>* xblweb : The ticketâs value is the authorization code returned by XBox Live OAuth.
 *
 * <p>* live : The ticketâs value is the XSTS token.
 *
 * <p>* awscognito : The ticketâs value is the aws cognito access token (JWT).
 *
 * <p>* epicgames : The ticketâs value is an access-token or authorization code obtained from
 * Epicgames EOS Account Service.
 *
 * <p>* nintendo : The ticketâs value is the id_token returned by Nintendo OAuth.
 *
 * <p>* netflix : The ticketâs value is GAT (Gamer Access Token) returned by Netflix backend.
 *
 * <p>* snapchat : The ticketâs value is authorization code returned by Snapchat OAuth.
 *
