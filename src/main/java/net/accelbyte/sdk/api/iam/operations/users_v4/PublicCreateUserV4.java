 ...
 *
 * <p>Required attributes: - authType: possible value is EMAILPASSWD - emailAddress: 5 to 254
 * characters - username: 3 to 48 characters, case insensitive, alphanumeric with allowed symbols
 * underscore (_) and dot (.) - password: 8 to 32 characters, satisfy at least 3 out of 4
 * conditions(uppercase, lowercase letters, numbers and special characters) and should not have more
 * than 2 equal characters in a row. - country: ISO3166-1 alpha-2 two letter, e.g. US. -
