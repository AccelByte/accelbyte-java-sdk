...
public class GetListCountryAgeRestriction extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/iam/v2/admin/namespaces/{namespace}/countries/agerestrictions";
    ...
    */
    ...
    @JsonIgnore
    public GetListCountryAgeRestriction createFromJson(String json) throws JsonProcessingException {
