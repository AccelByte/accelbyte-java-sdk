...
import net.accelbyte.sdk.api.iam.models.ModelPermissionDeleteRequest;
...
public class AdminDeleteUserPermissionBulkV3 extends Operation {
    /**
    ...
    private List<ModelPermissionDeleteRequest> body;
    ...
    */
    ...
    @Override
    @JsonIgnore
    public List<ModelPermissionDeleteRequest> getBodyParams(){
        return this.body;
    }
