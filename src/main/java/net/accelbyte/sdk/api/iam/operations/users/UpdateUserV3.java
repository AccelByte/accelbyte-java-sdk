 ...
 * <p>Important notes:
 *
 * <p>This endpoint provides support for client that doesn't have PATCH support, i.e. UE4 before
 * v4.23 released.
 *
 * <p>If the client support PATCH method, use [PATCH] /iam/v3/public/namespaces/{namespace}/users/me
 * instead
 *
 * <p>action code : 10103
 */
