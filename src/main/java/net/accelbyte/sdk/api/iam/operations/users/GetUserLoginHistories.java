...
public class GetUserLoginHistories extends Operation {
  ...
  private String path = "/iam/namespaces/{namespace}/users/{userId}/logins/histories";
  ...
  public ModelLoginHistoriesResponse parseResponse(int code, String contentTpe, InputStream payload)
