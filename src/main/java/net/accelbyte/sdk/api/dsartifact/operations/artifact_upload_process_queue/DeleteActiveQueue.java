 ...
 * deleteActiveQueue
 *
 * <p>``` Required permission: ADMIN:DSAM:ARTIFACT:QUEUE [DELETE]
 *
 * <p>This endpoint is used to delete active queue process on a node ```
 */
@Getter
@Setter
public class DeleteActiveQueue extends Operation {
  ...
  @Deprecated
  public DeleteActiveQueue(String nodeIP) {
    this.nodeIP = nodeIP;
