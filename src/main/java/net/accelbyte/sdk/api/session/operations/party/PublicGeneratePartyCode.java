 ...
 *
 * <p>Generate a new code for the party. Only leader can generate a code.
 */
@Getter
@Setter
public class PublicGeneratePartyCode extends Operation {
  ...
  @Deprecated
  public PublicGeneratePartyCode(String namespace, String partyId) {
