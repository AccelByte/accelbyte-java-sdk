 ...
 * publicPartyJoin
 *
 * <p>Join a party. The user can either join a party they have been invited to, or any party with an
 * "open" joinable setting.
 */
@Getter
@Setter
public class PublicPartyJoin extends Operation {
  ...
  @Deprecated
  public PublicPartyJoin(String namespace, String partyId) {
