...
public class ApimodelsCreateConfigurationTemplateRequest extends Model {
  ...
  public static class ApimodelsCreateConfigurationTemplateRequestBuilder {
    ...
    public ApimodelsCreateConfigurationTemplateRequestBuilder joinability(
        final String joinability) {
      this.joinability = joinability;
      return this;
    }

    public ApimodelsCreateConfigurationTemplateRequestBuilder joinabilityFromEnum(
    ...
    public ApimodelsCreateConfigurationTemplateRequestBuilder type(final String type) {
      this.type = type;
      return this;
    }

    public ApimodelsCreateConfigurationTemplateRequestBuilder typeFromEnum(final Type type) {
      this.type = type.toString();
      return this;
    }
  }
