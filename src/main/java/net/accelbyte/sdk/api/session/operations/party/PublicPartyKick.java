 ...
 * publicPartyKick
 *
 * <p>Kick a player from a party. Requires invoker to be the party leader.
 */
@Getter
@Setter
public class PublicPartyKick extends Operation {
  ...
  public ApimodelsKickResponse parseResponse(int code, String contentType, InputStream payload)
