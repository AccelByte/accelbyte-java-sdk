 ...
 * /session/v1/public/namespaces/{namespace}/gamesessions/{sessionId} - ttlHours is how long the
 * session will active, only non persistent can use this, max value is 168 hours To update DS
 * attributes (clientVersion, deployment, requestedRegions) it will only be applied only as long as
 * no DS has been requested, otherwise ignored.
 */
@Getter
@Setter
