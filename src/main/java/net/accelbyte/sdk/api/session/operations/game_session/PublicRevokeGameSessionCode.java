 ...
 *
 * <p>Revoke code of the game session. Only leader can revoke a code.
 */
@Getter
@Setter
public class PublicRevokeGameSessionCode extends Operation {
  ...
  @Deprecated
  public PublicRevokeGameSessionCode(String namespace, String sessionId) {
