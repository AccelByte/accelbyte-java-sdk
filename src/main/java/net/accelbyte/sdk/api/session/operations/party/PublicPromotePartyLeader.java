 ...
 *
 * <p>Promotes a party member to be a party leader. Only leader can promote a new leader.
 */
@Getter
@Setter
public class PublicPromotePartyLeader extends Operation {
  /** generated field's value */
  private String path = "/session/v1/public/namespaces/{namespace}/parties/{partyId}/leader";
  ...
  public PublicPromotePartyLeader(
      String namespace, String partyId, ApimodelsPromoteLeaderRequest body) {
