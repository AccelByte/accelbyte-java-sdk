...
public class ApimodelsPlayerAttributesResponseBody extends Model {
  ...
  @JsonIgnore
  public ApimodelsPlayerAttributesResponseBody createFromJson(String json)
      throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<ApimodelsPlayerAttributesResponseBody> createFromJsonList(String json)
      throws JsonProcessingException {
