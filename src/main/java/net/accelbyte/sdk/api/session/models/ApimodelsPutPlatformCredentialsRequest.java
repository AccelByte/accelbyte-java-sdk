...
public class ApimodelsPutPlatformCredentialsRequest extends Model {
  ...
  @JsonIgnore
  public List<ApimodelsPutPlatformCredentialsRequest> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<ApimodelsPutPlatformCredentialsRequest>>() {});
  }
}
