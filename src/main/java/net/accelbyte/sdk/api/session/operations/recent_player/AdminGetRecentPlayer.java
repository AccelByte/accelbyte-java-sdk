...
@Getter
@Setter
public class AdminGetRecentPlayer extends Operation {
  /** generated field's value */
  private String path = "/session/v1/admin/namespaces/{namespace}/recent-player";
  ...
  @Deprecated
  public AdminGetRecentPlayer(String namespace, Integer limit, String userId) {
