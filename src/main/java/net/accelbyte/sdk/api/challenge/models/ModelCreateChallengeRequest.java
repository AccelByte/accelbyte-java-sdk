...
public class ModelCreateChallengeRequest extends Model {
    ...
    @JsonIgnore
    public List<ModelCreateChallengeRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelCreateChallengeRequest>>() {});
    }
    ...
    public static class ModelCreateChallengeRequestBuilder {
        ...
        public ModelCreateChallengeRequestBuilder assignmentRuleFromEnum(final AssignmentRule assignmentRule) {
            this.assignmentRule = assignmentRule.toString();
            return this;
        }
        ...
        public ModelCreateChallengeRequestBuilder goalsVisibilityFromEnum(final GoalsVisibility goalsVisibility) {
            this.goalsVisibility = goalsVisibility.toString();
            return this;
        }
