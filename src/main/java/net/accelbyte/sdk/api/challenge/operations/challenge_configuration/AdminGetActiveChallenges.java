...
@Getter
@Setter
public class AdminGetActiveChallenges extends Operation {
  /** generated field's value */
  private String path = "/challenge/v1/admin/namespaces/{namespace}/challenges/users/{userId}";
  ...
  @Deprecated
  public AdminGetActiveChallenges(String namespace, String userId, Integer limit, Integer offset) {
