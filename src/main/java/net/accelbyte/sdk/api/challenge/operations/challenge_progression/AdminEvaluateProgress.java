 ...
 *
 * <p>* Required permission: ADMIN:NAMESPACE:{namespace}:CHALLENGE:PROGRESSION [UPDATE]
 */
@Getter
@Setter
public class AdminEvaluateProgress extends Operation {
  ...
  @Deprecated
  public AdminEvaluateProgress(String namespace, ModelEvaluatePlayerProgressionRequest body) {
