...
public class PublicGetScheduledGoals extends Operation {
     ...
     */
    private String path = "/challenge/v1/public/namespaces/{namespace}/challenges/{challengeCode}/goals";
    ...
    */
    ...
    public List<ModelGoalResponse> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
