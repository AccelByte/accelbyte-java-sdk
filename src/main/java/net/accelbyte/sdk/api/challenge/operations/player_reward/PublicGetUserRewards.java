...
public class PublicGetUserRewards extends Operation {
  ...
  private String path = "/challenge/v1/public/namespaces/{namespace}/users/me/rewards";
  ...
  public ModelListUserRewardsResponse parseResponse(
  ...
  public static class PublicGetUserRewardsBuilder {
    ...
    public PublicGetUserRewardsBuilder statusFromEnum(final Status status) {
