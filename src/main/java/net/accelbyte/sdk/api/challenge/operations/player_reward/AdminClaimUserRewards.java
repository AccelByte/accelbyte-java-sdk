...
@Getter
@Setter
public class AdminClaimUserRewards extends Operation {
  /** generated field's value */
  private String path = "/challenge/v1/admin/namespaces/{namespace}/users/{userId}/rewards/claim";
  ...
  private ModelClaimUserRewardsReq body;
  ...
  @Deprecated
  public AdminClaimUserRewards(String namespace, String userId, ModelClaimUserRewardsReq body) {
  ...
  @Override
  public ModelClaimUserRewardsReq getBodyParams() {
    return this.body;
  }
