 ...
 *
 * <p>- Required permission: ADMIN:NAMESPACE:{namespace}:CHALLENGE [CREATE] Challenge is a
 * collection of goals that can be completed by players. Challenge can have rules that specify what
 * and when goals will be available for players to be taken. #### Request body: - code: only
 * lowercase letters, numbers, and the separator - are allowed; must start and end with letter -
 * name: name of the challenge - description: text describing about the challenge (optional) -
