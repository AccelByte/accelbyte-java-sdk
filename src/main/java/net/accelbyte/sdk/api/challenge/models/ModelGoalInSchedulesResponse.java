...
public class ModelGoalInSchedulesResponse extends Model {
  ...
  @JsonIgnore
  public ModelGoalInSchedulesResponse createFromJson(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<ModelGoalInSchedulesResponse> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<ModelGoalInSchedulesResponse>>() {});
  }
}
