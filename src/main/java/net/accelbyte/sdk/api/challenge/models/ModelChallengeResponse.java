...
public class ModelChallengeResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelChallengeResponse> createFromJsonList(String json) throws JsonProcessingException {
    ...
    public static class ModelChallengeResponseBuilder {
        ...
        public ModelChallengeResponseBuilder assignmentRuleFromEnum(final AssignmentRule assignmentRule) {
            this.assignmentRule = assignmentRule.toString();
            return this;
        }
        ...
        public ModelChallengeResponseBuilder goalsVisibilityFromEnum(final GoalsVisibility goalsVisibility) {
            this.goalsVisibility = goalsVisibility.toString();
            return this;
        }
