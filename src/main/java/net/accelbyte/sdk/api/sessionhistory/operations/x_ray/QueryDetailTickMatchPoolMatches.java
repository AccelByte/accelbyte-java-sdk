...
public class QueryDetailTickMatchPoolMatches extends Operation {
     ...
     */
    private String path = "/sessionhistory/v2/admin/namespaces/{namespace}/xray/match-pools/{poolName}/pods/{podName}/ticks/{tickId}/matches";
    ...
    */
    ...
    public ApimodelsXRayMatchPoolPodTickMatchResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
