...
public class GetGameSessionDetail extends Operation {
  ...
  @Deprecated
  public GetGameSessionDetail(String namespace, String sessionId) {
  ...
  public ApimodelsGameSessionDetail parseResponse(int code, String contentType, InputStream payload)
