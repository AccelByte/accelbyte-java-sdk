 ...
 *
 * <p>Query match length duration avg. time in seconds
 */
@Getter
@Setter
public class QueryMatchLengthDurationpAvg extends Operation {
  /** generated field's value */
  private String path =
      "/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/match-length-duration-avg";
  ...
  public ApimodelsXRayMatchLengthDurationQueryResponse parseResponse(
