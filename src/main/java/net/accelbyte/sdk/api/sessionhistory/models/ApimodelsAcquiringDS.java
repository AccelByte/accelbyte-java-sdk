...
public class ApimodelsAcquiringDS extends Model {
  ...
  @JsonIgnore
  public List<ApimodelsAcquiringDS> createFromJsonList(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsAcquiringDS>>() {});
  }
}
