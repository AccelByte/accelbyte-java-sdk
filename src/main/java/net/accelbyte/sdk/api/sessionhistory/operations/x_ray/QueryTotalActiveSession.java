...
public class QueryTotalActiveSession extends Operation {
     ...
     */
    private String path = "/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/total-active-session";
    ...
    */
    ...
    public ApimodelsXRayTotalActiveSessionQueryResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
