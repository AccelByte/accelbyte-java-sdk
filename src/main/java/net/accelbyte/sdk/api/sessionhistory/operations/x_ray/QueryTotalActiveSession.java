 ...
 *
 * <p>Query total active session.
 */
@Getter
@Setter
public class QueryTotalActiveSession extends Operation {
  /** generated field's value */
  private String path =
      "/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/total-active-session";
  ...
  public QueryTotalActiveSession(
      String namespace, List<String> matchPool, String region, String endDate, String startDate) {
  ...
  public ApimodelsXRayTotalActiveSessionQueryResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApimodelsXRayTotalActiveSessionQueryResponse().createFromJson(json);
  }
