...
public class ModelsSessionConfiguration extends Model {
    ...
    @JsonIgnore
    public List<ModelsSessionConfiguration> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsSessionConfiguration>>() {});
    }
