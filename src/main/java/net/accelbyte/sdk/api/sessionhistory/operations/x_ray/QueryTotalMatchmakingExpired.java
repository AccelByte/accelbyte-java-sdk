...
@Getter
@Setter
public class QueryTotalMatchmakingExpired extends Operation {
    /**
     * generated field's value
     */
    private String path = "/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/total-ticket-expired";
    ...
    */
    ...
    public ApimodelsXRayExpiredMatchmakingTicketQueryResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
            throw new HttpResponseException(code, json);    
        }
        final String json = Helper.convertInputStreamToString(payload);
        return new ApimodelsXRayExpiredMatchmakingTicketQueryResponse().createFromJson(json);
    }
