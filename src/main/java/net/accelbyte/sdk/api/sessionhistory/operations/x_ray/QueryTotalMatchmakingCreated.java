...
public class QueryTotalMatchmakingCreated extends Operation {
     ...
     */
    private String path = "/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/total-ticket-created";
    ...
    */
    ...
    public ApimodelsXRayCreatedMatchmakingTicketQueryResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
