 ...
 *
 * <p>Update Runtime Environment Variable Configuration.
 */
@Getter
@Setter
public class AdminPatchUpdateEnvConfig extends Operation {
  ...
  private EnvconfigConfiguration body;
  ...
  @Deprecated
  public AdminPatchUpdateEnvConfig(EnvconfigConfiguration body) {
    this.body = body;
  ...
  @Override
  public EnvconfigConfiguration getBodyParams() {
    return this.body;
  }
