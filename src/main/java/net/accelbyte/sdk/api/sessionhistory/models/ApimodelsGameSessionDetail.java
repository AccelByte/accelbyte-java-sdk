...
public class ApimodelsGameSessionDetail extends Model {
    ...
    @JsonIgnore
    public List<ApimodelsGameSessionDetail> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsGameSessionDetail>>() {});
    }
