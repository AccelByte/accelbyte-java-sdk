 ...
 * queryAcquiringDS
 *
 * <p>Query total success and failed claim DS.
 */
@Getter
@Setter
public class QueryAcquiringDS extends Operation {
  ...
  @Deprecated
  public QueryAcquiringDS(String namespace, String endDate, String startDate) {
  ...
  public ApimodelsXRayAcquiringDsQueryResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApimodelsXRayAcquiringDsQueryResponse().createFromJson(json);
  }
