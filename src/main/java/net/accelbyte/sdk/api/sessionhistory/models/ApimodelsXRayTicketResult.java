...
public class ApimodelsXRayTicketResult extends Model {
    ...
    @JsonIgnore
    public List<ApimodelsXRayTicketResult> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsXRayTicketResult>>() {});
    }
