...
public class QueryTotalMatchmakingMatchTicket extends Operation {
    ...
    */
    ...
    public ApimodelsXRayMatchMatchmakingTicketQueryResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
