...
public class QueryTotalMatchmakingMatchTicket extends Operation {
  ...
  private String path =
      "/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/total-ticket-match";
  ...
  public ApimodelsXRayMatchMatchmakingTicketQueryResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ApimodelsXRayMatchMatchmakingTicketQueryResponse().createFromJson(json);
  }
