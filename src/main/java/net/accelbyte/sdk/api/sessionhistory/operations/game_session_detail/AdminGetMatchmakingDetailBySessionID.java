...
@Getter
@Setter
public class AdminGetMatchmakingDetailBySessionID extends Operation {
    /**
     * generated field's value
     */
    private String path = "/sessionhistory/v1/admin/namespaces/{namespace}/matchmaking/session/{sessionId}";
    ...
    */
    ...
    public ApimodelsMatchmakingDetail parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
