 ...
 *
 * <p>Get detail matchmaking history by session ID.
 */
@Getter
@Setter
public class AdminGetMatchmakingDetailBySessionID extends Operation {
  ...
  private String path =
      "/sessionhistory/v1/admin/namespaces/{namespace}/matchmaking/session/{sessionId}";
  ...
  @Deprecated
  public AdminGetMatchmakingDetailBySessionID(String namespace, String sessionId) {
