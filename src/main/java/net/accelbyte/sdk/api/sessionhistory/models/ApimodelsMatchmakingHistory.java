...
public class ApimodelsMatchmakingHistory extends Model {
    ...
    @JsonIgnore
    public List<ApimodelsMatchmakingHistory> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsMatchmakingHistory>>() {});
    }
