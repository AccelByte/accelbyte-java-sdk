...
public class QueryAcquiringDSWaitTimeAvg extends Operation {
     ...
     */
    private String path = "/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/acquiring-ds-wait-time-avg";
    ...
    */
    ...
    public ApimodelsXRayAcquiringDsWaitTimeQueryResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
