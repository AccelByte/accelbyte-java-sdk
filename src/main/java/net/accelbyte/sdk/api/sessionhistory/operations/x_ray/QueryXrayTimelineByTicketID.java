...
@Getter
@Setter
public class QueryXrayTimelineByTicketID extends Operation {
    /**
     * generated field's value
     */
    private String path = "/sessionhistory/v2/admin/namespaces/{namespace}/xray/tickets/{ticketId}";
    ...
    */
    ...
    public ApimodelsXRayTicketQueryResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
