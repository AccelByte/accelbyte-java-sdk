...
public class ApimodelsEventMatchHistory extends Model {
    ...
    @JsonIgnore
    public List<ApimodelsEventMatchHistory> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsEventMatchHistory>>() {});
    }
