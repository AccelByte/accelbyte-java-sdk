 ...
 *
 * <p>Update group custom rule. This endpoint will check the group ID of the user based on the
...
public class UpdateGroupCustomRulePublicV1 extends Operation {
  ...
  private String path = "/group/v1/public/namespaces/{namespace}/groups/{groupId}/rules/custom";
