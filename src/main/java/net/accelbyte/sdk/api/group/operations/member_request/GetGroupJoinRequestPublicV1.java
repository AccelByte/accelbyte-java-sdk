...
public class GetGroupJoinRequestPublicV1 extends Operation {
     ...
     */
    private String url = "/group/v1/public/namespaces/{namespace}/groups/{groupId}/join/request";
    ...
    */
    ...
    public GetGroupJoinRequestPublicV1 createFromJson(String json) throws JsonProcessingException {
    ...
    public ModelsGetMemberRequestsListResponseV1 parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
