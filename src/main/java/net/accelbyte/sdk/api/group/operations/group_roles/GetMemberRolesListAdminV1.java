...
public class GetMemberRolesListAdminV1 extends Operation {
    /**
    ...
    */
    ...
    @JsonIgnore
    public GetMemberRolesListAdminV1 createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public ModelsGetMemberRolesListResponseV1 parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
