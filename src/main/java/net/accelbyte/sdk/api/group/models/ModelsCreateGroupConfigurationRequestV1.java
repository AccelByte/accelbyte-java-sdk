...
public class ModelsCreateGroupConfigurationRequestV1 extends Model {
    ...
    @JsonIgnore
    public ModelsCreateGroupConfigurationRequestV1 createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ModelsCreateGroupConfigurationRequestV1> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsCreateGroupConfigurationRequestV1>>() {});
    }
