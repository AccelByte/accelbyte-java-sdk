...
public class AdminUnlockAchievement extends Operation {
     ...
     */
    private String url = "/achievement/v1/admin/namespaces/{namespace}/users/{userId}/achievements/{achievementCode}/unlock";
    ...
    */
    ...
    public AdminUnlockAchievement createFromJson(String json) throws JsonProcessingException {
