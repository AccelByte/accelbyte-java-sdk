...
package net.accelbyte.sdk.api.achievement.operations.anonymization;
 ...
 *
 * <p>This API will delete specified user achievement
 *
 * <p>Required permission `ADMIN:NAMESPACE:{namespace}:USER:{userId}:ANONYMIZATION [DELETE]`
 */
@Getter
@Setter
public class AdminAnonymizeUserAchievement extends Operation {
