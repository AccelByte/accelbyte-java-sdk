 ...
 * <p>Note:
 *
 * <p>Global achievement should be unlocked to claim the reward. Only contributor of global
 * achievement are eligible for rewards
 */
@Getter
@Setter
public class ClaimGlobalAchievementReward extends Operation {
  ...
  @Deprecated
  public ClaimGlobalAchievementReward(String achievementCode, String namespace, String userId) {
