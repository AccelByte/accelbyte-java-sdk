...
public class AdminListUserAchievements extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/achievement/v1/admin/namespaces/{namespace}/users/{userId}/achievements";
    ...
    */
    ...
    @JsonIgnore
    public AdminListUserAchievements createFromJson(String json) throws JsonProcessingException {
    ...
    public Map<String, String> getQueryParams(){
        ...
        queryParams.put("preferUnlocked", this.preferUnlocked == null ? null : String.valueOf(this.preferUnlocked));
        return queryParams;
    }
    ...
    public static Map<String, String> getFieldInfo() {
        ...
        result.put("preferUnlocked","preferUnlocked");
        return result;
    }
    ...
    @Override
    @JsonIgnore
    public ModelsPaginatedUserAchievementResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
