...
public class UpdateAliPayConfig extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/payment/config/merchant/{id}/alipayconfig";
    ...
    */
    ...
    @JsonIgnore
    public UpdateAliPayConfig createFromJson(String json) throws JsonProcessingException {
