 ...
 *
 * <p>Query IAP order ine items. Other detail info:
 *
 * <p>* Returns : paginated iap orders
 */
@Getter
@Setter
public class AdminGetIAPOrderLineItems extends Operation {
  ...
  @Deprecated
  public AdminGetIAPOrderLineItems(String iapOrderNo, String namespace, String userId) {
  ...
  public List<IAPOrderLineItemInfo> parseResponse(int code, String contentType, InputStream payload)
