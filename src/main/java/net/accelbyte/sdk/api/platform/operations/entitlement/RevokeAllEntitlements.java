...
@Getter
@Setter
public class RevokeAllEntitlements extends Operation {
  /** generated field's value */
  private String path = "/platform/admin/namespaces/{namespace}/users/{userId}/entitlements/revoke";
  ...
  @Deprecated
  public RevokeAllEntitlements(String namespace, String userId) {
