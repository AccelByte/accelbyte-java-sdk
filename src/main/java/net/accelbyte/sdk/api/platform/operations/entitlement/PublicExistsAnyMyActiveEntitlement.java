...
public class PublicExistsAnyMyActiveEntitlement extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/public/namespaces/{namespace}/users/me/entitlements/ownership/any";
    ...
    */
    ...
    @JsonIgnore
    public PublicExistsAnyMyActiveEntitlement createFromJson(String json) throws JsonProcessingException {
