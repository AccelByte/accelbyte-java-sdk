...
@Getter
@Setter
public class ExportStoreByCSV extends Operation {
  ...
  private ExportStoreToCSVRequest body;
  ...
  @Deprecated
  public ExportStoreByCSV(String namespace, ExportStoreToCSVRequest body) {
  ...
  @Override
  public ExportStoreToCSVRequest getBodyParams() {
    return this.body;
  }
