...
public class GetFulfillmentScript extends Operation {
    ...
    */
    ...
    public GetFulfillmentScript createFromJson(String json) throws JsonProcessingException {
    ...
    public FulfillmentScriptInfo parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
