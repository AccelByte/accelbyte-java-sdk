...
public class PublicGetUserAppEntitlementOwnershipByAppId extends Operation {
     ...
     */
    private String url = "/platform/public/namespaces/{namespace}/users/{userId}/entitlements/ownership/byAppId";
    ...
    */
    ...
    public PublicGetUserAppEntitlementOwnershipByAppId createFromJson(String json) throws JsonProcessingException {
