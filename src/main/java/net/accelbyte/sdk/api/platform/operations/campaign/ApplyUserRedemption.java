...
public class ApplyUserRedemption extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/users/{userId}/redemption";
    ...
    */
    ...
    @JsonIgnore
    public ApplyUserRedemption createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public RedeemResult parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
