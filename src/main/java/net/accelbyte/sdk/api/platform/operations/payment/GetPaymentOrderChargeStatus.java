...
public class GetPaymentOrderChargeStatus extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/payment/orders/{paymentOrderNo}/status";
    ...
    */
    ...
    public PaymentOrderChargeStatus parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
