...
public class RollbackPublishedStore extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/stores/published/rollback";
    ...
    */
    ...
    @JsonIgnore
    public RollbackPublishedStore createFromJson(String json) throws JsonProcessingException {
