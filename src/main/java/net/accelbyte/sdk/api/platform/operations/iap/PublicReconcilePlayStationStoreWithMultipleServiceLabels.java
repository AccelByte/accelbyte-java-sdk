 ...
 *
 * <p>Synchronize with entitlements in PSN Store with multiple service labels.Other detail info: *
 * Returns : result of synchronization
 */
@Getter
@Setter
public class PublicReconcilePlayStationStoreWithMultipleServiceLabels extends Operation {
  ...
  private PlayStationMultiServiceLabelsReconcileRequest body;
  ...
  @Override
  public PlayStationMultiServiceLabelsReconcileRequest getBodyParams() {
    return this.body;
  }
