...
public class PaymentOrderSyncResult extends Model {
    ...
    @JsonIgnore
    public List<PaymentOrderSyncResult> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<PaymentOrderSyncResult>>() {});
    }
