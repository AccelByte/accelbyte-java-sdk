...
public class GetPlatformDLCConfig extends Operation {
    /**
    ...
    */
    ...
    @JsonIgnore
    public GetPlatformDLCConfig createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public PlatformDLCConfigInfo parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
