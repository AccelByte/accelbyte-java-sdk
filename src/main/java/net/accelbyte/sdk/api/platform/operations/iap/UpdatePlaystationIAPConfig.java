 ...
 *
 * <p>Update playstation iap config. Other detail info: * Returns : updated playstation iap config
 */
@Getter
@Setter
public class UpdatePlaystationIAPConfig extends Operation {
  ...
  @Deprecated
  public UpdatePlaystationIAPConfig(String namespace, PlaystationIAPConfigRequest body) {
  ...
  public PlayStationIAPConfigInfo parseResponse(int code, String contentType, InputStream payload)
