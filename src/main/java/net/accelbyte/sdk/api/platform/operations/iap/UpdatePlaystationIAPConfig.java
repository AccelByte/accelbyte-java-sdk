...
public class UpdatePlaystationIAPConfig extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/iap/config/playstation";
    ...
    */
    ...
    @Override
    @JsonIgnore
    public PlayStationIAPConfigInfo parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
