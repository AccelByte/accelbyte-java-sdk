...
@Getter
@Setter
public class QueryUserCurrencyWallets extends Operation {
    /**
     * generated field's value
     */
    private String path = "/platform/admin/namespaces/{namespace}/users/{userId}/wallets/currencies/summary";
    ...
    */
    ...
    public List<CurrencyWallet> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
