 ...
 *
 * <p>This API is used to get root categories.
 *
 * <p>Other detail info:
 *
 ...
 * with this permission can view draft store category) * Returns : root category data
 */
@Getter
@Setter
public class PublicGetRootCategories extends Operation {
  /** generated field's value */
  private String path = "/platform/public/namespaces/{namespace}/categories";
   ...
   */
  @Builder
  public PublicGetRootCategories(String namespace, String language, String storeId) {
  ...
  public List<CategoryInfo> parseResponse(int code, String contentTpe, InputStream payload)
