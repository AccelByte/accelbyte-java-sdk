...
import net.accelbyte.sdk.api.platform.models.IAPItemConfigUpdate;
...
public class UpdateIAPItemConfig extends Operation {
     ...
     */
    private String url = "/platform/admin/namespaces/{namespace}/iap/config/item";
    ...
    */
    ...
    public UpdateIAPItemConfig createFromJson(String json) throws JsonProcessingException {
