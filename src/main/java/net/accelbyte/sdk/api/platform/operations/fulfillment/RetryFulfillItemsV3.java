 ...
 * the original payload. Other detail info: * Returns : fulfillment v2 result, storeId field can be
 * ignored.
 */
@Getter
@Setter
public class RetryFulfillItemsV3 extends Operation {
  ...
  @Deprecated
  public RetryFulfillItemsV3(String namespace, String transactionId, String userId) {
