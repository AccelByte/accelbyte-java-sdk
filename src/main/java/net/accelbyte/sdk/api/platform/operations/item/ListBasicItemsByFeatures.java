...
public class ListBasicItemsByFeatures extends Operation {
    ...
    */
    ...
    public Map<String, String> getQueryParams(){
        ...
        queryParams.put("features", this.features == null ? null : String.valueOf(this.features));
        return queryParams;
    }
    ...
    @Override
    @JsonIgnore
    public List<BasicItem> parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
