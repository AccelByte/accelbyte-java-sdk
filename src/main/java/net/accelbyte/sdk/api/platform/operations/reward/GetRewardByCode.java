...
public class GetRewardByCode extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/public/namespaces/{namespace}/rewards/byCode";
    ...
    */
    ...
    public GetRewardByCode createFromJson(String json) throws JsonProcessingException {
    ...
    public Map<String, String> getQueryParams(){
        ...
        queryParams.put("rewardCode", this.rewardCode);
        return queryParams;
    }
