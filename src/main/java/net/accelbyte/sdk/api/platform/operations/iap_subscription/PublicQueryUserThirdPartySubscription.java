...
@Getter
@Setter
public class PublicQueryUserThirdPartySubscription extends Operation {
  ...
  public static class PublicQueryUserThirdPartySubscriptionBuilder {
    private String platform;

    public PublicQueryUserThirdPartySubscriptionBuilder platform(final String platform) {
      this.platform = platform;
      return this;
    }

    public PublicQueryUserThirdPartySubscriptionBuilder platformFromEnum(final Platform platform) {
