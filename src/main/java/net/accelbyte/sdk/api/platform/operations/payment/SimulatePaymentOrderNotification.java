...
public class SimulatePaymentOrderNotification extends Operation {
    ...
    */
    ...
    @JsonIgnore
    public SimulatePaymentOrderNotification createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public NotificationProcessResult parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
