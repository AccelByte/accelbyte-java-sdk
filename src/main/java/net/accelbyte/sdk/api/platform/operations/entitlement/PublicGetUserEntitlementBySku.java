...
public class PublicGetUserEntitlementBySku extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/public/namespaces/{namespace}/users/{userId}/entitlements/bySku";
    ...
    */
    ...
    @JsonIgnore
    public PublicGetUserEntitlementBySku createFromJson(String json) throws JsonProcessingException {
