...
public class UpdateGoogleIAPConfig extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/iap/config/google";
    ...
    */
    ...
    @Override
    @JsonIgnore
    public GoogleIAPConfigInfo parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
