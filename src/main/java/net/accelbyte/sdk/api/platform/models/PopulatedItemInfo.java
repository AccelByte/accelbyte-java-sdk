...
public class PopulatedItemInfo extends Model {
  ...
  public static class PopulatedItemInfoBuilder {
    private String appType;
    private String entitlementType;
    private String itemType;
    private String seasonType;
    ...
    public PopulatedItemInfoBuilder appType(final String appType) {
      this.appType = appType;
      return this;
    }

    public PopulatedItemInfoBuilder appTypeFromEnum(final AppType appType) {
      this.appType = appType.toString();
      return this;
    }

    public PopulatedItemInfoBuilder entitlementType(final String entitlementType) {
      this.entitlementType = entitlementType;
      return this;
    }

    public PopulatedItemInfoBuilder entitlementTypeFromEnum(final EntitlementType entitlementType) {
      this.entitlementType = entitlementType.toString();
      return this;
    }

    public PopulatedItemInfoBuilder itemType(final String itemType) {
      this.itemType = itemType;
      return this;
    }

    public PopulatedItemInfoBuilder itemTypeFromEnum(final ItemType itemType) {
      this.itemType = itemType.toString();
      return this;
    }

    public PopulatedItemInfoBuilder seasonType(final String seasonType) {
      this.seasonType = seasonType;
      return this;
    }

    public PopulatedItemInfoBuilder seasonTypeFromEnum(final SeasonType seasonType) {
      this.seasonType = seasonType.toString();
      return this;
    }

    public PopulatedItemInfoBuilder status(final String status) {
      this.status = status;
      return this;
    }

    public PopulatedItemInfoBuilder statusFromEnum(final Status status) {
      this.status = status.toString();
      return this;
    }
  }
