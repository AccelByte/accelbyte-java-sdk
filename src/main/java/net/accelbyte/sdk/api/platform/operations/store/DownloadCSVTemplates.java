...
@Getter
@Setter
public class DownloadCSVTemplates extends Operation {
  /** generated field's value */
  private String path = "/platform/admin/namespaces/{namespace}/stores/downloadCSVTemplates";
  ...
  @Deprecated
  public DownloadCSVTemplates(String namespace) {
