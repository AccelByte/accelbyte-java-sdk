...
public class PublicGetUserEntitlementByItemId extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/public/namespaces/{namespace}/users/{userId}/entitlements/byItemId";
    ...
    */
    ...
    @JsonIgnore
    public PublicGetUserEntitlementByItemId createFromJson(String json) throws JsonProcessingException {
