...
public class PublicGetUserEntitlementOwnershipByItemId extends Operation {
  ...
  public static class PublicGetUserEntitlementOwnershipByItemIdBuilder {
    ...
    public PublicGetUserEntitlementOwnershipByItemIdBuilder entitlementClazz(
        final String entitlementClazz) {
      this.entitlementClazz = entitlementClazz;
      return this;
    }

    public PublicGetUserEntitlementOwnershipByItemIdBuilder entitlementClazzFromEnum(
