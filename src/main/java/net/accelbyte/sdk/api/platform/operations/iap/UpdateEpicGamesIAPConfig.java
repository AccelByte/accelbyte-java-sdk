...
import net.accelbyte.sdk.api.platform.models.EpicGamesIAPConfigRequest;
...
public class UpdateEpicGamesIAPConfig extends Operation {
    ...
    */
    ...
    @JsonIgnore
    public UpdateEpicGamesIAPConfig createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public EpicGamesIAPConfigInfo parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
