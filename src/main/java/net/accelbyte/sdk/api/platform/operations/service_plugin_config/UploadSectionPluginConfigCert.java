 ...
 *
 * <p>Upload section plugin custom config tls cert.Other detail info: * Returns : updated service
 * plugin config
 */
@Getter
@Setter
public class UploadSectionPluginConfigCert extends Operation {
  ...
  @Deprecated
  public UploadSectionPluginConfigCert(String namespace, File file) {
