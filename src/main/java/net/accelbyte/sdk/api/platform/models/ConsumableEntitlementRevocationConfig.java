...
public class ConsumableEntitlementRevocationConfig extends Model {
  ...
  @JsonIgnore
  public ConsumableEntitlementRevocationConfig createFromJson(String json)
      throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<ConsumableEntitlementRevocationConfig> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<ConsumableEntitlementRevocationConfig>>() {});
  }
