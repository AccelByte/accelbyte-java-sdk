 ...
 * updateXblIAPConfig
 *
 * <p>Update xbl iap config. Other detail info: * Required permission :
 * resource="ADMIN:NAMESPACE:{namespace}:IAP:CONFIG", action=4 (UPDATE) * Returns : updated xbl iap
 * config
 */
@Getter
@Setter
public class UpdateXblIAPConfig extends Operation {
  ...
  public XblIAPConfigInfo parseResponse(int code, String contentTpe, InputStream payload)
