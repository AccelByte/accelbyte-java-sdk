...
public class UpdateXblIAPConfig extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/iap/config/xbl";
    ...
    */
    ...
    @JsonIgnore
    public UpdateXblIAPConfig createFromJson(String json) throws JsonProcessingException {
