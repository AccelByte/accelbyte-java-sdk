...
import net.accelbyte.sdk.api.platform.models.PaymentUrlCreate;
...
public class PublicGetPaymentUrl extends Operation {
     ...
     */
    private String url = "/platform/public/namespaces/{namespace}/payment/link";
    ...
    */
    ...
    public PaymentUrl parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
