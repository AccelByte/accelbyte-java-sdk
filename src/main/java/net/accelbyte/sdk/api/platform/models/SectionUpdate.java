...
public class SectionUpdate extends Model {
  ...
  @JsonIgnore
  public SectionUpdate createFromJson(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<SectionUpdate> createFromJsonList(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, new TypeReference<List<SectionUpdate>>() {});
  }
  ...
  public static class SectionUpdateBuilder {
    ...
    public SectionUpdateBuilder rotationType(final String rotationType) {
      this.rotationType = rotationType;
      return this;
    }

    public SectionUpdateBuilder rotationTypeFromEnum(final RotationType rotationType) {
      this.rotationType = rotationType.toString();
      return this;
    }
  }
