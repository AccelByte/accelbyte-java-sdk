...
public class RedeemCode extends Operation {
  ...
  private String path = "/platform/admin/namespaces/{namespace}/users/{userId}/fulfillment/code";
  ...
  @Deprecated
  public RedeemCode(String namespace, String userId, FulfillCodeRequest body) {
