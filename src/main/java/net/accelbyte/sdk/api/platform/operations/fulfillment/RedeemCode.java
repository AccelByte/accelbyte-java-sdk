...
public class RedeemCode extends Operation {
    /**
     * generated field's value
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/users/{userId}/fulfillment/code";
    ...
    */
    ...
    @JsonIgnore
    public RedeemCode createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public FulfillmentResult parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
