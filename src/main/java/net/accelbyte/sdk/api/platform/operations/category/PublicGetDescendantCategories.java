...
public class PublicGetDescendantCategories extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/public/namespaces/{namespace}/categories/{categoryPath}/descendants";
    ...
    */
    ...
    @JsonIgnore
    public PublicGetDescendantCategories createFromJson(String json) throws JsonProcessingException {
