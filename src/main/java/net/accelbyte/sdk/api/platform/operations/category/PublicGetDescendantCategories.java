 ...
 *
 * <p>This API is used to get descendant categories by category path.
 *
 * <p>Other detail info:
 *
 ...
 * with this permission can view draft store category) * Returns : list of descendant categories
 * data
 */
@Getter
@Setter
public class PublicGetDescendantCategories extends Operation {
