...
public class GetUserEntitlementOwnershipByItemId extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/users/{userId}/entitlements/ownership/byItemId";
    ...
    */
    ...
    @JsonIgnore
    public GetUserEntitlementOwnershipByItemId createFromJson(String json) throws JsonProcessingException {
