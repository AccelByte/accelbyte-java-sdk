 ...
 * publicListStores
 *
 * <p>This API is used to list all stores in a namespace.
 *
 * <p>Other detail info:
 *
 * <p>* Optional permission : resource="PREVIEW", action=1(CREATE) (user with this permission can
 * view draft store) * Optional permission : resource="SANDBOX", action=1(CREATE) (user with this
 * permission can view draft store) * Returns : the list of stores
 */
@Getter
@Setter
public class PublicListStores extends Operation {
  ...
  @Deprecated
  public PublicListStores(String namespace) {
