...
public class GetUserOrderGrant extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/users/{userId}/orders/{orderNo}/grant";
    ...
    */
    ...
    @JsonIgnore
    public GetUserOrderGrant createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public OrderGrantInfo parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
