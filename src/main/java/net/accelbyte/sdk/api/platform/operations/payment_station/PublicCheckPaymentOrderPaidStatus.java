...
public class PublicCheckPaymentOrderPaidStatus extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/public/namespaces/{namespace}/payment/orders/{paymentOrderNo}/status";
    ...
    */
    ...
    @Override
    public PaymentOrderPaidResult parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
