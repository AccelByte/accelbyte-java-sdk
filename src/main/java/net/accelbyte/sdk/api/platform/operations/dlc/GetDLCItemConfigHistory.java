...
public class GetDLCItemConfigHistory extends Operation {
  ...
  @Deprecated
  public GetDLCItemConfigHistory(String namespace, String dlcId) {
  ...
  public DLCItemConfigHistoryResult parseResponse(int code, String contentType, InputStream payload)
