...
public class RevokeItems extends Operation {
  ...
  private String path =
      "/platform/v2/admin/namespaces/{namespace}/users/{userId}/fulfillments/{transactionId}/revoke";
  ...
  @Deprecated
  public RevokeItems(String namespace, String transactionId, String userId) {
