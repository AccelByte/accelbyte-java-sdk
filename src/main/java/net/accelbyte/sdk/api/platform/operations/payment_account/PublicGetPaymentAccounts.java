 ...
 *
 * <p>Get payment accounts. Other detail info:
 *
...
public class PublicGetPaymentAccounts extends Operation {
  ...
  @Deprecated
  public PublicGetPaymentAccounts(String namespace, String userId) {
  ...
  public List<PaymentAccount> parseResponse(int code, String contentType, InputStream payload)
