...
public class DeletePublishedStore extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/stores/published";
    ...
    */
    ...
    public DeletePublishedStore createFromJson(String json) throws JsonProcessingException {
