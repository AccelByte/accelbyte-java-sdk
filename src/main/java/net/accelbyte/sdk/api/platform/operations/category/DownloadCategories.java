...
public class DownloadCategories extends Operation {
     ...
     */
    private String url = "/platform/public/namespaces/{namespace}/categories/download";
    ...
    */
    ...
    @Override
    public List<HierarchicalCategoryInfo> parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
