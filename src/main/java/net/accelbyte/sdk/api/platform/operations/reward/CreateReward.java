 ...
 *
 * <p>* Returns : created reward data * Acceptable values for rewardItem's identityType are :
 * ITEM_ID or ITEM_SKU
 */
@Getter
@Setter
public class CreateReward extends Operation {
  ...
  private String path = "/platform/admin/namespaces/{namespace}/rewards";
  ...
  @Deprecated
  public CreateReward(String namespace, RewardCreate body) {
