...
public class ListCategoriesBasic extends Operation {
     ...
     */
    private String url = "/platform/admin/namespaces/{namespace}/categories/basic";
    ...
    */
    ...
    public List<BasicCategoryInfo> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
