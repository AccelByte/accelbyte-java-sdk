...
@Getter
@Setter
public class GetAvailablePredicateTypes extends Operation {
  /** generated field's value */
  private String path = "/platform/admin/namespaces/{namespace}/items/predicate/types";
  ...
  @Deprecated
  public GetAvailablePredicateTypes(String namespace) {
