...
public class FulfillmentV2RequestItem extends Model {
  ...
  @JsonIgnore
  public List<FulfillmentV2RequestItem> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<FulfillmentV2RequestItem>>() {});
  }
  ...
  public static class FulfillmentV2RequestItemBuilder {
    ...
    public FulfillmentV2RequestItemBuilder entitlementOriginFromEnum(
