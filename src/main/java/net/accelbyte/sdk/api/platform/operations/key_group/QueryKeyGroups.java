...
public class QueryKeyGroups extends Operation {
    ...
    */
    ...
    @Override
    public KeyGroupPagingSlicedResult parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
