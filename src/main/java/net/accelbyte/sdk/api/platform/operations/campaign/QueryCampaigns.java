...
public class QueryCampaigns extends Operation {
  ...
  @Deprecated
  public QueryCampaigns(String namespace, Integer limit, String name, Integer offset, String tag) {
  ...
  public CampaignPagingSlicedResult parseResponse(int code, String contentType, InputStream payload)
