...
import net.accelbyte.sdk.api.platform.models.CurrencyCreate;
...
public class CreateCurrency extends Operation {
    /**
    ...
    */
    ...
    @Override
    @JsonIgnore
    public CurrencyCreate getBodyParams(){
        return this.body;
    }
