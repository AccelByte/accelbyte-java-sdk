...
@Getter
@Setter
public class SyncXboxInventory extends Operation {
    /**
     * generated field's value
     */
    private String url = "/platform/public/namespaces/{namespace}/users/{userId}/iap/xbl/sync";
    ...
    */
    ...
    @Override
    public List<XblReconcileResult> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
