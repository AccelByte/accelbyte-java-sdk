...
public class QueryFulfillmentHistories extends Operation {
     ...
     */
    private String url = "/platform/admin/namespaces/{namespace}/fulfillment/history";
    ...
    */
    ...
    @Override
    public FulfillmentHistoryPagingSlicedResult parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
