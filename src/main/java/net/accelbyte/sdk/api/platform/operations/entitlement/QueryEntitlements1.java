...
public class QueryEntitlements1 extends Operation {
  ...
  public static class QueryEntitlements1Builder {
    private String appType;
    private String entitlementClazz;
    private String origin;

    public QueryEntitlements1Builder appType(final String appType) {
      this.appType = appType;
      return this;
    }

    public QueryEntitlements1Builder appTypeFromEnum(final AppType appType) {
      this.appType = appType.toString();
      return this;
    }

    public QueryEntitlements1Builder entitlementClazz(final String entitlementClazz) {
      this.entitlementClazz = entitlementClazz;
      return this;
    }

    public QueryEntitlements1Builder entitlementClazzFromEnum(
        final EntitlementClazz entitlementClazz) {
      this.entitlementClazz = entitlementClazz.toString();
      return this;
    }

    public QueryEntitlements1Builder origin(final String origin) {
      this.origin = origin;
      return this;
    }

    public QueryEntitlements1Builder originFromEnum(final Origin origin) {
