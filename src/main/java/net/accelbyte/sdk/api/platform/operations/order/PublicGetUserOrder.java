...
public class PublicGetUserOrder extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/public/namespaces/{namespace}/users/{userId}/orders/{orderNo}";
    ...
    */
    ...
    @JsonIgnore
    public PublicGetUserOrder createFromJson(String json) throws JsonProcessingException {
