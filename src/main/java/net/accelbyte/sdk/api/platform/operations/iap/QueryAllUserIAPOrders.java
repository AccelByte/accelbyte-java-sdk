...
public class QueryAllUserIAPOrders extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/users/{userId}/iap/all";
    ...
    */
    ...
    @JsonIgnore
    public QueryAllUserIAPOrders createFromJson(String json) throws JsonProcessingException {
