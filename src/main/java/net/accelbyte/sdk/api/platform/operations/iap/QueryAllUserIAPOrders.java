...
public class QueryAllUserIAPOrders extends Operation {
   ...
   */
  @Builder
  public QueryAllUserIAPOrders(String namespace, String userId) {
  ...
  public IAPOrderPagingSlicedResult parseResponse(int code, String contentTpe, InputStream payload)
