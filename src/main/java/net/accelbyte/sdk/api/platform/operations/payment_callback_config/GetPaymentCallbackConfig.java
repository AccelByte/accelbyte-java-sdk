 ...
 *
 * <p>Get payment callback configuration. Other detail info:
 *
 * <p>* Required permission : resource="ADMIN:NAMESPACE:{namespace}:PAYMENT:CONFIG", action=2 (READ)
...
public class GetPaymentCallbackConfig extends Operation {
  ...
  @Deprecated
  public GetPaymentCallbackConfig(String namespace) {
  ...
  public PaymentCallbackConfigInfo parseResponse(int code, String contentType, InputStream payload)
