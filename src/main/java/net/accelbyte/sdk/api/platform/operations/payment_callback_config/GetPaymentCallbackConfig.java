...
public class GetPaymentCallbackConfig extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/payment/config/callback";
    ...
    */
    ...
    @JsonIgnore
    public GetPaymentCallbackConfig createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public PaymentCallbackConfigInfo parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
