...
public class GetUserEntitlementByItemId extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byItemId";
    ...
    */
    ...
    public static class GetUserEntitlementByItemIdBuilder {
        ...
        public GetUserEntitlementByItemIdBuilder entitlementClazzFromEnum(final EntitlementClazz entitlementClazz) {
