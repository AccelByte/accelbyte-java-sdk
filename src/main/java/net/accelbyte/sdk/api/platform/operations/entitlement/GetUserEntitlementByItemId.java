...
public class GetUserEntitlementByItemId extends Operation {
     ...
     */
    private String url = "/platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byItemId";
    ...
    */
    ...
    public GetUserEntitlementByItemId createFromJson(String json) throws JsonProcessingException {
