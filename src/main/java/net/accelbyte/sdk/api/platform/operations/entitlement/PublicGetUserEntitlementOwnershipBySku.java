...
public class PublicGetUserEntitlementOwnershipBySku extends Operation {
     ...
     */
    private String url = "/platform/public/namespaces/{namespace}/users/{userId}/entitlements/ownership/bySku";
    ...
    */
    ...
    public PublicGetUserEntitlementOwnershipBySku createFromJson(String json) throws JsonProcessingException {
