...
@Getter
@Setter
public class GetSteamIAPConfig extends Operation {
    /**
    ...
    */
    ...
    public GetSteamIAPConfig createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public SteamIAPConfig parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
