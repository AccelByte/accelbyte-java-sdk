...
@Getter
@Setter
public class PublicSplitUserEntitlement extends Operation {
  ...
  private EntitlementSplitRequest body;
  ...
  public PublicSplitUserEntitlement(
      String entitlementId, String namespace, String userId, EntitlementSplitRequest body) {
  ...
  @Override
  public EntitlementSplitRequest getBodyParams() {
    return this.body;
  }
  ...
  public EntitlementSplitResult parseResponse(int code, String contentType, InputStream payload)
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new EntitlementSplitResult().createFromJson(json);
  }
}
