...
public class CatalogConfigUpdate extends Model {
  ...
  @JsonIgnore
  public CatalogConfigUpdate createFromJson(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<CatalogConfigUpdate> createFromJsonList(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, new TypeReference<List<CatalogConfigUpdate>>() {});
  }
  ...
  public static class CatalogConfigUpdateBuilder {
    ...
    public CatalogConfigUpdateBuilder itemDeletionCheckConfig(
        final List<String> itemDeletionCheckConfig) {
      this.itemDeletionCheckConfig = itemDeletionCheckConfig;
      return this;
    }

    public CatalogConfigUpdateBuilder itemDeletionCheckConfigFromEnum(
        final List<ItemDeletionCheckConfig> itemDeletionCheckConfig) {
      ArrayList<String> en = new ArrayList<String>();
      for (ItemDeletionCheckConfig e : itemDeletionCheckConfig) en.add(e.toString());
      this.itemDeletionCheckConfig = en;
