...
public class GetUserSubscriptionActivities extends Operation {
     ...
     */
    private String url = "/platform/admin/namespaces/{namespace}/users/{userId}/subscriptions/activities";
    ...
    */
    ...
    public SubscriptionActivityPagingSlicedResult parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
