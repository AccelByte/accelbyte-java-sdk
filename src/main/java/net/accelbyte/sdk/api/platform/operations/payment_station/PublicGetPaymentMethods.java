...
public class PublicGetPaymentMethods extends Operation {
     ...
     */
    private String url = "/platform/public/namespaces/{namespace}/payment/methods";
    ...
    */
    ...
    public PublicGetPaymentMethods createFromJson(String json) throws JsonProcessingException {
    ...
    public List<PaymentMethod> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
