 ...
 * disableItem
 *
 * <p>Disable an item. Other detail info:
 *
 * <p>* Returns : updated item
 */
@Getter
@Setter
public class DisableItem extends Operation {
  /** generated field's value */
  private String path = "/platform/admin/namespaces/{namespace}/items/{itemId}/disable";
  ...
  @Deprecated
  public DisableItem(
      String itemId, String namespace, String storeId, ChangeStatusItemRequest body) {
    this.itemId = itemId;
