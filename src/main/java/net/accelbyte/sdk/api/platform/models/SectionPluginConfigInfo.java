...
public class SectionPluginConfigInfo extends Model {
  ...
  @JsonIgnore
  public SectionPluginConfigInfo createFromJson(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<SectionPluginConfigInfo> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<SectionPluginConfigInfo>>() {});
  }
  ...
  public static class SectionPluginConfigInfoBuilder {
    ...
    public SectionPluginConfigInfoBuilder extendType(final String extendType) {
      this.extendType = extendType;
      return this;
    }

    public SectionPluginConfigInfoBuilder extendTypeFromEnum(final ExtendType extendType) {
      this.extendType = extendType.toString();
      return this;
    }
  }
