...
@Getter
@Setter
public class PreCheckFulfillItem extends Operation {
  ...
  private PreCheckFulfillmentRequest body;
  ...
  @Deprecated
  public PreCheckFulfillItem(String namespace, String userId, PreCheckFulfillmentRequest body) {
  ...
  @Override
  public PreCheckFulfillmentRequest getBodyParams() {
    return this.body;
  }
  ...
  public List<FulfillmentItem> parseResponse(int code, String contentType, InputStream payload)
