...
public class GrantEntitlements extends Operation {
  ...
  @Deprecated
  public GrantEntitlements(String namespace, BulkEntitlementGrantRequest body) {
  ...
  public BulkEntitlementGrantResult parseResponse(int code, String contentType, InputStream payload)
