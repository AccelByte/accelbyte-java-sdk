 ...
 *
 * <p>Get user entitlement histories.
 *
 * <p>Other detail info:
 *
...
public class GetUserEntitlementHistories extends Operation {
   ...
   */
  @Builder
  public GetUserEntitlementHistories(String entitlementId, String namespace, String userId) {
  ...
  public List<EntitlementHistoryInfo> parseResponse(
      int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
    String json = Helper.convertInputStreamToString(payload);
    if (code == 200) {
      return new ObjectMapper()
          .readValue(json, new TypeReference<List<EntitlementHistoryInfo>>() {});
    }
