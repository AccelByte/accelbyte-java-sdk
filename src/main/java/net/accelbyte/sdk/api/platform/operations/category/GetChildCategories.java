...
public class GetChildCategories extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/platform/admin/namespaces/{namespace}/categories/{categoryPath}/children";
    ...
    */
    ...
    @JsonIgnore
    public GetChildCategories createFromJson(String json) throws JsonProcessingException {
