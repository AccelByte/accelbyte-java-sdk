 ...
 *
 * <p>Update checkout.com config. Other detail info:
 *
...
public class UpdateCheckoutConfig extends Operation {
  ...
  private String path = "/platform/admin/payment/config/merchant/{id}/checkoutconfig";
  ...
  @Deprecated
  public UpdateCheckoutConfig(String id, Boolean sandbox, Boolean validate, CheckoutConfig body) {
    this.id = id;
