...
public class GetCurrencySummary extends Operation {
     ...
     */
    private String url = "/platform/admin/namespaces/{namespace}/currencies/{currencyCode}/summary";
    ...
    */
    ...
    public GetCurrencySummary createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public CurrencySummary parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
