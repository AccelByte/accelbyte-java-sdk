 ...
 * createSeason
 *
 * <p>This API is used to create a season, season only allowed in non-publisher namespace.
 *
 * <p>Other detail info:
 *
...
@Getter
@Setter
public class CreateSeason extends Operation {
  ...
  private SeasonCreate body;

  /**
   * @param namespace required
   */
  @Builder
  public CreateSeason(String namespace, SeasonCreate body) {
  ...
  @Override
  public SeasonCreate getBodyParams() {
    return this.body;
  }
  ...
  public SeasonInfo parseResponse(int code, String contentTpe, InputStream payload)
