...
public class GetCurrentSeason extends Operation {
     ...
     */
    private String url = "/seasonpass/admin/namespaces/{namespace}/seasons/current";
    ...
    */
    ...
    public SeasonSummary parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
