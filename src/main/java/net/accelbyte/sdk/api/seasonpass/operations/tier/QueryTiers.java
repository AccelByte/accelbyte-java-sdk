 ...
 * queryTiers
 *
 * <p>This API is used to query paginated tiers for a season.
 *
 * <p>Other detail info:
 *
...
public class QueryTiers extends Operation {
  ...
  @Deprecated
  public QueryTiers(String namespace, String seasonId, Integer limit, Integer offset) {
  ...
  public TierPagingSlicedResult parseResponse(int code, String contentType, InputStream payload)
