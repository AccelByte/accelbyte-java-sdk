 ...
 *
 * <p>This API is used to get current user season data, it will auto enroll if there's no user
 * season but active published season exist, season only located in non-publisher namespace.
 *
 * <p>Other detail info:
 *
...
public class PublicGetCurrentUserSeason extends Operation {
   ...
   */
  @Builder
  public PublicGetCurrentUserSeason(String namespace, String userId) {
  ...
  public ClaimableUserSeasonInfo parseResponse(int code, String contentTpe, InputStream payload)
