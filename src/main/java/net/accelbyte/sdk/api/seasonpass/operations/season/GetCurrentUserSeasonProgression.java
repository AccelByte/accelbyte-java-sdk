...
public class GetCurrentUserSeasonProgression extends Operation {
     ...
     */
    private String path = "/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/progression";
    ...
    */
    ...
    public UserSeasonSummary parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
