 ...
 *
 * <p>This API is used to get current user season progression, season only located in non-publisher
 * namespace.
 *
 * <p>Other detail info:
 *
 * <p>* Required permission : resource="ADMIN:NAMESPACE:{namespace}:USER:{userId}:SEASONPASS",
 * action=2 (READ) * Returns : user season progression
 */
@Getter
@Setter
public class GetCurrentUserSeasonProgression extends Operation {
  ...
  public UserSeasonSummary parseResponse(int code, String contentType, InputStream payload)
