 ...
 * queryRewards
 *
 * <p>This API is used to query rewards for a season.
 *
 * <p>Other detail info:
 *
...
public class QueryRewards extends Operation {
  ...
  private String path = "/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/rewards";
  ...
  @Deprecated
  public QueryRewards(String namespace, String seasonId, String q) {
  ...
  public List<RewardInfo> parseResponse(int code, String contentType, InputStream payload)
