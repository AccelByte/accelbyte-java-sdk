...
import net.accelbyte.sdk.api.seasonpass.models.PassCreate;
...
public class CreatePass extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/passes";
    ...
    */
    ...
    @JsonIgnore
    public CreatePass createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public PassInfo parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
