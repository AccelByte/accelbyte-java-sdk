 ...
 * createReward
 *
 * <p>This API is used to create a reward for a draft season.
 *
 * <p>Other detail info:
 *
 * <p>* Returns : created reward
 */
@Getter
@Setter
public class CreateReward extends Operation {
  ...
  @Deprecated
  public CreateReward(String namespace, String seasonId, RewardCreate body) {
