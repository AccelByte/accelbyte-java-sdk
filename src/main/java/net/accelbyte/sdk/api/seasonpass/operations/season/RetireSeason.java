 ...
 * retireSeason
 *
 * <p>This API is used to retire a published season, if the season has not ended it will report
 * error except with force.
 *
 * <p>Other detail info:
 *
...
public class RetireSeason extends Operation {
  ...
  private String path = "/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/retire";
