...
public class PublicGetUserSeason extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/seasonpass/public/namespaces/{namespace}/users/{userId}/seasons/{seasonId}/data";
    ...
    */
    ...
    public PublicGetUserSeason createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public ClaimableUserSeasonInfo parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
