...
import net.accelbyte.sdk.api.seasonpass.models.TierCreate;
...
@Getter
@Setter
public class CreateTier extends Operation {
    /**
    ...
    */
    ...
    public CreateTier createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public TierCreate getBodyParams(){
        return this.body;
    }
    ...
    public List<Tier> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
