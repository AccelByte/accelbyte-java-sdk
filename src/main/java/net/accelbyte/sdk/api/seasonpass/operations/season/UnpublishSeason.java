 ...
 * unpublishSeason
 *
 * <p>This API is used to unpublish a published season, if the season already started it will report
...
public class UnpublishSeason extends Operation {
   ...
   */
  @Builder
  public UnpublishSeason(String namespace, String seasonId, Boolean force) {
