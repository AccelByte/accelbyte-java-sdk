...
import net.accelbyte.sdk.api.seasonpass.models.TierInput;
...
public class UpdateTier extends Operation {
    /**
     * generated field's value
     */
    @JsonIgnore
    private String url = "/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/tiers/{id}";
    ...
    */
    ...
    @JsonIgnore
    public UpdateTier createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    @JsonIgnore
    public TierInput getBodyParams(){
        return this.body;
    }
