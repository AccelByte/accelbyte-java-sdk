 ...
 *
 * <p>[SERVICE COMMUNICATION ONLY]This API is used to get ownership for any pass codes, season only
 * located in non-publisher namespace.
 *
 * <p>Other detail info:
 *
 * <p>* Required permission : resource="ADMIN:NAMESPACE:{namespace}:USER:{userId}:SEASONPASS",
 * action=2 (READ) * Returns : ownership
 */
@Getter
@Setter
