...
public class GetUserParticipatedSeasons extends Operation {
     ...
     */
    private String url = "/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons";
    ...
    */
    ...
    @Override
    public ListUserSeasonInfoPagingSlicedResult parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
