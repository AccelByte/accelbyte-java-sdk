...
public class AgentTypeDescriptionHandler extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/event/descriptions/agentType";
    ...
    */
    ...
    public AgentTypeDescriptionHandler createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public ModelsMultipleAgentType parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
