...
@Getter
@Setter
public class GetLeaderboardConfigurationsAdminV3 extends Operation {
  ...
  public ModelsGetAllLeaderboardConfigsRespV3 parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ModelsGetAllLeaderboardConfigsRespV3().createFromJson(json);
  }
