...
@Getter
@Setter
public class GetUserRankingPublicV3 extends Operation {
  ...
  @Deprecated
  public GetUserRankingPublicV3(String leaderboardCode, String namespace, String userId) {
  ...
  public ModelsUserRankingResponseV3 parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ModelsUserRankingResponseV3().createFromJson(json);
  }
}
