...
@Getter
@Setter
public class GetMockTicketsByTimestamp extends Operation {
  ...
  @Deprecated
  public GetMockTicketsByTimestamp(String channelName, String namespace, ModelsQueryMockBy body) {
  ...
  public ModelsGetMockTicketsResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ModelsGetMockTicketsResponse().createFromJson(json);
  }
}
