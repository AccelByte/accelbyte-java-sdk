...
public class ModelsQueryMockBy extends Model {
  ...
  @JsonIgnore
  public List<ModelsQueryMockBy> createFromJsonList(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, new TypeReference<List<ModelsQueryMockBy>>() {});
  }
}
