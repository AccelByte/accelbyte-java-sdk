...
public class PublicGetSingleMatchmakingChannel extends Operation {
  ...
  private String path = "/matchmaking/v1/public/namespaces/{namespace}/channels/{channelName}";
   ...
   */
  @Builder
  public PublicGetSingleMatchmakingChannel(String channelName, String namespace) {
  ...
  public ModelsChannelV1 parseResponse(int code, String contentTpe, InputStream payload)
