...
public class StoreMatchResults extends Operation {
     ...
     */
    private String url = "/matchmaking/namespaces/{namespace}/matchresult";
    ...
    */
    ...
    public StoreMatchResults createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public ModelsMatchResultResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
