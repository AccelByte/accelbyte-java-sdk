...
public class UpdatePlayTimeWeight extends Operation {
     ...
     */
    private String url = "/matchmaking/social/playtime/namespaces/{namespace}/weight";
    ...
    */
    ...
    public ModelsUpdatePlayerPlaytimeWeightResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
