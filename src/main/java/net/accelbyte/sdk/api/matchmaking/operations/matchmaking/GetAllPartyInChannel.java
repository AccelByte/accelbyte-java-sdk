...
public class GetAllPartyInChannel extends Operation {
     ...
     */
    private String path = "/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/parties";
    ...
    */
    ...
    public List<ModelsMatchingParty> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
