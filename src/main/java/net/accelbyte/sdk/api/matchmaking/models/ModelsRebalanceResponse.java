...
public class ModelsRebalanceResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelsRebalanceResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsRebalanceResponse>>() {});
    }
