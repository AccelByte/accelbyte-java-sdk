...
public class GetAllChannelsHandler extends Operation {
  ...
  @Deprecated
  public GetAllChannelsHandler(String namespace, Integer limit, Integer offset) {
  ...
  public ModelsGetChannelsResponse parseResponse(int code, String contentType, InputStream payload)
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ModelsGetChannelsResponse().createFromJson(json);
  }
