...
public class GetAllSessionsInChannel extends Operation {
     ...
     */
    private String path = "/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/sessions";
    ...
    */
    ...
    public List<ModelsMatchmakingResult> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
