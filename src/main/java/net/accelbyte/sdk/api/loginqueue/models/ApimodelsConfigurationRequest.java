...
@NoArgsConstructor
public class ApimodelsConfigurationRequest extends Model {
  ...
  @JsonIgnore
  public ApimodelsConfigurationRequest createFromJson(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<ApimodelsConfigurationRequest> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<ApimodelsConfigurationRequest>>() {});
  }
}
