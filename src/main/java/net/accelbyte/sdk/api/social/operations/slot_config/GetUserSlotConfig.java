...
public class GetUserSlotConfig extends Operation {
  ...
  @Deprecated
  public GetUserSlotConfig(String namespace, String userId) {
  ...
  public UserSlotConfigInfo parseResponse(int code, String contentType, InputStream payload)
