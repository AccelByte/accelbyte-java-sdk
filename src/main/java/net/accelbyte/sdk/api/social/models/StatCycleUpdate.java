...
public class StatCycleUpdate extends Model {
  ...
  @JsonIgnore
  public StatCycleUpdate createFromJson(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<StatCycleUpdate> createFromJsonList(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, new TypeReference<List<StatCycleUpdate>>() {});
  }
  ...
  public static class StatCycleUpdateBuilder {
    ...
    public StatCycleUpdateBuilder cycleType(final String cycleType) {
      this.cycleType = cycleType;
      return this;
    }

    public StatCycleUpdateBuilder cycleTypeFromEnum(final CycleType cycleType) {
      this.cycleType = cycleType.toString();
      return this;
    }
  }
