 ...
 *
 * <p>Public bulk reset user's statitems value for given namespace and user. Other detail info: +
...
public class BulkResetUserStatItem3 extends Operation {
  ...
  @Deprecated
  public BulkResetUserStatItem3(String namespace, String userId, List<BulkStatItemReset> body) {
