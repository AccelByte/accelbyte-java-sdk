...
public class QueryStats extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/social/v1/admin/namespaces/{namespace}/stats/search";
    ...
    */
    ...
    @Override
    @JsonIgnore
    public StatPagingSlicedResult parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
