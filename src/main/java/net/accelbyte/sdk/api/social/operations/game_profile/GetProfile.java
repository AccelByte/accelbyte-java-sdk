 ...
 * getProfile
 *
 * <p>Returns profile for a user. Other detail info:
 *
 * <p>* Required permission : resource="ADMIN:NAMESPACE:{namespace}:USER:{userId}:GAMEPROFILE",
 * action=2 (READ) * Returns : game profile info
 */
@Getter
@Setter
public class GetProfile extends Operation {
  /** generated field's value */
  private String path = "/social/admin/namespaces/{namespace}/users/{userId}/profiles/{profileId}";
