 ...
 *
 * <p>Bulk update user's statitems value. Other detail info: * Required permission :
 * resource="ADMIN:NAMESPACE:{namespace}:USER:{userId}:STATITEM", action=4 (UPDATE) * Returns : bulk
 * updated result
 */
@Getter
@Setter
public class BulkIncUserStatItem1 extends Operation {
  ...
  @Deprecated
  public BulkIncUserStatItem1(String namespace, String userId, List<BulkStatItemInc> body) {
