 ...
 *
 * <p>Bulk reset user's statitems value for given namespace and user. Other detail info: + *Required
...
public class BulkResetUserStatItem1 extends Operation {
  ...
  @Deprecated
  public BulkResetUserStatItem1(String namespace, String userId, List<BulkStatItemReset> body) {
