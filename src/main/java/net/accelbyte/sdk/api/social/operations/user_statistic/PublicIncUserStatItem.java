 ...
 *
 * <p>Public update user's statitem value. Other detail info:
 *
...
@Getter
@Setter
public class PublicIncUserStatItem extends Operation {
   ...
   */
  @Builder
  public PublicIncUserStatItem(String namespace, String statCode, String userId, StatItemInc body) {
