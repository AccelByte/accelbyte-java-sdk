 ...
 *
 * <p>Create user's statItem. Other detail info: * Returns : created user's statItem
 */
@Getter
@Setter
public class PublicCreateUserStatItem extends Operation {
  ...
  @Deprecated
  public PublicCreateUserStatItem(String namespace, String statCode, String userId) {
