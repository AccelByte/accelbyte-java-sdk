 ...
 *
 * <p>Get slots for a given user. Other detail info: * Returns : list of slots
 *
 * @deprecated
 */
@Deprecated
...
public class GetUserNamespaceSlots extends Operation {
  ...
  private String path = "/social/admin/namespaces/{namespace}/users/{userId}/slots";
  ...
  @Deprecated
  public GetUserNamespaceSlots(String namespace, String userId) {
