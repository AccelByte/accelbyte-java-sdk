...
public class GetUserNamespaceSlots extends Operation {
    ...
    */
    ...
    public GetUserNamespaceSlots createFromJson(String json) throws JsonProcessingException {
    ...
    @Override
    public List<SlotInfo> parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
