...
public class BulkCreateUserStatItems extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/social/v1/admin/namespaces/{namespace}/users/{userId}/statitems/bulk";
    ...
    */
    ...
    @JsonIgnore
    public BulkCreateUserStatItems createFromJson(String json) throws JsonProcessingException {
