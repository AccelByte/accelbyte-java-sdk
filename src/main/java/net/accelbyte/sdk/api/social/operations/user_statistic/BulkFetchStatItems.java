 ...
 * bulkFetchStatItems
 *
 * <p>Bulk fetch multiple user's statitem value for a given namespace and statCode. Other detail
 * info: + *Required permission*: resource="ADMIN:NAMESPACE:{namespace}:STATITEM", action=2 (READ) +
...
public class BulkFetchStatItems extends Operation {
  ...
  private String path = "/social/v1/admin/namespaces/{namespace}/statitems/bulk";
   ...
   */
  @Builder
  public BulkFetchStatItems(String namespace, String statCode, String userIds) {
  ...
  public List<UserStatItemInfo> parseResponse(int code, String contentTpe, InputStream payload)
