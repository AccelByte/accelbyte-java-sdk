 ...
 *
 * <p>Update user's statitem value. Other detail info: * Returns : updated user's statItem
 */
@Getter
@Setter
public class IncUserStatItemValue extends Operation {
  ...
  @Deprecated
  public IncUserStatItemValue(String namespace, String statCode, String userId, StatItemInc body) {
