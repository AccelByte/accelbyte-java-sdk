...
public class BulkFetchStatItems1 extends Operation {
     ...
     */
    private String url = "/social/v1/public/namespaces/{namespace}/statitems/bulk";
    ...
    */
    ...
    public BulkFetchStatItems1 createFromJson(String json) throws JsonProcessingException {
    ...
    public List<UserStatItemInfo> parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
