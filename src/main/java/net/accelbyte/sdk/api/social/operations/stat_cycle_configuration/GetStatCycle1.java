 ...
 * resource="NAMESPACE:{namespace}:STAT", action=2 (READ) * Returns : stat cycle info
 */
@Getter
@Setter
public class GetStatCycle1 extends Operation {
  /** generated field's value */
  private String path = "/social/v1/public/namespaces/{namespace}/statCycles/{cycleId}";
  ...
  @Deprecated
  public GetStatCycle1(String cycleId, String namespace) {
