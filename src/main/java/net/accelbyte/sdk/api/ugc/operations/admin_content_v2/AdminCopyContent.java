...
public class AdminCopyContent extends Operation {
  ...
  private String path =
      "/ugc/v2/admin/namespaces/{namespace}/channels/{channelId}/contents/{contentId}/copy";
  ...
  public AdminCopyContent(
      String channelId, String contentId, String namespace, ModelsCopyContentRequest body) {
