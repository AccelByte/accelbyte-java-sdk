 ...
 * [UPDATE]. All request body are required except payload, preview, tags, and
...
public class AdminUpdateContentS3 extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/ugc/v1/admin/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/s3/{contentId}";
