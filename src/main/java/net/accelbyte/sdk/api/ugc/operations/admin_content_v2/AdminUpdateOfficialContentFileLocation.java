 ...
 *
 * <p>This endpoint should be used after calling generate official content upload url endpoint to
 * commit the changes. Required permission ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENT
 * [UPDATE].
 */
@Getter
@Setter
public class AdminUpdateOfficialContentFileLocation extends Operation {
  ...
  public AdminUpdateOfficialContentFileLocation(
      String channelId, String contentId, String namespace, ModelsUpdateFileLocationRequest body) {
