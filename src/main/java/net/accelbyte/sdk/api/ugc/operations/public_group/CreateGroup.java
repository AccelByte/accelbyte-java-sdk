 ...
 * CreateGroup
 *
 * <p>Required permission NAMESPACE:{namespace}:USER:{userId}:CONTENTGROUP [CREATE]
 */
@Getter
@Setter
public class CreateGroup extends Operation {
  ...
  @Deprecated
  public CreateGroup(String namespace, String userId, ModelsCreateGroupRequest body) {
