 ...
 * UpdateScreenshotsV2
 *
 * <p>Required permission NAMESPACE:{namespace}:USER:{userId}:CONTENT [UPDATE]. Maximum description
 * length: 1024.
 */
@Getter
@Setter
public class UpdateScreenshotsV2 extends Operation {
  ...
  public UpdateScreenshotsV2(
      String contentId, String namespace, String userId, ModelsUpdateScreenshotRequest body) {
