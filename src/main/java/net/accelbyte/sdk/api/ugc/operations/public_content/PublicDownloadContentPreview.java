...
public class PublicDownloadContentPreview extends Operation {
     ...
     */
    private String url = "/ugc/v1/public/namespaces/{namespace}/contents/{contentId}/preview";
    ...
    */
    ...
    @Override
    public ModelsGetContentPreviewResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
