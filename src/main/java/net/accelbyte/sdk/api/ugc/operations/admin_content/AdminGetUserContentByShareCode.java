...
@Getter
@Setter
public class AdminGetUserContentByShareCode extends Operation {
  /** generated field's value */
  private String path = "/ugc/v1/admin/namespaces/{namespace}/contents/sharecodes/{shareCode}";
  ...
  @Deprecated
  public AdminGetUserContentByShareCode(String namespace, String shareCode) {
