 ...
 * AdminUpdateTag
 *
 * <p>Required permission ADMIN:NAMESPACE:{namespace}:UGCCONFIG [UPDATE] updates a tag
 */
@Getter
@Setter
public class AdminUpdateTag extends Operation {
  ...
  @Deprecated
  public AdminUpdateTag(String namespace, String tagId, ModelsCreateTagRequest body) {
  ...
  public ModelsCreateTagResponse parseResponse(int code, String contentType, InputStream payload)
