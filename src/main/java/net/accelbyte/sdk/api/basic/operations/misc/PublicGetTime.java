...
public class PublicGetTime extends Operation {
     ...
     */
    private String url = "/basic/v1/public/misc/time";
    ...
    */
    ...
    @Override
    public RetrieveTimeResponse parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
