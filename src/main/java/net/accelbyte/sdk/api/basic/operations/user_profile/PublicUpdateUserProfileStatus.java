 ...
 * (UPDATE) * Action code : 11406 * Returns : user profile
 */
@Getter
@Setter
public class PublicUpdateUserProfileStatus extends Operation {
  /** generated field's value */
  private String path = "/basic/v1/public/namespaces/{namespace}/users/{userId}/profiles/status";
  ...
  public PublicUpdateUserProfileStatus(
      String namespace, String userId, UserProfileStatusUpdate body) {
