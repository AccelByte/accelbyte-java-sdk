...
public class UpdateUserProfileStatus extends Operation {
     ...
     */
    private String url = "/basic/v1/admin/namespaces/{namespace}/users/{userId}/profiles/status";
    ...
    */
    ...
    public UpdateUserProfileStatus createFromJson(String json) throws JsonProcessingException {
