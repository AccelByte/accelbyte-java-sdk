...
@Getter
@Setter
public class GetMyZipCode extends Operation {
   ...
   */
  @Builder
  public GetMyZipCode(String namespace) {
  ...
  public UserZipCode parseResponse(int code, String contentTpe, InputStream payload)
