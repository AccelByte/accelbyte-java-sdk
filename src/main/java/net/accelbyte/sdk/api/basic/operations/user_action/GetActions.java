...
public class GetActions extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/basic/v1/admin/namespaces/{namespace}/actions";
    ...
    */
    ...
    @Override
    @JsonIgnore
    public List<Action> parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
