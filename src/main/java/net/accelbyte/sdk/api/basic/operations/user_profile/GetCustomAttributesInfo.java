...
public class GetCustomAttributesInfo extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/basic/v1/admin/namespaces/{namespace}/users/{userId}/profiles/customAttributes";
    ...
    */
    ...
    @JsonIgnore
    public GetCustomAttributesInfo createFromJson(String json) throws JsonProcessingException {
