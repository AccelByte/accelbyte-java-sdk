...
public class UpdatePrivateCustomAttributesPartially extends Operation {
     ...
     */
    private String url = "/basic/v1/admin/namespaces/{namespace}/users/{userId}/profiles/privateCustomAttributes";
    ...
    */
    ...
    public UpdatePrivateCustomAttributesPartially createFromJson(String json) throws JsonProcessingException {
