...
public class PublicGeneratedUserUploadContentUrl extends Operation {
     ...
     */
    @JsonIgnore
    private String url = "/basic/v1/public/namespaces/{namespace}/users/{userId}/files";
    ...
    */
    ...
    @JsonIgnore
    public PublicGeneratedUserUploadContentUrl createFromJson(String json) throws JsonProcessingException {
