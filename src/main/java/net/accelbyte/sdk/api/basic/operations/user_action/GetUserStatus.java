...
public class GetUserStatus extends Operation {
     ...
     */
    private String url = "/basic/v1/admin/namespaces/{namespace}/actions/status";
    ...
    */
    ...
    @Override
    public ADTOObjectForEqu8UserStatus parseResponse(int code, String contentTpe, InputStream payload) throws ResponseException, IOException {
