 ...
 *
 * <p>Retrieve player record key and payload in bulk under given namespace. Maximum number of user
 * ids per request is 20.
 */
@Getter
@Setter
public class AdminBulkGetPlayerRecordsByUserIDsHandlerV1 extends Operation {
