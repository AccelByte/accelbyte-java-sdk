...
public class ModelsGameBinaryRecordAdminResponse extends Model {
  ...
  @JsonIgnore
  public ModelsGameBinaryRecordAdminResponse createFromJson(String json)
      throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<ModelsGameBinaryRecordAdminResponse> createFromJsonList(String json)
      throws JsonProcessingException {
    return new ObjectMapper()
        .readValue(json, new TypeReference<List<ModelsGameBinaryRecordAdminResponse>>() {});
  }
