...
@Getter
@Setter
public class AdminPutPlayerBinaryRecorMetadataV1 extends Operation {
  ...
  private ModelsPlayerBinaryRecordMetadataRequest body;
  ...
  public AdminPutPlayerBinaryRecorMetadataV1(
      String key, String namespace, String userId, ModelsPlayerBinaryRecordMetadataRequest body) {
    this.key = key;
  ...
  @Override
  public ModelsPlayerBinaryRecordMetadataRequest getBodyParams() {
    return this.body;
  }
