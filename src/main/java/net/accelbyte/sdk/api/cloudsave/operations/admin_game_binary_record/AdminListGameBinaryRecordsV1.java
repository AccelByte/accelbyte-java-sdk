...
@Getter
@Setter
public class AdminListGameBinaryRecordsV1 extends Operation {
  ...
  public AdminListGameBinaryRecordsV1(
      String namespace, Integer limit, Integer offset, String query) {
  ...
  public ModelsListGameBinaryRecordsAdminResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ModelsListGameBinaryRecordsAdminResponse().createFromJson(json);
  }
