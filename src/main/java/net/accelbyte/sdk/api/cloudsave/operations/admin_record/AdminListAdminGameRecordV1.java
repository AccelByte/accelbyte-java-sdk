...
@Getter
@Setter
public class AdminListAdminGameRecordV1 extends Operation {
  /** generated field's value */
  private String path = "/cloudsave/v1/admin/namespaces/{namespace}/adminrecords";
  ...
  public ModelsListAdminGameRecordKeysResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new ModelsListAdminGameRecordKeysResponse().createFromJson(json);
  }
