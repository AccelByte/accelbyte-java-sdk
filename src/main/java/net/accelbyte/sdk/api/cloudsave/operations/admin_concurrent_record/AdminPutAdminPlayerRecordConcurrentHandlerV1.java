...
@Getter
@Setter
public class AdminPutAdminPlayerRecordConcurrentHandlerV1 extends Operation {
  ...
  private ModelsAdminPlayerConcurrentRecordRequest body;
  ...
  public AdminPutAdminPlayerRecordConcurrentHandlerV1(
      String key, String namespace, String userId, ModelsAdminPlayerConcurrentRecordRequest body) {
    this.key = key;
  ...
  @Override
  public ModelsAdminPlayerConcurrentRecordRequest getBodyParams() {
    return this.body;
  }
