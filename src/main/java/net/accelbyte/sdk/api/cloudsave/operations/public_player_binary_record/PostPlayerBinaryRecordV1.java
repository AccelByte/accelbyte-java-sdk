 ...
 *
 * <p>Required permission: `NAMESPACE:{namespace}:USER:{userId}:CLOUDSAVE:RECORD [CREATE]` Required
 * scope: `social`
 *
...
@Getter
@Setter
public class PostPlayerBinaryRecordV1 extends Operation {
  /** generated field's value */
  private String path = "/cloudsave/v1/namespaces/{namespace}/users/{userId}/binaries";
  ...
  private ModelsPublicPlayerBinaryRecordCreate body;
  ...
  public PostPlayerBinaryRecordV1(
      String namespace, String userId, ModelsPublicPlayerBinaryRecordCreate body) {
  ...
  @Override
  public ModelsPublicPlayerBinaryRecordCreate getBodyParams() {
    return this.body;
  }
