...
public class ModelsGameBinaryRecordResponse extends Model {
  ...
  public static class ModelsGameBinaryRecordResponseBuilder {
    private String setBy;

    public ModelsGameBinaryRecordResponseBuilder setBy(final String setBy) {
      this.setBy = setBy;
      return this;
    }

    public ModelsGameBinaryRecordResponseBuilder setByFromEnum(final SetBy setBy) {
      this.setBy = setBy.toString();
      return this;
    }
  }
