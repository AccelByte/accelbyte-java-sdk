...
@Getter
@Setter
public class AdminGetPlayerPublicRecordHandlerV1 extends Operation {
  ...
  @Deprecated
  public AdminGetPlayerPublicRecordHandlerV1(String key, String namespace, String userId) {
    this.key = key;
