...
@Getter
@Setter
public class AdminPutPlayerRecordsHandlerV1 extends Operation {
  /** generated field's value */
  private String path = "/cloudsave/v1/admin/namespaces/{namespace}/users/{userId}/records/bulk";
  ...
  private ModelsBulkUpdatePlayerRecordsRequest body;
  ...
  public AdminPutPlayerRecordsHandlerV1(
      String namespace, String userId, ModelsBulkUpdatePlayerRecordsRequest body) {
  ...
  @Override
  public ModelsBulkUpdatePlayerRecordsRequest getBodyParams() {
    return this.body;
  }
  ...
  public List<ModelsBulkUpdatePlayerRecordResponse> parseResponse(
