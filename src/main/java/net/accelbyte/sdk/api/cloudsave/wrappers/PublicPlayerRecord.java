...
public class PublicPlayerRecord {
     ...
     */
    public ModelsBulkGetPlayerRecordResponse bulkGetPlayerPublicRecordHandlerV1(BulkGetPlayerPublicRecordHandlerV1 input) throws Exception {
     ...
     */
    public void publicDeletePlayerPublicRecordHandlerV1(PublicDeletePlayerPublicRecordHandlerV1 input) throws Exception {
        HttpResponse httpResponse = null;
        try {
          httpResponse = sdk.runRequest(input);
          input
     ...
     */
    public ModelsPlayerRecordResponse getPlayerRecordHandlerV1(GetPlayerRecordHandlerV1 input) throws Exception {
        HttpResponse httpResponse = null;
        try {
          httpResponse = sdk.runRequest(input);
          return input
     ...
     */
    public ModelsPlayerRecordResponse getPlayerPublicRecordHandlerV1(GetPlayerPublicRecordHandlerV1 input) throws Exception {
        HttpResponse httpResponse = null;
        try {
          httpResponse = sdk.runRequest(input);
          return input
     ...
     */
    public void putPlayerPublicRecordHandlerV1(PutPlayerPublicRecordHandlerV1 input) throws Exception {
        HttpResponse httpResponse = null;
        try {
          httpResponse = sdk.runRequest(input);
          input
     ...
     */
    public void postPlayerPublicRecordHandlerV1(PostPlayerPublicRecordHandlerV1 input) throws Exception {
        HttpResponse httpResponse = null;
        try {
          httpResponse = sdk.runRequest(input);
          input
