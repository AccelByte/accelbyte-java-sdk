...
@Getter
@Setter
public class AdminResetServicesConfiguration extends Operation {
  /** generated field's value */
  private String path = "/gdpr/admin/namespaces/{namespace}/services/configurations/reset";
  ...
  @Deprecated
  public AdminResetServicesConfiguration(String namespace) {
