...
public class AdminGetUserAccountDeletionRequest extends Operation {
  ...
  @Deprecated
  public AdminGetUserAccountDeletionRequest(String namespace, String userId) {
  ...
  public ModelsDeletionData parseResponse(int code, String contentType, InputStream payload)
