 ...
 *
 * <p>Cancel user's account deletion request Requires valid user access token Scope: account
 */
@Getter
@Setter
public class PublicCancelUserAccountDeletionRequest extends Operation {
