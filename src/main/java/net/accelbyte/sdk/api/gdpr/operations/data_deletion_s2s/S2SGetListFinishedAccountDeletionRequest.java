 ...
 * <p>Scope: account
 *
 * <p>Get list of finished account deletion requests based on the finished time period. Unfinished
 * deletion requests will not appear here, i.e. have Status **Request**, **Pending** or
 * **In-Progress**.
 *
...
public class S2SGetListFinishedAccountDeletionRequest extends Operation {
  ...
  @Deprecated
  public S2SGetListFinishedAccountDeletionRequest(String namespace, String end, String start) {
  ...
  public DtoListFinishedDataDeletion parseResponse(
