...
public class AdminGetListDeletionDataRequest extends Operation {
     ...
     */
    private String path = "/gdpr/admin/namespaces/{namespace}/deletions";
    ...
    */
    ...
    public ModelsListDeletionDataResponse parseResponse(int code, String contentTpe, InputStream payload) throws HttpResponseException, IOException {
