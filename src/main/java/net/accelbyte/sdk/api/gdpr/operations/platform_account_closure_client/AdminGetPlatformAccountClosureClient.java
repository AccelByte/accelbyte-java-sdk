...
@Getter
@Setter
public class AdminGetPlatformAccountClosureClient extends Operation {
  ...
  @Deprecated
  public AdminGetPlatformAccountClosureClient(String namespace, String platform) {
  ...
  public DtoPlatformAccountClosureClientResponse parseResponse(
    ...
    final String json = Helper.convertInputStreamToString(payload);
    return new DtoPlatformAccountClosureClientResponse().createFromJson(json);
  }
}
