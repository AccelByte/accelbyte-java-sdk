...
class TestIntegration {
  ...
  public void testServiceAchievement() throws Exception {
    ...
    final ModelsAchievementRequest createAchievement =
    ...
    final ModelsAchievementResponse createAchievementResult =
        achievementWrapper.adminCreateNewAchievement(
    ...
    final ModelsAchievementResponse getAchievementResult =
        achievementWrapper.adminGetAchievement(
    ...
    final ModelsPaginatedAchievementResponse getAchievementListResult =
        achievementWrapper.adminListAchievements(
    ...
    achievementWrapper.adminDeleteAchievement(
  ...
  public void testServiceBasic() throws Exception {
    ...
    try {
      final UserProfilePrivateInfo getProfileResult =
          profileWrapper.getMyProfileInfo(
      ...
      final UserProfilePrivateInfo deleteUserProfileResult =
          profileWrapper.deleteUserProfile(
    ...
    final UserProfilePrivateCreate createProfile =
    ...
    final UserProfilePrivateInfo createProfileResult =
        profileWrapper.createMyProfile(
            CreateMyProfile.builder().namespace(this.namespace).body(createProfile).build());
    ...
    final UserProfilePrivateUpdate updateProfile =
        UserProfilePrivateUpdate.builder().timeZone(profileTimeZone).build();

    final UserProfilePrivateInfo updateProfileResult =
        profileWrapper.updateMyProfile(
            UpdateMyProfile.builder().namespace(this.namespace).body(updateProfile).build());
  ...
  public void testServiceCloudSave() throws Exception {
    ...
    final DummyGameRecord createGameRecord =
    ...
    final ModelsGameRecordResponse getGameRecordResult1 =
    ...
    final ModelsGameRecordResponse getGameRecordResult2 =
        publicGameRecordWrapper.getGameRecordHandlerV1(
            GetGameRecordHandlerV1.builder().namespace(this.namespace).key(gameRecordKey).build());
  ...
  public void testServiceEventLog() throws Exception {
    ...
    final ModelsGenericQueryPayload queryEventStream =
        ModelsGenericQueryPayload.builder()
            .clientId(sdk.getSdkConfiguration().getConfigRepository().getClientId())
            .build();

    final ModelsEventResponseV2 queryEventStreamResult1 =
    ...
    final ModelsEventResponseV2 queryEventStreamResult2 =
  ...
  public void testServiceGroup() throws Exception {
    ...
    try {
      final ModelsCreateGroupConfigurationRequestV1 createGroupConfig =
      ...
      boolean isAlreadyExist = rex.getErrorMessage().contains("73130"); // Unable to create global
  ...
  public void testServiceLeaderboard() throws Exception {
    ...
    final ModelsLeaderboardConfigReq createLeaderboard =
    ...
    final ModelsGetLeaderboardConfigResp getLeaderboardResult1 =
    ...
    final ModelsUpdateLeaderboardConfigReq updateLeaderboard =
    ...
    final ModelsGetLeaderboardConfigResp getLeaderboardResult2 =
        leaderboardConfigWrapper.getLeaderboardConfigurationAdminV1(
            GetLeaderboardConfigurationAdminV1.builder()
                .namespace(this.namespace)
                .leaderboardCode(leaderboardCode)
  ...
  public void testServiceLegal() throws Exception {
    ...
    final List<RetrieveAcceptedAgreementResponse> aggrs =
        agreementWrapper.retrieveAgreementsPublic(RetrieveAgreementsPublic.builder().build());

    assertNotNull(aggrs);

    final List<AcceptAgreementRequest> acceptAgreements =
        Arrays.asList(
    ...
    agreementWrapper.changePreferenceConsent(
        ChangePreferenceConsent.builder().body(acceptAgreements).build());
  }
  ...
  public void testServicePlatform() throws Exception {
    ...
    final StoreInfo createStoreResult =
        storeWrapper.createStore(
            CreateStore.builder().namespace(this.namespace).body(createStore).build());
  ...
  public void testSessionBrowser() throws Exception {
    ...
    final ModelsSessionResponse dResp =
  ...
  public void testServiceSocial() throws Exception {
    ...
    final StatInfo createStatResult =
        statConfigWrapper.createStat(
            CreateStat.builder().namespace(this.namespace).body(createStat).build());
  ...
  public void testServiceUgc() throws Exception {
    ...
    final ModelsCreateTagRequest createTag = ModelsCreateTagRequest.builder().tag(tagName).build();

    final ModelsCreateTagResponse createTagResult =
        adminTagWrapper.adminCreateTag(
            AdminCreateTag.builder().namespace(this.namespace).body(createTag).build());
  ...
  public void testServiceGametelemetry() throws Exception {
    ...
    final TelemetryBody saveTelemetry =
  ...
  public void testDsmcLocalServer() throws Exception {
    ...
    final ModelsListServerResponse serverResp =
        adminWrapper.listLocalServer(ListLocalServer.builder().namespace(this.namespace).build());
  ...
  public void testDsmc() throws Exception, InterruptedException {
    ...
    final ModelsSessionResponse createSessionResult =
        sessionBrowserWrapper.createSession(
            CreateSession.builder().namespace(targetNamespace).body(createSession).build());
    ...
    final net.accelbyte.sdk.api.dsmc.models.ModelsCreateSessionRequest createSessionDsmc =
    ...
    final AccelByteSDK sdkReliable =
        new AccelByteSDK(
    ...
    final net.accelbyte.sdk.api.dsmc.wrappers.Session dsmcSessionReliableWrapper =
        new net.accelbyte.sdk.api.dsmc.wrappers.Session(sdkReliable);

    ModelsClaimSessionRequest claimServer =
        ModelsClaimSessionRequest.builder().sessionId(sessionId).build();

    dsmcSessionReliableWrapper.claimServer(
        ClaimServer.builder().namespace(targetNamespace).body(claimServer).build());
  ...
  public void testMatchmaking() throws Exception {
    ...
    final ModelsChannelRequest createChannel =
    ...
    final ModelsCreateChannelResponse createChannelResult =
        matchmakingWrapper.createChannelHandler(
            CreateChannelHandler.builder().namespace(this.namespace).body(createChannel).build());
    ...
    final ModelsChannelV1 getSingleChannelResult1 =
    ...
    final ModelsUpdateChannelRequest updateChannel =
    ...
    final ModelsChannelV1 getSingleChannelResult2 =
        matchmakingWrapper.getSingleMatchmakingChannel(
            GetSingleMatchmakingChannel.builder()
                .namespace(this.namespace)
                .channelName(channelName)
