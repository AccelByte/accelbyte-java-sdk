...
| `/achievement/v1/admin/namespaces/{namespace}/users/{userId}/achievements/bulkUnlock` | PUT | AdminBulkUnlockAchievement | [AdminBulkUnlockAchievement](../../src/main/java/net/accelbyte/sdk/api/achievement/operations/user_achievements/AdminBulkUnlockAchievement.java) | [AdminBulkUnlockAchievement](../../samples/cli/src/main/java/net/accelbyte/sdk/cli/api/achievement/user_achievements/AdminBulkUnlockAchievement.java) |
...
| `/achievement/v1/public/namespaces/{namespace}/users/{userId}/achievements/bulkUnlock` | PUT | PublicBulkUnlockAchievement | [PublicBulkUnlockAchievement](../../src/main/java/net/accelbyte/sdk/api/achievement/operations/user_achievements/PublicBulkUnlockAchievement.java) | [PublicBulkUnlockAchievement](../../samples/cli/src/main/java/net/accelbyte/sdk/cli/api/achievement/user_achievements/PublicBulkUnlockAchievement.java) |
...
| `models.BulkUnlockAchievementRequest` | [ModelsBulkUnlockAchievementRequest](../../src/main/java/net/accelbyte/sdk/api/achievement/models/ModelsBulkUnlockAchievementRequest.java) |
| `models.BulkUnlockAchievementResponse` | [ModelsBulkUnlockAchievementResponse](../../src/main/java/net/accelbyte/sdk/api/achievement/models/ModelsBulkUnlockAchievementResponse.java) |
